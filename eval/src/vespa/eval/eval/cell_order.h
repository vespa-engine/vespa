...
struct CellOrderMAX {
    static constexpr bool cmp(Int8Float a, Int8Float b) noexcept { return a.get_bits() > b.get_bits(); }
    static constexpr bool cmp(auto a, auto b) noexcept { return std::isnan(b) ? !std::isnan(a) : a > b; }
