...
OptimizeTensorFunctionOptions::OptimizeTensorFunctionOptions() noexcept : allow_universal_dot_product(true) {
}
...
template <typename Func> void run_optimize_pass(const Child& root, Func&& optimize_node) {
...
const TensorFunction& optimize_tensor_function(const ValueBuilderFactory& factory, const TensorFunction& function,
                                               Stash& stash, const OptimizeTensorFunctionOptions& options) {
...
const TensorFunction& apply_tensor_function_optimizer(const TensorFunction&     function,
                                                      tensor_function_optimizer optimizer, Stash& stash,
                                                      tensor_function_listener listener) {
    Child root(function);
