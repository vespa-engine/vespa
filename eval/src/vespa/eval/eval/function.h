...
struct SymbolExtractor {
    virtual void extract_symbol(const char* pos_in, const char* end_in, const char*& pos_out,
...
public:
    ...
    static bool unwrap(std::string_view input, std::string& wrapper, std::string& body, std::string& error);
    /**
