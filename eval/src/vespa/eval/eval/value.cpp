...
size_t EmptyIndex::size() const {
    return 0;
}

std::unique_ptr<Value::Index::View> EmptyIndex::create_view(std::span<const size_t>) const {
...
size_t TrivialIndex::size() const {
    return 1;
}

std::unique_ptr<Value::Index::View> TrivialIndex::create_view(std::span<const size_t>) const {
