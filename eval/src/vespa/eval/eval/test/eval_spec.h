...
private:
    ...
    struct Expression {
        ...
        Expression& add_cases(std::initializer_list<double> a_values, std::initializer_list<double> b_values,
                              fun_2_ref fun);
    };
...
public:
    struct EvalTest {
        ...
        virtual void next_expression(const std::vector<std::string>& param_names, const std::string& expression) = 0;
        virtual void handle_case(const std::vector<std::string>& param_names, const std::vector<double>& param_values,
                                 const std::string& expression, double expected_result) = 0;
