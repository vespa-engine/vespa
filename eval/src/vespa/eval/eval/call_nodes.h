...
private:
    ...
    template <typename T> void add(const T& op) { _map[op.name()] = T::create; }
    CallRepo();
...
template <typename T> struct CallHelper : Call {
    using Helper = CallHelper<T>;
    CallHelper(const std::string& name_in, size_t num_params_in) : Call(name_in, num_params_in) {}
...
struct Cos : CallHelper<Cos> {
    Cos() : Helper("cos", 1) {}
};
struct Sin : CallHelper<Sin> {
    Sin() : Helper("sin", 1) {}
};
struct Tan : CallHelper<Tan> {
    Tan() : Helper("tan", 1) {}
};
struct Cosh : CallHelper<Cosh> {
    Cosh() : Helper("cosh", 1) {}
};
struct Sinh : CallHelper<Sinh> {
    Sinh() : Helper("sinh", 1) {}
};
struct Tanh : CallHelper<Tanh> {
    Tanh() : Helper("tanh", 1) {}
};
struct Acos : CallHelper<Acos> {
    Acos() : Helper("acos", 1) {}
};
struct Asin : CallHelper<Asin> {
    Asin() : Helper("asin", 1) {}
};
struct Atan : CallHelper<Atan> {
    Atan() : Helper("atan", 1) {}
};
struct Exp : CallHelper<Exp> {
    Exp() : Helper("exp", 1) {}
};
struct Log10 : CallHelper<Log10> {
    Log10() : Helper("log10", 1) {}
};
struct Log : CallHelper<Log> {
    Log() : Helper("log", 1) {}
};
struct Sqrt : CallHelper<Sqrt> {
    Sqrt() : Helper("sqrt", 1) {}
};
struct Ceil : CallHelper<Ceil> {
    Ceil() : Helper("ceil", 1) {}
};
struct Fabs : CallHelper<Fabs> {
    Fabs() : Helper("fabs", 1) {}
};
struct Floor : CallHelper<Floor> {
    Floor() : Helper("floor", 1) {}
};
struct Atan2 : CallHelper<Atan2> {
    Atan2() : Helper("atan2", 2) {}
};
struct Ldexp : CallHelper<Ldexp> {
    Ldexp() : Helper("ldexp", 2) {}
};
struct Pow2 : CallHelper<Pow2> {
    Pow2() : Helper("pow", 2) {}
};
struct Fmod : CallHelper<Fmod> {
    Fmod() : Helper("fmod", 2) {}
};
struct Min : CallHelper<Min> {
    Min() : Helper("min", 2) {}
};
struct Max : CallHelper<Max> {
    Max() : Helper("max", 2) {}
};
struct IsNan : CallHelper<IsNan> {
    IsNan() : Helper("isNan", 1) {}
};
struct Relu : CallHelper<Relu> {
    Relu() : Helper("relu", 1) {}
};
struct Sigmoid : CallHelper<Sigmoid> {
    Sigmoid() : Helper("sigmoid", 1) {}
};
struct Elu : CallHelper<Elu> {
    Elu() : Helper("elu", 1) {}
};
struct Erf : CallHelper<Erf> {
    Erf() : Helper("erf", 1) {}
};
struct Bit : CallHelper<Bit> {
    Bit() : Helper("bit", 2) {}
};
struct Hamming : CallHelper<Hamming> {
    Hamming() : Helper("hamming", 2) {}
};
