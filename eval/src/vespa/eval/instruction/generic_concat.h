...
struct GenericConcat {
    static InterpretedFunction::Instruction make_instruction(const ValueType& result_type, const ValueType& lhs_type,
                                                             const ValueType& rhs_type, const std::string& dimension,
...
struct DenseConcatPlan {
    ...
    struct InOutLoop {
        ...
        std::pair<size_t, size_t> fill_from(const ValueType& in_type, std::string concat_dimension,
    ...
    InOutLoop left;
    InOutLoop right;
    DenseConcatPlan(const ValueType& lhs_type, const ValueType& rhs_type, std::string concat_dimension,
