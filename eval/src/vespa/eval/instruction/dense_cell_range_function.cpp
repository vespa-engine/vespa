...
template <typename CT> void my_cell_range_op(InterpretedFunction::State& state, uint64_t param) {
...
struct MyCellRangeOp {
    template <typename CT> static auto invoke() { return my_cell_range_op<CT>; }
};
