...
public:
    struct Self {
        ...
        size_t    vector_size;
        size_t    result_size;
        Self(const ValueType& result_type_in, size_t vector_size_in, size_t result_size_in);
        ~Self();
    };
...
public:
    DenseXWProductFunction(const ValueType& result_type, const TensorFunction& vector_in,
                           const TensorFunction& matrix_in, size_t vector_size, size_t result_size,
                           bool common_inner);
