...
TEST(ValueTypeTest, require_that_value_types_can_be_compared) {
    ...
    verify_equal(ValueType::make_type(CellType::DOUBLE, {{"x"}, {"y"}}),
                 ValueType::make_type(CellType::DOUBLE, {{"y"}, {"x"}}));
    verify_not_equal(ValueType::make_type(CellType::DOUBLE, {{"x"}, {"y"}}),
                     ValueType::make_type(CellType::DOUBLE, {{"x"}, {"y"}, {"z"}}));
    verify_equal(ValueType::make_type(CellType::DOUBLE, {{"x", 10}, {"y", 20}}),
                 ValueType::make_type(CellType::DOUBLE, {{"y", 20}, {"x", 10}}));
    verify_not_equal(ValueType::make_type(CellType::DOUBLE, {{"x", 10}, {"y", 20}}),
                     ValueType::make_type(CellType::DOUBLE, {{"x", 10}, {"y", 10}}));
    verify_not_equal(ValueType::make_type(CellType::DOUBLE, {{"x", 10}}),
                     ValueType::make_type(CellType::DOUBLE, {{"x"}}));
    verify_equal(ValueType::make_type(CellType::FLOAT, {{"x", 10}}),
                 ValueType::make_type(CellType::FLOAT, {{"x", 10}}));
    verify_equal(ValueType::make_type(CellType::BFLOAT16, {{"x", 10}}),
                 ValueType::make_type(CellType::BFLOAT16, {{"x", 10}}));
    verify_equal(ValueType::make_type(CellType::INT8, {{"x", 10}}),
                 ValueType::make_type(CellType::INT8, {{"x", 10}}));
    verify_not_equal(ValueType::make_type(CellType::DOUBLE, {{"x", 10}}),
                     ValueType::make_type(CellType::FLOAT, {{"x", 10}}));
    verify_not_equal(ValueType::make_type(CellType::FLOAT, {{"x", 10}}),
                     ValueType::make_type(CellType::BFLOAT16, {{"x", 10}}));
    verify_not_equal(ValueType::make_type(CellType::FLOAT, {{"x", 10}}),
                     ValueType::make_type(CellType::INT8, {{"x", 10}}));
    verify_not_equal(ValueType::make_type(CellType::BFLOAT16, {{"x", 10}}),
                     ValueType::make_type(CellType::INT8, {{"x", 10}}));
}
...
TEST(ValueTypeTest, require_that_value_type_can_make_spec) {
    ...
    EXPECT_EQ("tensor(x{},y[10],z[5])",
              ValueType::make_type(CellType::DOUBLE, {{"x"}, {"y", 10}, {"z", 5}}).to_spec());
    ...
    EXPECT_EQ("tensor<float>(x{},y[10],z[5])",
              ValueType::make_type(CellType::FLOAT, {{"x"}, {"y", 10}, {"z", 5}}).to_spec());
    ...
    EXPECT_EQ("tensor<bfloat16>(x{},y[10],z[5])",
              ValueType::make_type(CellType::BFLOAT16, {{"x"}, {"y", 10}, {"z", 5}}).to_spec());
    ...
    EXPECT_EQ("tensor<int8>(x{},y[10],z[5])",
              ValueType::make_type(CellType::INT8, {{"x"}, {"y", 10}, {"z", 5}}).to_spec());
}
...
TEST(ValueTypeTest, require_that_mapped_dimensions_can_be_stripped) {
    ...
    EXPECT_EQ(type("tensor<float>(a[1],b{},c[2],d{},e[3],f{})").strip_mapped_dimensions(),
              type("tensor<float>(a[1],c[2],e[3])"));
}
...
TEST(ValueTypeTest, require_that_indexed_dimensions_can_be_stripped) {
    ...
    EXPECT_EQ(type("tensor<float>(a[1],b{},c[2],d{},e[3],f{})").strip_indexed_dimensions(),
              type("tensor<float>(b{},d{},f{})"));
}
...
TEST(ValueTypeTest, require_that_value_types_can_be_wrapped_inside_each_other) {
    ...
    EXPECT_EQ(type("tensor<int8>(a{},c{})").wrap(type("tensor<int8>(b[10],d[5])")),
              type("tensor<int8>(a{},b[10],c{},d[5])"));
    EXPECT_EQ(type("tensor<int8>(x{})").wrap(type("tensor<int8>(x[10])")), type("error")); // dimension name conflict
    EXPECT_EQ(type("tensor<int8>(x{},z[2])").wrap(type("tensor<int8>(y[10])")),
              type("error")); // outer cannot have indexed dimensions
    EXPECT_EQ(type("tensor<int8>(x{})").wrap(type("tensor<int8>(y[10],z{})")),
              type("error")); // inner cannot have mapped dimensions
...
void verify_predicates(const ValueType& type, bool expect_error, bool expect_double, bool expect_tensor,
...
TEST(ValueTypeTest, require_that_cell_type_is_handled_correctly_for_concat) {
    ...
    verify_concat(type("tensor<bfloat16>(x[3])"), type("tensor<bfloat16>(x[2])"), "x",
                  type("tensor<bfloat16>(x[5])"));
