...
std::vector<std::pair<size_t, size_t>> run_two_loops(size_t idx1_in, size_t idx2_in, const std::vector<size_t>& loop,
                                                     const std::vector<size_t>& stride1,
...
std::vector<std::vector<size_t>> run_three_loops(size_t idx1_in, size_t idx2_in, size_t idx3_in,
                                                 const std::vector<size_t>& loop, const std::vector<size_t>& stride1,
                                                 const std::vector<size_t>& stride2,
                                                 const std::vector<size_t>& stride3) {
...
void verify_two(size_t idx1_in, size_t idx2_in, const std::vector<size_t>& loop, const std::vector<size_t>& stride1,
                const std::vector<size_t>& stride2) {
...
std::vector<size_t> v(std::vector<size_t> vec) {
    return vec;
}
