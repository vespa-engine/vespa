...
struct MyEvalTest : test::EvalSpec::EvalTest {
    ...
    void verify_result(const ValueBuilderFactory& factory, const Function& function, const std::string& description,
                       const SimpleParams& params, double expected_result) {
...
TEST(InterpretedFunctionTest, require_that_functions_with_non_compilable_simple_lambdas_cannot_be_interpreted) {
    ...
    std::cerr << "Example function issues:" << std::endl
              << ::testing::PrintToString(InterpretedFunction::detect_issues(*bad_join).list) << std::endl;
}
...
TEST(InterpretedFunctionTest, require_that_functions_with_non_interpretable_complex_lambdas_cannot_be_interpreted) {
    ...
    std::cerr << "Example function issues:" << std::endl
              << ::testing::PrintToString(InterpretedFunction::detect_issues(*bad_map_subspaces).list) << std::endl;
}
