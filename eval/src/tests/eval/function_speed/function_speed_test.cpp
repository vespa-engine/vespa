...
double big_gcc_function(double p, double o, double q, double f, double w) {
    return (0.35 * p + 0.15 * o + 0.30 * q + 0.20 * f) * w + (0.35 * p + 0.15 * o + 0.30 * q + 0.20 * f) * w +
           (0.35 * p + 0.15 * o + 0.30 * q + 0.20 * f) * w + (0.35 * p + 0.15 * o + 0.30 * q + 0.20 * f) * w;
}
...
struct Fixture {
    ...
    Fixture(const std::string& expr)
        : function(Function::parse(expr)),
          interpreted_simple(
              SimpleValueBuilderFactory::get(), *function,
