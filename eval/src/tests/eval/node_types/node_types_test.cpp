...
TEST(NodeTypesTest, require_that_tensor_map_subspace_resolves_correct_type) {
    ...
    verify("map_subspaces(tensor<int8>(y[10]), f(a)(a*tensor<int8>(z[2]):[a{y:0},a{y:1}]))",
           "tensor<float>(y[10],z[2])");
    ...
    verify("map_subspaces(tensor<float>(x{},y[10]), f(y)(y*tensor<float>(z[5])(z+3)))",
           "tensor<float>(x{},y[10],z[5])");
...
TEST(NodeTypesTest, require_that_tensor_filter_subspace_resolves_correct_type) {
    ...
    verify("filter_subspaces(tensor<int8>(x{},y[3]), f(a)(a))", "tensor<int8>(x{},y[3])",
           CheckFilterType("tensor<int8>(y[3])"));
    verify("filter_subspaces(tensor<bfloat16>(x{},y[3]), f(a)(a))", "tensor<bfloat16>(x{},y[3])",
           CheckFilterType("tensor<bfloat16>(y[3])"));
    verify("filter_subspaces(tensor<float>(x{},y[3]), f(a)(a))", "tensor<float>(x{},y[3])",
           CheckFilterType("tensor<float>(y[3])"));
    verify("filter_subspaces(tensor<double>(x{},y[3]), f(a)(a))", "tensor<double>(x{},y[3])",
           CheckFilterType("tensor<double>(y[3])"));
}
