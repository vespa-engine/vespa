...
TEST(DenseMatMulFunctionTest, require_that_matmul_can_be_optimized) {
    FunInfo details = {.lhs_size = 2, .common_size = 3, .rhs_size = 5, .lhs_inner = true, .rhs_inner = true};
...
TEST(DenseMatMulFunctionTest, require_that_MatMul_can_be_debug_dumped) {
    EvalFixture fixture(
        prod_factory, "reduce(x*y,sum,d)",
        EvalFixture::ParamRepo().add("x", GenSpec::from_desc("a2d3")).add("y", GenSpec::from_desc("b5d3")), true);
...
TEST(DenseMatMulFunctionTest, require_that_matmul_inner_outer_works_correctly) {
    FunInfo details = {.lhs_size = 2, .common_size = 5, .rhs_size = 3, .lhs_inner = true, .rhs_inner = false};
...
TEST(DenseMatMulFunctionTest, require_that_matmul_outer_outer_works_correctly) {
    FunInfo details = {.lhs_size = 2, .common_size = 5, .rhs_size = 3, .lhs_inner = false, .rhs_inner = false};
