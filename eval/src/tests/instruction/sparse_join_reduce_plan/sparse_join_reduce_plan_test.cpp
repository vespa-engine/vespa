...
struct Event {
    ...
    template <typename ADDR> Event(size_t a, size_t b, ADDR addr) : lhs_idx(a), rhs_idx(b), res_addr() {
        for (auto label : addr) {
...
struct Trace {
    ...
    Trace(size_t estimate_in) : estimate(estimate_in), events() {}
    ...
    bool operator==(const Trace& rhs) const noexcept { return estimate == rhs.estimate && events == rhs.events; }
};
...
Trace trace(size_t est) {
    return Trace(est);
}

Trace trace(const std::string& a_desc, const std::string& b_desc, const std::vector<std::string>& reduce_dims) {
    auto a = val(a_desc);
    auto b = val(b_desc);
...
TEST(SparseJoinReducePlanTest, traverse_order_can_be_swapped) {
    EXPECT_EQ(trace("x2_4", "y3_1", {}), trace(6)
                                             .add(0, 0, {"4", "1"})
                                             .add(0, 1, {"4", "2"})
                                             .add(0, 2, {"4", "3"})
                                             .add(1, 0, {"8", "1"})
                                             .add(1, 1, {"8", "2"})
                                             .add(1, 2, {"8", "3"}));
    EXPECT_EQ(trace("y3_1", "x2_4", {}), trace(6)
                                             .add(0, 0, {"4", "1"})
                                             .add(1, 0, {"4", "2"})
                                             .add(2, 0, {"4", "3"})
                                             .add(0, 1, {"8", "1"})
...
TEST(SparseJoinReducePlanTest, no_overlap_no_reduce) {
    EXPECT_EQ(trace("x2_1", "y3_1", {}), trace(6)
                                             .add(0, 0, {"1", "1"})
                                             .add(0, 1, {"1", "2"})
                                             .add(0, 2, {"1", "3"})
                                             .add(1, 0, {"2", "1"})
...
TEST(SparseJoinReducePlanTest, no_overlap_reduce_last) {
    EXPECT_EQ(trace("x2_1", "y3_1", {"y"}), trace(2)
                                                .add(0, 0, {"1"})
                                                .add(0, 1, {"1"})
                                                .add(0, 2, {"1"})
                                                .add(1, 0, {"2"})
...
TEST(SparseJoinReducePlanTest, no_overlap_reduce_first) {
    EXPECT_EQ(trace("x2_1", "y3_1", {"x"}), trace(3)
                                                .add(0, 0, {"1"})
                                                .add(0, 1, {"2"})
                                                .add(0, 2, {"3"})
                                                .add(1, 0, {"1"})
...
TEST(SparseJoinReducePlanTest, no_overlap_reduce_all) {
    EXPECT_EQ(trace("x2_1", "y3_1", {"x", "y"}),
              trace(1).add(0, 0, {}).add(0, 1, {}).add(0, 2, {}).add(1, 0, {}).add(1, 1, {}).add(1, 2, {}));
...
TEST(SparseJoinReducePlanTest, partial_overlap_no_reduce) {
    EXPECT_EQ(trace("x2_1y1_1", "y1_1z2_3", {}), trace(2)
                                                     .add(0, 0, {"1", "1", "3"})
                                                     .add(0, 1, {"1", "1", "6"})
                                                     .add(1, 0, {"2", "1", "3"})
                                                     .add(1, 1, {"2", "1", "6"}));
...
TEST(SparseJoinReducePlanTest, partial_overlap_reduce_first) {
    EXPECT_EQ(trace("x2_1y1_1", "y1_1z2_3", {"x"}),
              trace(2).add(0, 0, {"1", "3"}).add(0, 1, {"1", "6"}).add(1, 0, {"1", "3"}).add(1, 1, {"1", "6"}));
...
TEST(SparseJoinReducePlanTest, partial_overlap_reduce_middle) {
    EXPECT_EQ(trace("x2_1y1_1", "y1_1z2_3", {"y"}),
              trace(2).add(0, 0, {"1", "3"}).add(0, 1, {"1", "6"}).add(1, 0, {"2", "3"}).add(1, 1, {"2", "6"}));
...
TEST(SparseJoinReducePlanTest, partial_overlap_reduce_last) {
    EXPECT_EQ(trace("x2_1y1_1", "y1_1z2_3", {"z"}),
              trace(2).add(0, 0, {"1", "1"}).add(0, 1, {"1", "1"}).add(1, 0, {"2", "1"}).add(1, 1, {"2", "1"}));
...
TEST(SparseJoinReducePlanTest, partial_overlap_reduce_all) {
    EXPECT_EQ(trace("x2_1y1_1", "y1_1z2_3", {"x", "y", "z"}),
              trace(1).add(0, 0, {}).add(0, 1, {}).add(1, 0, {}).add(1, 1, {}));
