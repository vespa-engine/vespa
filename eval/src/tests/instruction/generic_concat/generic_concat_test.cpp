...
const std::vector<GenSpec> concat_layouts = {G(),
                                             G(),
                                             G(),
                                             G().idx("y", 5),
                                             G().idx("y", 5),
                                             ...
                                             G().idx("y", 3).idx("z", 5),
                                             G().idx("y", 4).idx("z", 5),
                                             G().idx("x", 2).idx("y", 3).idx("z", 5),
                                             G().idx("x", 2).idx("y", 3).idx("z", 5),
                                             G().idx("x", 2).idx("y", 3).idx("z", 5),
                                             G().idx("x", 2).idx("y", 4).idx("z", 5),
                                             G().idx("x", 2).idx("y", 3).map("z", {"a", "b"}),
                                             G().idx("x", 2).idx("y", 3).map("z", {"b", "c"}),
                                             G().idx("x", 2).idx("y", 3).map("z", {"a", "b"}),
                                             G().idx("x", 2).idx("y", 4).map("z", {"b", "c"}),
                                             G().idx("y", 5),
                                             G().idx("x", 5).idx("y", 2),
                                             G().idx("x", 3),
                                             G().idx("y", 2).idx("z", 3),
                                             G().idx("y", 2),
                                             G().idx("x", 5).idx("y", 3).idx("z", 2),
                                             G().idx("x", 5).idx("y", 2).idx("z", 2),
                                             G().idx("x", 5).idx("y", 3).idx("z", 2),
                                             G().idx("x", 5).idx("y", 3),
                                             G().idx("x", 5).idx("z", 7),
                                             G().map("x", {"a", "b", "c"}),
                                             ...
                                             G().map("x", {"b", "c", "d"}),
                                             G().map("x", {"a", "b", "c"}),
                                             G().map("x", {"a", "b", "c"}).map("z", {"foo", "bar", "baz"}),
                                             G().map("x", {"a", "b"}).map("z", {"foo", "bar", "baz"}),
                                             G().map("x", {"a", "b", "c"}).map("z", {"foo", "bar"}),
                                             G().map("x", {"a", "b", "c"}).idx("y", 3),
                                             G().idx("y", 2),
                                             G().map("x", {"a", "b", "c"}).idx("y", 3),
                                             G().idx("z", 5),
                                             G().map("x", {"a", "b", "c"}).idx("y", 3),
                                             ...
                                             G().idx("y", 2).idx("z", 5),
                                             G().map("x", {"a", "b", "c"}).idx("y", 3).idx("z", 5),
                                             G().map("x", {"a", "b", "c"}).idx("y", 2),
                                             G().map("x", {"b", "c", "d"}).idx("y", 3),
                                             G().map("x", {"a", "b"}).idx("y", 2),
                                             G().idx("y", 3).map("z", {"c", "d"})};
