...
TEST(DenseMultiMatMulFunctionTest, require_that_multi_matmul_can_be_optimized) {
    FunInfo details = {
        .lhs_size = 2, .common_size = 3, .rhs_size = 5, .matmul_cnt = 6, .lhs_inner = true, .rhs_inner = true};
...
TEST(DenseMultiMatMulFunctionTest, require_that_single_multi_matmul_can_be_optimized) {
    FunInfo details = {
        .lhs_size = 2, .common_size = 3, .rhs_size = 5, .matmul_cnt = 1, .lhs_inner = true, .rhs_inner = true};
...
TEST(DenseMultiMatMulFunctionTest, require_that_multi_matmul_function_can_be_debug_dumped) {
    EvalFixture fixture(prod_factory, "reduce(m1*m2,sum,d)",
                        EvalFixture::ParamRepo()
                            .add("m1", GenSpec::from_desc("A2B1C3a2d3"))
                            .add("m2", GenSpec::from_desc("A2B1C3b5d3")),
                        true);
...
TEST(DenseMultiMatMulFunctionTest, require_that_multi_matmul_inner_outer_works_correctly) {
    FunInfo details = {
        .lhs_size = 2, .common_size = 5, .rhs_size = 3, .matmul_cnt = 6, .lhs_inner = true, .rhs_inner = false};
...
TEST(DenseMultiMatMulFunctionTest, require_that_multi_matmul_outer_outer_works_correctly) {
    FunInfo details = {
        .lhs_size = 2, .common_size = 5, .rhs_size = 3, .matmul_cnt = 6, .lhs_inner = false, .rhs_inner = false};
