...
SimpleMessage::SimpleMessage(const string& str) : Message(), _value(str), _hasSeqId(false), _seqId(0) {
}

SimpleMessage::SimpleMessage(const string& str, bool hasSeqId, uint64_t seqId)
    : Message(), _value(str), _hasSeqId(hasSeqId), _seqId(seqId) {
}

SimpleMessage::~SimpleMessage() {
}

void SimpleMessage::setValue(const string& value) {
    _value = value;
}

const string& SimpleMessage::getValue() const {
    return _value;
}

int SimpleMessage::getHash() const {
    int    hash = 0;
    string str = _value;
...
const string& SimpleMessage::getProtocol() const {
    return SimpleProtocol::NAME;
}

uint32_t SimpleMessage::getType() const {
    return SimpleProtocol::MESSAGE;
}

bool SimpleMessage::hasSequenceId() const {
    return _hasSeqId;
}

uint64_t SimpleMessage::getSequenceId() const {
    return _seqId;
}

uint32_t SimpleMessage::getApproxSize() const {
    return _value.size();
}
