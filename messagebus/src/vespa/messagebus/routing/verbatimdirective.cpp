...
VerbatimDirective::VerbatimDirective(std::string_view image) : _image(image) {
    // empty
}

VerbatimDirective::~VerbatimDirective() = default;

bool VerbatimDirective::matches(const IHopDirective& dir) const {
...
string VerbatimDirective::toString() const {
    return _image;
}

string VerbatimDirective::toDebugString() const {
