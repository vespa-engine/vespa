...
public class MockNodeRepository extends NodeRepository {
    ...
    private void populate() {
        ...
        // Regular nodes
        nodes.add(createNode("node1", "host1.yahoo.com", ipAddresses(1), Optional.empty(),
                             flavors.getFlavorOrThrow("default"), NodeType.tenant));
        nodes.add(createNode("node2", "host2.yahoo.com", ipAddresses(2), Optional.empty(),
                             flavors.getFlavorOrThrow("default"), NodeType.tenant));
        nodes.add(createNode("node3", "host3.yahoo.com", ipAddresses(3), Optional.empty(),
                             flavors.getFlavorOrThrow("expensive"), NodeType.tenant));
        Node node4 = createNode("node4", "host4.yahoo.com", ipAddresses(4), Optional.of("dockerhost1.yahoo.com"),
        ...
        Node node5 = createNode("node5", "host5.yahoo.com", ipAddresses(5), Optional.of("dockerhost2.yahoo.com"),
                                new Flavor(new NodeResources(1, 1, 100)), NodeType.tenant);
        ...
        nodes.add(createNode("node6", "host6.yahoo.com", ipAddresses(6), Optional.empty(),
                             flavors.getFlavorOrThrow("default"), NodeType.tenant));
        Node node7 = createNode("node7", "host7.yahoo.com", ipAddresses(7), Optional.empty(),
                                flavors.getFlavorOrThrow("default"), NodeType.tenant);
        nodes.add(node7);

        // 8, 9, 11 and 12 are added by web service calls
        Node node10 = createNode("node10", "host10.yahoo.com", ipAddresses(10), Optional.of("parent1.yahoo.com"),
                                 flavors.getFlavorOrThrow("default"), NodeType.tenant);
        ...
        Node node13 = createNode("node13", "host13.yahoo.com", ipAddresses(13), Optional.empty(),
                                 flavors.getFlavorOrThrow("large"), NodeType.tenant);
        Node node14 = createNode("node14", "host14.yahoo.com", ipAddresses(14), Optional.empty(),
                                 flavors.getFlavorOrThrow("large"), NodeType.tenant);
        nodes.add(node13);
        nodes.add(node14);

        Node node55 = createNode("node55", "host55.yahoo.com", ipAddresses(55), Optional.empty(),
                                 flavors.getFlavorOrThrow("default"), NodeType.tenant);
        ...
        nodes.add(createNode("dockerhost1", "dockerhost1.yahoo.com", ipAddresses(100, 1, 3), Optional.empty(), Optional.empty(),
                             flavors.getFlavorOrThrow("large"), NodeType.host));
        nodes.add(createNode("dockerhost2", "dockerhost2.yahoo.com", ipAddresses(101, 1, 3), Optional.empty(), Optional.empty(),
                             flavors.getFlavorOrThrow("large"), NodeType.host));
        nodes.add(createNode("dockerhost3", "dockerhost3.yahoo.com", ipAddresses(102, 1, 3), Optional.empty(), Optional.empty(),
                             flavors.getFlavorOrThrow("large"), NodeType.host));
        nodes.add(createNode("dockerhost4", "dockerhost4.yahoo.com", ipAddresses(103, 1, 3), Optional.empty(), Optional.empty(),
                             flavors.getFlavorOrThrow("large"), NodeType.host));
        nodes.add(createNode("dockerhost5", "dockerhost5.yahoo.com", ipAddresses(104, 1, 3), Optional.empty(), Optional.empty(),
                             flavors.getFlavorOrThrow("large"), NodeType.host));

        // Config servers
        nodes.add(createNode("cfg1", "cfg1.yahoo.com", ipAddresses(201), Optional.empty(),
                             flavors.getFlavorOrThrow("default"), NodeType.config));
        nodes.add(createNode("cfg2", "cfg2.yahoo.com", ipAddresses(202), Optional.empty(),
                             flavors.getFlavorOrThrow("default"), NodeType.config));
    ...
    private IP.Config ipAddresses(int nodeIndex, int primarySize, int poolSize) {
    ...
    private IP.Config ipAddresses(int nodeIndex) {
        return ipAddresses(nodeIndex, 1, 0);
    }
