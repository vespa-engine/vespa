...
public record AllocationParams(NodeRepository nodeRepository,
     ...
     */
    public AllocationParams with(ClusterSpec cluster) { return from(nodeRepository, application, cluster, sharedHost); }

    private static AllocationParams from(NodeRepository nodeRepository, ApplicationId application, ClusterSpec cluster, SharedHost sharedHost) {
