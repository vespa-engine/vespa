...
public class IPTest {
    ...
    private static final LockedNodeList emptyList = new LockedNodeList(Collections.emptyList(), () -> {});
    ...
    private static Node createNode(Set<String> ipAddressPool) {
        return Node.create("id1", new IP.Config(Set.of("127.0.0.1"), ipAddressPool),
