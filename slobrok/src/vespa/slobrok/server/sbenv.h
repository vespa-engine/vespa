...
public:
    ...
    ServiceMapHistory& globalHistory() { return _globalVisibleHistory; }

    LocalRpcMonitorMap& localMonitorMap() { return _localRpcMonitorMap; }

    ServiceMapHistory& localHistory() { return _localRpcMonitorMap.history(); }

    UnionServiceMap& consensusMap() { return _consensusMap; }
    ...
    void setConsensusTime(unsigned long value) { _rpcHooks.setConsensusTime(value); }
};
