...
int Slobrok_CMD::main(int argc, char** argv) {
    ...
    if (strcmp(argv[2], "slobrok.admin.listAllRpcServers") == 0) {
        ...
        // no params
               ...
               strcmp(argv[2], "slobrok.system.stop") == 0 || strcmp(argv[2], "slobrok.system.version") == 0 ||
               strcmp(argv[2], "system.stop") == 0)
    {
        ...
        req->GetParams()->AddString(argv[3]);
                ...
                strcmp(argv[2], "slobrok.admin.addPeer") == 0 || strcmp(argv[2], "slobrok.admin.removePeer") == 0) &&
               argc == 5)
    {
        // two params
        req->GetParams()->AddString(argv[3]);
