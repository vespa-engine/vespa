...
void version() {
    std::cout << "fsainfo " << FSA::VER / 1000000 << "." << (FSA::VER / 1000) % 1000 << "." << FSA::VER % 1000;
    ...
    if (fd < 0) {
        ...
        if (r < sizeof(header) || header._magic != FSA::MAGIC) {
            ...
            std::cout << "  Version:           " << header._version / 1000000 << "."
                      << (header._version % 1000000) / 1000 << "." << header._version % 1000 << std::endl;
            ...
            std::cout << "  Total size:        "
                      << (header._size *
                          ...
                          header._data_size + sizeof(header))
                      << " bytes" << std::endl;
