...
public:
    ...
    public:
         ...
         */
        virtual bool hasPerfectHash() const { return _fsa->hasPerfectHash(); }
         ...
         */
        virtual bool isValid() const { return _state > 0; }
         ...
         */
        virtual bool tryDelta(symbol_t in) { return _fsa->delta(_state, in) != 0; }
         ...
         */
        virtual bool isFinal() const { return _fsa->isFinal(_state); }
         ...
         */
        virtual int dataSize() const { return _fsa->dataSize(_state); }
         ...
         *         range.
         */
        virtual std::string revLookup(hash_t hash) const { return _fsa->revLookup(hash); }
    ...
    public:
         ...
         * @return Hash value.
         */
        hash_t hash() const override { return _hash; }
         ...
         * @return Hash value.
         */
        virtual hash_t getHash() const { return _hash; }
    };
    ...
    public:
         ...
         */
        virtual uint32_t counter() const { return _counter; }
         ...
         * @return Counter value.
         */
        virtual uint32_t getCounter() const { return _counter; }
    };
    // }}}
    ...
    public:
         ...
         * @return Memory value.
         */
        virtual std::string memory() const { return _memory; }
         ...
         * @return Memory value.
         */
        virtual std::string getMemory() const { return _memory; }
    };
...
public:
     ...
     */
    enum Data_Type { DATA_VARIABLE = 0, DATA_FIXED };
...
public:
     ...
     */
    bool hasPerfectHash() const { return _has_perfect_hash; }
     ...
     */
    state_t start() const noexcept { return _start; }
...
private:
    ...
    FSA(Descriptor& d)
        : _mmap_addr(nullptr),
          ...
          _size(d._size),
          _data(d._data),
          _data_size(d._data_size),
          _data_type(d._data_type),
          _fixed_data_size(d._fixed_data_size),
          _has_perfect_hash(d._perf_hash != nullptr),
          _perf_hash(d._perf_hash),
          _start(d._start) {}
