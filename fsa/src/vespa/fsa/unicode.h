...
public:
    ...
    static bool hasProperty(ucs4_t testchar, unsigned char testprops) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & testprops) != 0);
    }
    ...
    static bool isWordChar(ucs4_t testchar) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & _wordcharProp) != 0);
    }
    ...
    static bool isIdeographicChar(ucs4_t testchar) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & _ideographicProp) != 0);
    }
    ...
    static bool isIgnorableChar(ucs4_t testchar) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & _ignorableControlCharProp) != 0);
    }
     ...
     */
    static bool isIDStartChar(ucs4_t testchar) { return (testchar < 256 && _isidstartchar[testchar] != 0); }
     ...
     */
    static bool isIDChar(ucs4_t testchar) { return (testchar < 256 && _isidchar[testchar] != 0); }
    ...
    static bool isDigit(ucs4_t testchar) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & _decimalDigitCharProp) != 0);
    }
     ...
     */
    static bool isIntegerIndexOp(ucs4_t testchar) { return (testchar < 256 && _isintegerindexop[testchar] != 0); }
    ...
    static bool isSpaceChar(ucs4_t testchar) {
        return (testchar < 65536 && (_compCharProps[testchar >> 8][testchar & 255] & _spaceProp) != 0);
    }
     ...
     */
    static unsigned char getUTF8ByteLength(unsigned char utf8char) { return _utf8header[utf8char]; }
     ...
     */
    static ucs4_t getUTF8Char(unsigned const char *&src, int length = -1);
    static ucs4_t getUTF8Char(char *&src, int length = -1) {
     ...
     */
    static int utf8move(unsigned const char *start, size_t length, unsigned const char *&pos, off_t offset);
};
