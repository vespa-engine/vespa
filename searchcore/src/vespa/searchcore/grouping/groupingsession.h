...
public:
     ...
     **/
    GroupingSession(const SessionId& sessionId, GroupingContext& groupingContext,
                    const attribute::IAttributeContext& attrCtx, const document::DocumentType* documentType);
     ...
     * @param attrCtx attribute context.
     **/
    std::unique_ptr<GroupingContext> createThreadContext(size_t                              thread_id,
