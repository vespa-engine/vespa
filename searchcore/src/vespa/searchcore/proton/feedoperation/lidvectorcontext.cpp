...
LidVectorContext::LidVectorContext(size_t docIdLimit) : _result(), _docIdLimit(docIdLimit) {
}

LidVectorContext::LidVectorContext() : _result(), _docIdLimit(0) {
}

LidVectorContext::LidVectorContext(size_t docIdLimit, const LidVector& lids)
    : _result(lids), _docIdLimit(docIdLimit) {
}

void LidVectorContext::addLid(const search::DocumentIdT lid) {
...
void LidVectorContext::deserialize(vespalib::nbostream& is) {
    int32_t  format;
    uint64_t docIdLimit;
    is >> docIdLimit;
