...
ReprocessDocumentsTask::ReprocessDocumentsTask(IReprocessingInitializer&                                initializer,
...
void ReprocessDocumentsTask::run() {
    if (_handler.hasProcessors()) {
...
void ReprocessDocumentsTask::updateProgress(double progress) {
...
IReprocessingTask::Progress ReprocessDocumentsTask::getProgress() const {
