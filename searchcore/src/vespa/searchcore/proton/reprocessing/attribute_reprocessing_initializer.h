...
public:
    ...
    public:
        Config(const proton::IAttributeManager::SP& attrMgr, const search::index::Schema& schema)
            : _attrMgr(attrMgr), _schema(schema) {}
...
public:
    AttributeReprocessingInitializer(const Config& newCfg, const Config& oldCfg,
