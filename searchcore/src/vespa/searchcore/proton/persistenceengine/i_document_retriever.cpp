...
document::Document::UP IDocumentRetriever::getDocument(search::DocumentIdT         lid,
                                                       const document::DocumentId& docId) const {
    return getPartialDocument(lid, docId, document::AllFields());
}

document::Document::UP IDocumentRetriever::getPartialDocument(search::DocumentIdT lid, const document::DocumentId&,
...
void DocumentRetrieverBaseForTest::visitDocuments(const LidVector& lids, search::IDocumentVisitor& visitor,
