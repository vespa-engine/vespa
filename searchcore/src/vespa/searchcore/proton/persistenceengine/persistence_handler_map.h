...
public:
    ...
    public:
        ...
        HandlerSnapshot(DocTypeToHandlerMap::Snapshot handlers_) : _handlers(std::move(handlers_)) {}
    ...
    public:
        ...
        UnsafeHandlerSnapshot(DocTypeToHandlerMap::UnsafeSnapshot handlers_) : _handlers(std::move(handlers_)) {}
...
public:
    ...
    PersistenceHandlerSP putHandler(document::BucketSpace bucketSpace, const DocTypeName& docType,
