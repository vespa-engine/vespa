...
public:
     ...
     */
    DocumentMetaStoreContext(std::shared_ptr<bucketdb::BucketDBOwner> bucketDB, const std::string& name,
    ...
    IReadGuard::SP getReadGuard() const override { return std::make_shared<ReadGuard>(_metaStoreAttr); }
