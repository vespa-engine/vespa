...
public:
    WriteDocumentId(search::BufferWriter& writer, MetadataView metadata_view, const DocumentIdStore& docid_store)
        : _writer(writer), _metadata_view(metadata_view), _docid_store(docid_store) {}
...
DocumentIdSaver::DocumentIdSaver(const GidIterator& gid_iterator, MetadataView metadata_view,
                                 const DocumentIdSaver::DocumentIdStore& docid_store)
    : _gid_iterator(gid_iterator), _metadata_view(metadata_view), _docid_store(docid_store) {
}
