...
JoinBucketsSession::JoinBucketsSession(BucketDBOwner& bucketDB, IBucketCreateNotifier& bucketCreateNotifier,
                                       const BucketId& source1, const BucketId& source2, const BucketId& target)
...
bool JoinBucketsSession::mustFixupTargetActiveLids(bool movedSource1Docs, bool movedSource2Docs) const {
    return _adjustTargetActiveLids || (_adjustSource1ActiveLids && movedSource1Docs) ||
           (_adjustSource2ActiveLids && movedSource2Docs);
}

void JoinBucketsSession::applyDeltas(const BucketDeltaPair& deltas) {
