...
BucketCreateNotifier::BucketCreateNotifier() : _listeners() {
}
...
void BucketCreateNotifier::addListener(IBucketCreateListener* listener) {
    _listeners.push_back(listener);
}

void BucketCreateNotifier::removeListener(IBucketCreateListener* listener) {
