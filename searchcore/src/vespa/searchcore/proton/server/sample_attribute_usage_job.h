...
public:
    SampleAttributeUsageJob(IAttributeManagerSP readyAttributeManager, IAttributeManagerSP notReadyAttributeManager,
                            AttributeUsageFilter& attributeUsageFilter, const std::string& docTypeName,
                            vespalib::duration interval, std::shared_ptr<searchcorespi::IIndexManager> index_manager);
