...
public:
    ...
    virtual void handlePruneRemovedDocuments(const PruneRemovedDocumentsOperation& pruneOp,
                                             const DoneCallback&                   onDone) = 0;
    ...
    void forceCommit(search::SerialNum serialNum) {
        forceCommit(CommitParam(serialNum, CommitParam::UpdateStats::SKIP));
    }
