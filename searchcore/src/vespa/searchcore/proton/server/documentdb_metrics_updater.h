...
class DocumentDBMetricsUpdater {
    ...
    void updateMiscMetrics(DocumentDBTaggedMetrics&             metrics,
...
public:
    DocumentDBMetricsUpdater(const DocumentSubDBCollection& subDBs, ExecutorThreadingService& writeService,
                             DocumentDBJobTrackers& jobTrackers, const AttributeUsageFilter& writeFilter,
