...
public:
    ...
    std::shared_ptr<DocumentMetaStoreInitializerResult::SP> writableDocumentMetaStore() { return _documentMetaStore; }
    DocumentMetaStoreInitializerResult::SP documentMetaStore() const { return *_documentMetaStore; }
    std::shared_ptr<SummaryManager::SP> writableSummaryManager() { return _summaryManager; }
    SummaryManager::SP summaryManager() const { return *_summaryManager; }
    std::shared_ptr<AttributeManager::SP> writableAttributeManager() { return _attributeManager; }
    AttributeManager::SP attributeManager() const { return *_attributeManager; }
    std::shared_ptr<searchcorespi::IIndexManager::SP> writableIndexManager() { return _indexManager; }
    searchcorespi::IIndexManager::SP indexManager() const { return *_indexManager; }
