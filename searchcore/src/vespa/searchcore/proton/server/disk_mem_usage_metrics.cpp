...
DiskMemUsageMetrics::DiskMemUsageMetrics() noexcept : DiskMemUsageMetrics(ResourceUsageState()) {
}
...
DiskMemUsageMetrics::DiskMemUsageMetrics(const ResourceUsageState& usage) noexcept
    : _total_disk_usage(usage.diskState().usage()),
      ...
      _non_transient_disk_usage_and_reserved_disk_space(usage.non_transient_disk_usage() +
...
void DiskMemUsageMetrics::merge(const ResourceUsageState& usage) noexcept {
    ...
    _reserved_disk_space = std::max(_reserved_disk_space, usage.reserved_disk_space());
    _non_transient_disk_usage_and_reserved_disk_space =
        std::max(_non_transient_disk_usage_and_reserved_disk_space,
                 usage.non_transient_disk_usage() + usage.reserved_disk_space());
