...
private:
    ...
    void reconfigureSearchView(std::shared_ptr<ISummaryManager::ISummarySetup> summarySetup,
...
public:
    ...
    SearchableDocSubDBConfigurer(const std::shared_ptr<ISummaryManager>& summaryMgr, SearchViewHolder& searchView,
