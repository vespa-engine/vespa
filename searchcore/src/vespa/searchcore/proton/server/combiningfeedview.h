...
private:
    ...
    IFeedView* getReadyFeedView() { return _views[getReadyFeedViewId()].get(); }

    IFeedView* getRemFeedView() { return _views[getRemFeedViewId()].get(); }

    IFeedView* getNotReadyFeedView() { return _views[getNotReadyFeedViewId()].get(); }

    bool hasNotReadyFeedView() const { return _views.size() > getNotReadyFeedViewId(); }
...
public:
    ...
    CombiningFeedView(const std::vector<IFeedView::SP>& views, document::BucketSpace bucketSpace,
