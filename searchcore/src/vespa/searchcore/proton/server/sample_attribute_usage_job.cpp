...
CountIndexesVisitor::CountIndexesVisitor() : searchcorespi::IndexSearchableVisitor(), _indexes(0) {
}
...
SampleAttributeUsageJob::SampleAttributeUsageJob(IAttributeManagerSP   readyAttributeManager,
                                                 IAttributeManagerSP   notReadyAttributeManager,
                                                 AttributeUsageFilter& attributeUsageFilter,
                                                 const std::string& docTypeName, vespalib::duration interval,
...
bool SampleAttributeUsageJob::run() {
