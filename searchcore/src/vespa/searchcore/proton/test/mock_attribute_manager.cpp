...
MockAttributeManager::MockAttributeManager() : _mock(), _writables(), _importedAttributes(), _writer(), _shared() {
}

MockAttributeManager::~MockAttributeManager() = default;

ResourceUsage MockAttributeManager::get_resource_usage() const {
    return {};
}
