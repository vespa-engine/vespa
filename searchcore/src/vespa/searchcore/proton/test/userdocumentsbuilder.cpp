...
UserDocumentsBuilder::UserDocumentsBuilder() : _builder(), _docs() {
}

UserDocumentsBuilder::~UserDocumentsBuilder() = default;

UserDocumentsBuilder& UserDocumentsBuilder::createDoc(uint32_t userId, search::DocumentIdT lid) {
...
UserDocumentsBuilder& UserDocumentsBuilder::createDocs(uint32_t userId, search::DocumentIdT begin,
