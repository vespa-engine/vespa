...
std::shared_ptr<IDocumentDBReferenceRegistry> DummyDBOwner::getDocumentDBReferenceRegistry() const {
    return _registry;
}

matching::SessionManager& DummyDBOwner::session_manager() {
    return *_sessionManager;
}

std::shared_ptr<MaintenanceJobTokenSource> DummyDBOwner::get_lid_space_compaction_job_token_source() {
    return _lid_space_compaction_job_token_source;
}

std::shared_ptr<vespalib::SharedOperationThrottler> DummyDBOwner::shared_replay_throttler() const {
