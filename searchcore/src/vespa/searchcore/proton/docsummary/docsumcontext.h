 ...
 **/
class DocsumContext : public search::docsummary::GetDocsumsStateCallback, public search::QueryNormalization {
private:
...
public:
    ...
    DocsumContext(const search::engine::DocsumRequest& request, search::docsummary::IDocsumWriter& docsumWriter,
                  search::docsummary::IDocsumStore& docsumStore, std::shared_ptr<matching::Matcher> matcher,
                  matching::ISearchContext& searchCtx, search::attribute::IAttributeContext& attrCtx,
                  const search::IAttributeManager& attrMgr, matching::SessionManager& sessionMgr);
