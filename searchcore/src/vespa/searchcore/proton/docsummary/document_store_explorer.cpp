...
DocumentStoreExplorer::DocumentStoreExplorer(ISummaryManager::SP mgr) : _mgr(std::move(mgr)) {
}

namespace {

void setMemoryUsage(Cursor& object, const vespalib::MemoryUsage& usage) {
...
void DocumentStoreExplorer::get_state(const Inserter& inserter, bool full) const {
