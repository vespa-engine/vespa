...
MatchingStats& MatchingStats::merge_partition(const Partition& partition, size_t id) {
...
MatchingStats& MatchingStats::add(const MatchingStats& rhs) noexcept {
...
MatchingStats& MatchingStats::updatesoftDoomFactor(vespalib::duration hardLimit, vespalib::duration softLimit,
