                                                   ...
                                                   uint32_t active_docids, uint32_t docid_limit)
{
    ...
    double acorn_one_upper_limit = AcornOneUpperLimit::lookup(rank_properties, rank_setup.get_acorn_one_upper_limit());
    double acorn_one_exploration = AcornOneExploration::lookup(rank_properties, rank_setup.get_acorn_one_exploration());
    ...
    return {lower_limit * active_hit_ratio,
            ...
            acorn_one_upper_limit * active_hit_ratio,
            acorn_one_exploration,
