...
public:
    ...
    RequestContext(const Doom& softDoom, vespalib::ThreadBundle& threadBundle, IAttributeContext& attributeContext,
                   const search::fef::IQueryEnvironment& query_env, search::fef::IObjectStore& shared_store,
    ...
    const MetaStoreReadGuardSP* getMetaStoreReadGuard() const override { return _metaStoreReadGuard; }
