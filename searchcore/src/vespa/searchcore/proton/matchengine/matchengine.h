...
class MatchEngine : public search::engine::SearchServer, public vespalib::StateExplorer {
private:
    std::mutex                         _lock;
...
public:
     ...
     */
    std::unique_ptr<search::engine::SearchReply> performSearch(search::engine::SearchRequest::Source req);
    ...
    search::engine::SearchReply::UP search(search::engine::SearchRequest::Source request,
