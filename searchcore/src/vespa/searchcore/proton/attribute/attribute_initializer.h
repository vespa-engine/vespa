...
private:
    ...
    bool                            _header_ok;
    AttributeInitializationStatusWrapper::SP _initializationStatusWrapper;
...
public:
    ...
    AttributeInitializationStatusWrapper::SP getInitializationStatusWrapper() const { return _initializationStatusWrapper; }
};
