...
AttributeConfigInspector::AttributeConfigInspector(const AttributesConfig& config) : _hash() {
...
const Config* AttributeConfigInspector::get_config(const std::string& name) const {
