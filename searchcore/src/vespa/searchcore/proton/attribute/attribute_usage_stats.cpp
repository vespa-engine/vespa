...
AttributeUsageStats::AttributeUsageStats() : AttributeUsageStats("") {
}

AttributeUsageStats::AttributeUsageStats(const std::string& document_type_in)
    : _max_usage(vespalib::AddressSpace()), _document_type(document_type_in) {
}
...
void AttributeUsageStats::merge(const search::AddressSpaceUsage& usage, const std::string& attributeName,
