...
AttributesConfigScout::AttributesConfigScout(const AttributesConfig& live) : _live(live), _map() {
    uint32_t i = 0;
...
void AttributesConfigScout::adjust(AttributesConfig::Attribute& attr, const AttributesConfig::Attribute& liveAttr) {
...
void AttributesConfigScout::adjust(AttributesConfig::Attribute& attr) {
...
AttributesConfigScout::adjust(const AttributesConfig& config) {
    std::shared_ptr<AttributesConfigBuilder> result = std::make_shared<AttributesConfigBuilder>(config);
