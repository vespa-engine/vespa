...
template <typename Entry> FieldMetrics<Entry>::FieldMetrics(metrics::MetricSet* parent) : _parent(parent), _fields() {
}

template <typename Entry> FieldMetrics<Entry>::~FieldMetrics() {
}

template <typename Entry> void FieldMetrics<Entry>::set_fields(std::vector<std::string> field_names) {
...
std::shared_ptr<Entry> FieldMetrics<Entry>::get_field_metrics_entry(const std::string& field_name) const {
