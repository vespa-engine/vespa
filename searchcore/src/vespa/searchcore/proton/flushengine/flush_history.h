...
class FlushHistory {
     ...
     * and later _finished when the flush has completed. The oldest entries in _finished can be removed due to
     * pruning.
     *
    ...
    std::map<uint32_t, FlushStrategyHistoryEntry>
                              _draining_strategies; // inactive flush strategies with active flushes
