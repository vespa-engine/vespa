...
private:
    ...
    std::unique_ptr<ImportedAttributesRepo>
    createImportedAttributesRepo(const search::IAttributeManager&                          attrMgr,
...
public:
    DocumentDBReferenceResolver(const IDocumentDBReferenceRegistry& registry,
                                ...
                                const document::DocumentType& prevThisDocType, vespalib::MonitoredRefCount& refCount,
                                vespalib::ISequencedTaskExecutor& attributeFieldWriter, bool useReferences);
