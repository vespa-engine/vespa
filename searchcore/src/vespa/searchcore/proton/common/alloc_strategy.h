...
public:
    AllocStrategy(const search::GrowStrategy& grow_strategy, const CompactionStrategy& compaction_strategy,
    ...
    bool operator!=(const AllocStrategy& rhs) const noexcept { return !operator==(rhs); }
