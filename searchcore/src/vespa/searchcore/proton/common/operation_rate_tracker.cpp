...
void OperationRateTracker::observe(vespalib::steady_time now) {
...
bool OperationRateTracker::above_threshold(vespalib::steady_time now) const {
    return _threshold_time > now;
}

void OperationRateTracker::reset(vespalib::steady_time now) {
