...
public:
    ...
    static void lidSpaceCompactionRestart(const string& subDbName, uint32_t usedLids, uint32_t allowedLidBloat,
    ...
    static void loadAttributeComplete(const std::string& subDbName, const std::string& attrName,
