...
FeedDebugger::FeedDebugger() : _enableDebugging(false), _debugLidList(), _debugDocIdList() {
...
ns_log::Logger::LogLevel FeedDebugger::getDebugDebuggerInternal(uint32_t                    lid,
