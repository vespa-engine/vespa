...
BucketDbSnapshotVector::BucketDbSnapshotVector(const std::vector<storage::spi::PersistenceProvider*>& providers,
                                               const ClusterStateBundle& cluster_state_bundle)
    : _snapshots() {
...
uint32_t BucketDbSnapshotVector::count_moved_documents(const BucketDbSnapshotVector& old) const {
...
uint32_t BucketDbSnapshotVector::count_lost_unique_documents(const BucketDbSnapshotVector& old) const {
