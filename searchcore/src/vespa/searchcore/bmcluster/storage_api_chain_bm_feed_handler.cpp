...
StorageApiChainBmFeedHandler::StorageApiChainBmFeedHandler(
    std::vector<std::shared_ptr<BmStorageLinkContext>> contexts, const IBmDistribution& distribution,
    bool distributor)
...
void StorageApiChainBmFeedHandler::send_cmd(std::shared_ptr<storage::api::StorageCommand> cmd,
...
void StorageApiChainBmFeedHandler::attach_bucket_info_queue(PendingTracker&) {
}

uint32_t StorageApiChainBmFeedHandler::get_error_count() const {
