...
StorageApiMessageBusBmFeedHandler::StorageApiMessageBusBmFeedHandler(BmMessageBus&          message_bus,
...
void StorageApiMessageBusBmFeedHandler::send_cmd(std::shared_ptr<storage::api::StorageCommand> cmd,
...
void StorageApiMessageBusBmFeedHandler::attach_bucket_info_queue(PendingTracker&) {
}

uint32_t StorageApiMessageBusBmFeedHandler::get_error_count() const {
