...
public:
    ...
    const std::vector<index::DiskIndexStats>& getDiskIndexes() const { return _diskIndexes; }
    const std::vector<index::MemoryIndexStats>& getMemoryIndexes() const { return _memoryIndexes; }
};
