...
public:
    IndexDiskDir(uint32_t id, bool fusion) noexcept : _id(id), _fusion(fusion) {}
    IndexDiskDir() noexcept : IndexDiskDir(0, false) {}
    ...
    bool operator==(const IndexDiskDir& rhs) const noexcept { return (_id == rhs._id) && (_fusion == rhs._fusion); }
