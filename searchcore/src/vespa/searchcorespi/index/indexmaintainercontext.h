...
public:
    IndexMaintainerContext(IThreadingService& threadingService, IIndexManager::Reconfigurer& reconfigurer,
     ...
     */
    IThreadingService& getThreadingService() const { return _threadingService; }

    /**
     * Returns the reconfigurer used to signal when the index maintainer has changed.
     */
    IIndexManager::Reconfigurer& getReconfigurer() const { return _reconfigurer; }

    /**
     * Returns the context used to insert extra tags into file headers before writing them.
     */
    const search::common::FileHeaderContext& getFileHeaderContext() const { return _fileHeaderContext; }
