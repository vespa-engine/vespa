...
void EventLogger::diskIndexLoadStart(const std::string& indexDir) {
    JSONStringer jstr;
    jstr.beginObject();
...
void EventLogger::diskIndexLoadComplete(const std::string& indexDir, int64_t elapsedTimeMs) {
    JSONStringer jstr;
    jstr.beginObject();
...
void EventLogger::diskFusionStart(const std::vector<std::string>& sources, const std::string& fusionDir) {
    JSONStringer jstr;
    jstr.beginObject();
...
void EventLogger::diskFusionComplete(const std::string& fusionDir, int64_t elapsedTimeMs) {
    JSONStringer jstr;
    jstr.beginObject();
    jstr.appendKey("time.elapsed.ms").appendInt64(elapsedTimeMs);
    jstr.appendKey("output");
