...
makeDocumentTypeRepo()
{
    ...
    auto float_array = doc.registerArray(doc.createArray(builder.primitiveType(DataType::T_FLOAT)));
    ...
    auto float_wset = doc.registerWset(doc.createWset(builder.primitiveType(DataType::T_FLOAT)));
