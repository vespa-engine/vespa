...
struct DummyPersistenceHandler : public IPersistenceHandler {
    ...
    void handleRemove(FeedToken, const storage::spi::Bucket&, storage::spi::Timestamp,
                      const document::DocumentId&) override {}
    void handleRemoveByGid(FeedToken, const storage::spi::Bucket&, storage::spi::Timestamp, std::string_view,
    ...
    void handleSetActiveState(const storage::spi::Bucket&, storage::spi::BucketInfo::ActiveState,
                              std::shared_ptr<IGenericResultHandler>) override {}
    ...
    void handleSplit(FeedToken, const storage::spi::Bucket&, const storage::spi::Bucket&,
...
void assertSnapshot(const std::vector<IPersistenceHandler::SP>& exp, HandlerSnapshot snapshot,
...
PersistenceHandlerMapTest::PersistenceHandlerMapTest() : ::testing::Test(), map() {
