...
void DocumentWeightAttributeLookupStressTest::populate(AttributeVector& attr) {
...
void DocumentWeightAttributeLookupStressTest::make_lookup_keys() {
...
std::pair<uint64_t, uint64_t> DocumentWeightAttributeLookupStressTest::lookup_loop(AttributeVector& attr,
                                                                                   uint32_t         loops) {
