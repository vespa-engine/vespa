...
public class ExpressionFunction {
    ...
    public Instance expand(SerializationContext context, List<ExpressionNode> argumentValues, Deque<String> path) {
        ...
        String name = toSymbol(argumentBindings);
        String expr = body.getRoot().toString(new StringBuilder(), context.withBindings(argumentBindings), path, null).toString();
        return new Instance(name, expr);
    }
