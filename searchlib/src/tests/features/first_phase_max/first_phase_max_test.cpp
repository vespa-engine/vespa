...
struct FirstPhaseMaxBlueprintTest : public ::testing::Test {
    ...
    FirstPhaseMaxBlueprintTest() : ::testing::Test(), factory(), index_env() {
    ...
    std::shared_ptr<Blueprint> make_blueprint() const {
        return factory.createBlueprint("firstPhaseMax");
    }
...
TEST_F(FirstPhaseMaxBlueprintTest, blueprint_setup_fails_when_parameter_list_is_not_empty)
{
    expect_setup_fail({"is"},
                      "The parameter list used for setting up rank feature firstPhaseMax is not valid: "
