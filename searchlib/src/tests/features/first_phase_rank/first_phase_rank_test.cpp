...
struct FirstPhaseRankBlueprintTest : public ::testing::Test {
    ...
    FirstPhaseRankBlueprintTest() : ::testing::Test(), factory(), index_env() { setup_search_features(factory); }

    ~FirstPhaseRankBlueprintTest() override;

    std::shared_ptr<Blueprint> make_blueprint() const { return factory.createBlueprint("firstPhaseRank"); }
...
TEST_F(FirstPhaseRankBlueprintTest, blueprint_setup_fails_when_parameter_list_is_not_empty) {
    expect_setup_fail({"is"}, "The parameter list used for setting up rank feature firstPhaseRank is not valid: "
...
struct FirstPhaseRankExecutorTest : public ::testing::Test {
    ...
    FirstPhaseRankExecutorTest() : ::testing::Test(), factory(), test(factory, "firstPhaseRank") {
