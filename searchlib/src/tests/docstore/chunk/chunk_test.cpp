...
constexpr const char* MY_LONG_STRING =
    "This is medium long string that hopefully will compress to something where lz4, zstandard and none"
    " will make a difference. The intentions is to verify that we trigger all compresssions possible and are able to "
    "decompress them too."
    " I guess that we need a considerable length in order to get the rather inefficient lz4 compression triger. "
