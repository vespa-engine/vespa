...
struct VespaWandFactory : WandFactory {
    ...
    SearchIterator::UP create(const wand::Terms &terms) override {
        return WeakAndSearch::create(terms, wand::MatchParams(_scores, wand::StopWordStrategy::none(), 1), n, true, false);
    }
};
...
struct VespaArrayWandFactory : WandFactory {
    ...
    SearchIterator::UP create(const wand::Terms &terms) override {
        return WeakAndSearch::createArrayWand(terms, wand::MatchParams(_scores, wand::StopWordStrategy::none(), 1), wand::TermFrequencyScorer(), n, true, false);
    }
};
...
struct VespaHeapWandFactory : WandFactory {
    ...
    SearchIterator::UP create(const wand::Terms &terms) override {
        return WeakAndSearch::createHeapWand(terms, wand::MatchParams(_scores, wand::StopWordStrategy::none(), 1), wand::TermFrequencyScorer(), n, true, false);
    }
};
