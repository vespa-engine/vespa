...
TEST_F(FakeSearchableTest, require_that_term_search_works) {
    source.addResult("fieldfoo", "word1", FakeResult().doc(5).elem(2).pos(3).elem(4).pos(5));
...
TEST_F(FakeSearchableTest, require_that_phrase_search_works) {
    source.addResult("fieldfoo", "word1", FakeResult().doc(3).pos(7).doc(5).pos(3));
    source.addResult("fieldfoo", "word2", FakeResult().doc(2).pos(1).doc(3).pos(10).doc(5).pos(4));
...
TEST_F(FakeSearchableTest, require_that_weigheted_set_search_works) {
    source.addResult("fieldfoo", "friend1", FakeResult().doc(3).doc(5).doc(7).doc(9));
    source.addResult("fieldfoo", "friend2", FakeResult().doc(3).doc(4).doc(5).doc(6));
    source.addResult("fieldfoo", "friend3", FakeResult().doc(5));
...
TEST_F(FakeSearchableTest, require_that_multi_field_search_works) {
    source.addResult("fieldfoo", "word1", FakeResult().doc(5).pos(3));
    source.addResult("fieldbar", "word1", FakeResult().doc(5).pos(7).doc(10).pos(2));
...
TEST_F(FakeSearchableTest, require_that_match_data_is_compressed_for_attributes) {
    source.is_attr(true);
    source.addResult("attrfoo", "word1", FakeResult().doc(5).elem(2).weight(6).pos(3).elem(4).weight(8).pos(5));
    SimpleStringTerm             termNode("word1", "viewfoo", 1, w);
    FieldSpecList                fields;
    search::fef::MatchDataLayout mdl;
    mdl.allocTermField(0);
