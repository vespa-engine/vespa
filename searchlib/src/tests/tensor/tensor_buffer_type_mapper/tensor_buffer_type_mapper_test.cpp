...
struct TestParam {
    ...
    TestParam(std::string name, std::vector<size_t> array_sizes, std::vector<size_t> large_array_sizes,
              std::vector<uint32_t> type_id_caps, const std::string& tensor_type_spec)
        : _name(std::move(name)),
...
std::vector<size_t> TensorBufferTypeMapperTest::get_array_sizes() {
...
std::vector<size_t> TensorBufferTypeMapperTest::get_large_array_sizes() {
...
void TensorBufferTypeMapperTest::select_type_ids() {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(TestParam("1d", {8, 16, 32, 40, 64}, {2768, 49712, 950768, 18268976, 351101184},
                              {27, 30, 514, 584}, tensor_type_sparse_spec),
                    TestParam("1dfloat", {4, 12, 20, 28, 36}, {2688, 48896, 937248, 18009808, 346121248},
                              {27, 30, 514, 585}, float_tensor_type_spec),
                    TestParam("2d", {8, 24, 40, 56, 80}, {2416, 41392, 790112, 15179616, 291726288},
                              {26, 29, 520, 590}, tensor_type_2d_spec),
                    TestParam("2dmixed", {8, 24, 48, 64, 96}, {3008, 51728, 987632, 18974512, 364657856},
                              {26, 29, 513, 583}, tensor_type_2d_mixed_spec),
