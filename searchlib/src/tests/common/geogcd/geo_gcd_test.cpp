...
const Point airports[NUM] = {
    {"SFO", 37.61, -122.38}, {"LHR", 51.47, -0.46},   {"OSL", 60.20, 11.08},
    {"GIG", -22.8, -43.25},  {"HKG", 22.31, 113.91},  {"TRD", 63.45, 10.92},
    {"SYD", -33.95, 151.17}, {"LAX", 33.94, -118.41}, {"JFK", 40.64, -73.78},
};

const double exact_distances[NUM][NUM] = {
    {0, 5367, 5196, 6604, 6927, 5012, 7417, 337, 2586},   {5367, 0, 750, 5734, 5994, 928, 10573, 5456, 3451},
    {5196, 750, 0, 6479, 5319, 226, 9888, 5345, 3687},    {6604, 5734, 6479, 0, 10989, 6623, 8414, 6294, 4786},
    {6927, 5994, 5319, 10989, 0, 5240, 4581, 7260, 8072}, {5012, 928, 226, 6623, 5240, 0, 9782, 5171, 3611},
    {7417, 10573, 9888, 8414, 4581, 9782, 0, 7488, 9950}, {337, 5456, 5345, 6294, 7260, 5171, 7488, 0, 2475},
