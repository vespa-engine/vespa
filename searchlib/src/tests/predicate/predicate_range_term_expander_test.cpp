...
struct MyRangeHandler {
    ...
    size_t         i;
    ~MyRangeHandler() { EXPECT_EQ(expected_labels.size(), i); }
...
TEST(PredicateRangeTermExpanderTest, require_that_small_range_is_expanded) {
    ...
    MyRangeHandler range_handler{{"key=40-49", "key=0-99", "key=0-999", "key=0-9999", "key=0-99999", "key=0-999999",
                                  "key=0-9999999", "key=0-99999999", "key=0-999999999", "key=0-9999999999",
                                  "key=0-99999999999", "key=0-999999999999", "key=0-9999999999999",
                                  "key=0-99999999999999", "key=0-999999999999999", "key=0-9999999999999999",
                                  "key=0-99999999999999999", "key=0-999999999999999999"},
                                 "key=40",
                                 2,
                                 0};
...
TEST(PredicateRangeTermExpanderTest, require_that_large_range_is_expanded) {
    ...
    MyRangeHandler             range_handler{
                    {"key=123456789012345670-123456789012345679", "key=123456789012345600-123456789012345699",
                     "key=123456789012345000-123456789012345999", "key=123456789012340000-123456789012349999",
                     "key=123456789012300000-123456789012399999", "key=123456789012000000-123456789012999999",
                     "key=123456789010000000-123456789019999999", "key=123456789000000000-123456789099999999",
                     "key=123456789000000000-123456789999999999", "key=123456780000000000-123456789999999999",
                     "key=123456700000000000-123456799999999999", "key=123456000000000000-123456999999999999",
                     "key=123450000000000000-123459999999999999", "key=123400000000000000-123499999999999999",
                     "key=123000000000000000-123999999999999999", "key=120000000000000000-129999999999999999",
                     "key=100000000000000000-199999999999999999", "key=0-999999999999999999"},
        "key=123456789012345670",
        8,
        0};
...
TEST(PredicateRangeTermExpanderTest, require_that_small_negative_range_is_expanded) {
    PredicateRangeTermExpander expander(10);
    MyRangeHandler             range_handler{{"key=-49-40", "key=-99-0", "key=-999-0", "key=-9999-0", "key=-99999-0",
                                              "key=-999999-0", "key=-9999999-0", "key=-99999999-0", "key=-999999999-0",
                                              "key=-9999999999-0", "key=-99999999999-0", "key=-999999999999-0",
                                              "key=-9999999999999-0", "key=-99999999999999-0", "key=-999999999999999-0",
                                              "key=-9999999999999999-0", "key=-99999999999999999-0", "key=-999999999999999999-0"},
                                 "key=-40",
                                 2,
                                 0};
    expander.expand("key", -42, range_handler);
...
TEST(PredicateRangeTermExpanderTest, require_that_min_range_minus_9_is_expanded) {
    PredicateRangeTermExpander expander(10);
    MyRangeHandler             range_handler{
                    {"key=-9223372036854775799-9223372036854775790", "key=-9223372036854775799-9223372036854775700"},
        "key=-9223372036854775790",
        9,
        0};
...
TEST(PredicateRangeTermExpanderTest, require_that_small_range_is_expanded_in_arity_2) {
    ...
    MyRangeHandler             range_handler{{"key=42-43",
                                              "key=40-43",
                                              "key=40-47",
                                              "key=32-47",
                                              "key=32-63",
...
TEST(PredicateRangeTermExpanderTest, require_that_small_negative_range_is_expanded_in_arity_2) {
    PredicateRangeTermExpander expander(2);
    MyRangeHandler             range_handler{{"key=-43-42",
                                              "key=-43-40",
                                              "key=-47-40",
                                              "key=-47-32",
                                              "key=-63-32",
...
TEST(PredicateRangeTermExpanderTest, require_that_upper_bound_is_used) {
    ...
    MyRangeHandler             range_handler{{"key=40-49", "key=0-99", "key=0-999", "key=0-9999"}, "key=40", 2, 0};
    expander.expand("key", 42, range_handler);
}

TEST(PredicateRangeTermExpanderTest, require_that_lower_bound_is_used) {
    PredicateRangeTermExpander expander(10, -9999, 99);
    MyRangeHandler range_handler{{"key=-49-40", "key=-99-0", "key=-999-0", "key=-9999-0"}, "key=-40", 2, 0};
    expander.expand("key", -42, range_handler);
}
...
TEST(PredicateRangeTermExpanderTest, require_that_upper_and_lower_bound_gt_0_works) {
    ...
    MyRangeHandler range_handler{{"key=140-149", "key=100-199", "key=0-999", "key=0-9999"}, "key=140", 2, 0};
...
TEST(PredicateRangeTermExpanderTest, require_that_search_close_to_max_uneven_upper_bound_is_sensible) {
    ...
    MyRangeHandler             range_handler{{"key=9223372036854770000-9223372036854770009",
                                              "key=9223372036854770000-9223372036854770099",
                                              "key=9223372036854770000-9223372036854770999"},
                                 "key=9223372036854770000",
                                 0,
                                 0};
