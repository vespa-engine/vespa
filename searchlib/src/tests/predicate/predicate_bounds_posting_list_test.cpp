...
TEST(PredicateBoundsPostingListTest, require_that_empty_bounds_posting_list_starts_at_0) {
    ...
    PredicateBoundsPostingList<PredicateIndex::BTreeIterator> posting_list(
        index.getIntervalStore(), index.getBoundsIndex().getBTreePostingList(ref), 42);
...
void checkNext(PredicateBoundsPostingList<PredicateIndex::BTreeIterator>& posting_list, uint32_t move_past,
    ...
    ost << "checkNext(posting_list, " << move_past << ", " << doc_id << ", " << interval_count << ")";
...
TEST(PredicateBoundsPostingListTest, require_that_bounds_posting_list_checks_bounds) {
    ...
    PredicateBoundsPostingList<PredicateIndex::BTreeIterator> posting_list(index.getIntervalStore(),
    ...
    PredicateBoundsPostingList<PredicateIndex::BTreeIterator> posting_list2(
        index.getIntervalStore(), bounds_index.getBTreePostingList(ref), 40);
