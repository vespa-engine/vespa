...
template <typename IntervalT> void testInsertAndRetrieve(const std::vector<IntervalT>& interval_list) {
...
TEST(PredicateIntervalStoreTest, require_that_multi_interval_entry_can_be_inserted) {
    ...
    testInsertAndRetrieve<Interval>({{0x00010001}, {0x00020002}, {0x0003ffff}});
    testInsertAndRetrieve<Interval>({{0x00010001},
                                     {0x00020002},
                                     {0x00030003},
                                     {0x00040004},
                                     {0x00050005},
                                     ...
                                     {0x00080008},
                                     {0x0009ffff}});
    testInsertAndRetrieve<IntervalWithBounds>({{0x00010001, 0x4}, {0x0002ffff, 0x10}});
    testInsertAndRetrieve<IntervalWithBounds>(
        {{0x00010001, 0x4}, {0x00020002, 0x10}, {0x00030003, 0x20}, {0x00040004, 0x6}, {0x0005ffff, 0x7}});
}
