...
TEST_F(IntrinsicBlueprintAdapterTest,
       require_that_intrinsic_blueprint_adaption_fails_if_blueprint_has_more_than_one_output) {
...
TEST_F(IntrinsicBlueprintAdapterTest,
       require_that_intrinsic_blueprint_adaption_fails_if_blueprint_has_error_typed_output) {
