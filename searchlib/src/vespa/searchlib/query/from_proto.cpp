...
bool handle(const ItemPureWeightedString& item, QueryStackIterator::Data& _d) {
...
bool handle(const ItemPureWeightedLong& item, QueryStackIterator::Data& _d) {
...
bool ProtoStackIterator::handle_item(const QueryStackItem& qsi) {
    ...
    case IC::kItemPureWeightedString:
        return handle(qsi.item_pure_weighted_string(), _d);
    case IC::kItemPureWeightedLong:
        return handle(qsi.item_pure_weighted_long(), _d);
