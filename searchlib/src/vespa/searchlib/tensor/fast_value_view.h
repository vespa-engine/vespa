...
struct FastValueView final : vespalib::eval::Value {
    ...
    FastValueView(const vespalib::eval::ValueType& type, std::span<const vespalib::string_id> labels,
                  vespalib::eval::TypedCells cells, size_t num_mapped_dimensions, size_t num_subspaces);
