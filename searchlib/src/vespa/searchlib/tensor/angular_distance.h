 ...
 */
template <typename FloatType> class AngularDistanceFunctionFactory : public DistanceFunctionFactory {
private:
    bool _reference_insertion_vector;

public:
    AngularDistanceFunctionFactory() noexcept : AngularDistanceFunctionFactory(false) {}
    AngularDistanceFunctionFactory(bool reference_insertion_vector) noexcept
