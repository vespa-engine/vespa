...
LargeSubspacesBufferType::LargeSubspacesBufferType(const AllocSpec&                 spec,
                                                   std::shared_ptr<MemoryAllocator> memory_allocator,
                                                   TensorBufferTypeMapper&          type_mapper) noexcept
    : ParentType(1u, spec.min_entries_in_buffer, spec.max_entries_in_buffer, spec.num_entries_for_new_buffer,
...
void LargeSubspacesBufferType::clean_hold(void* buffer, size_t offset, EntryCount num_entries,
                                          CleanContext cleanCtx) {
...
void LargeSubspacesBufferType::destroy_entries(void* buffer, EntryCount num_entries) {
...
void LargeSubspacesBufferType::fallback_copy(void* newBuffer, const void* oldBuffer, EntryCount num_entries) {
...
void LargeSubspacesBufferType::initialize_reserved_entries(void* buffer, EntryCount reserved_entries) {
...
const vespalib::alloc::MemoryAllocator* LargeSubspacesBufferType::get_memory_allocator() const {
