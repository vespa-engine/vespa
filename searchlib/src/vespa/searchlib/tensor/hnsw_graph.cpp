...
template <HnswIndexType type> HnswGraph<type>::~HnswGraph() = default;

template <HnswIndexType type>
typename HnswGraph<type>::LevelsRef HnswGraph<type>::make_node(uint32_t nodeid, uint32_t docid, uint32_t subspace,
                                                               uint32_t num_levels) {
...
template <HnswIndexType type> void HnswGraph<type>::trim_nodes_size() {
...
template <HnswIndexType type> typename HnswGraph<type>::Histograms HnswGraph<type>::histograms() const {
    Histograms result;
...
template <HnswIndexType type> void HnswGraph<type>::set_entry_node(EntryNode node) {
