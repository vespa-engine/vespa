...
public:
    ImportedTensorAttributeVector(std::string_view name, std::shared_ptr<ReferenceAttribute> reference_attribute,
    ...
    makeReadGuard(std::shared_ptr<MetaStoreReadGuard> targetMetaStoreReadGuard, bool stableEnumGuard) const override;
};
