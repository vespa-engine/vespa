...
vespalib::asciistream& operator<<(vespalib::asciistream& os, const FieldIndexBase::WordKey& rhs) {
...
FieldIndexBase::FieldIndexBase(const index::Schema& schema, uint32_t fieldId, const index::FieldLengthInfo& info)
    : _wordStore(),
      _numUniqueWords(0),
      _generationHandler(),
      _dict(),
