...
WordStore::WordStore()
    : _store(), _numWords(0), _type(buffer_array_size, MIN_BUFFER_ARRAYS, RefType::offsetSize()), _typeId(0) {
...
vespalib::datastore::EntryRef WordStore::addWord(const std::string_view word) {
