...
public:
    ...
    Trace& match_profile_depth(int32_t depth) {
        _match_profile_depth = depth;
        return *this;
    }
    Trace& first_phase_profile_depth(int32_t depth) {
        _first_phase_profile_depth = depth;
        return *this;
    }
    Trace& second_phase_profile_depth(int32_t depth) {
