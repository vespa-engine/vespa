...
PageDict4MemSeqReader::PageDict4MemSeqReader(uint32_t chunkSize, uint64_t numWordIds, ThreeLevelCountWriteBuffers& wb)
...
void PageDict4MemSeqReader::readCounts(std::string& word, uint64_t& wordNum, PostingListCounts& counts) {
