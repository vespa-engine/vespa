...
FakeZcFilterOcc::FakeZcFilterOcc(const FakeWord& fw, bool bigEndian,
                                 const diskindex::Zc4PostingParams& posting_params, const char* nameSuffix)
...
void FakeZcFilterOcc::setup(const FakeWord& fw) {
    if (_bigEndian) {
        setupT<true>(fw);
    } else {
        setupT<false>(fw);
...
template <bool bigEndian> void FakeZcFilterOcc::setupT(const FakeWord& fw) {
    ...
    FeatureEncodeContext<bigEndian>&  f =
        (_posting_params._dynamic_k ? static_cast<FeatureEncodeContext<bigEndian>&>(f1)
...
template <bool bigEndian> void FakeZcFilterOcc::read_header() {
...
void FakeZcFilterOcc::validate_read(const FakeWord& fw) const {
    if (_bigEndian) {
...
template <bool bigEndian> void FakeZcFilterOcc::validate_read(const FakeWord& fw) const {
    ...
    bitcompression::FeatureDecodeContext<bigEndian>& decode_context =
        _posting_params._dynamic_k ? decode_context_dynamic_k_upcast : decode_context_static_k_upcast;
...
void FakeZcFilterOcc::forceLink() {
}

size_t FakeZcFilterOcc::bitSize() const {
    return _compressedBits - (_l1SkipSize + _l2SkipSize + _l3SkipSize + _l4SkipSize) * 8;
}

bool FakeZcFilterOcc::hasWordPositions() const {
    return false;
}

bool FakeZcFilterOcc::has_interleaved_features() const {
    return _posting_params._encode_interleaved_features;
}

size_t FakeZcFilterOcc::skipBitSize() const {
    return (_l1SkipSize + _l2SkipSize + _l3SkipSize + _l4SkipSize) * 8;
}

size_t FakeZcFilterOcc::l1SkipBitSize() const {
    return _l1SkipSize * 8;
}

size_t FakeZcFilterOcc::l2SkipBitSize() const {
    return _l2SkipSize * 8;
}

size_t FakeZcFilterOcc::l3SkipBitSize() const {
    return _l3SkipSize * 8;
}

size_t FakeZcFilterOcc::l4SkipBitSize() const {
    return _l4SkipSize * 8;
}

int FakeZcFilterOcc::lowLevelSinglePostingScan() const {
    return 0;
}

int FakeZcFilterOcc::lowLevelSinglePostingScanUnpack() const {
    return 0;
}

int FakeZcFilterOcc::lowLevelAndPairPostingScan(const FakePosting& rhs) const {
    (void)rhs;
    return 0;
}

int FakeZcFilterOcc::lowLevelAndPairPostingScanUnpack(const FakePosting& rhs) const {
    (void)rhs;
    return 0;
}
...
private:
    ...
    FakeFilterOccZCArrayIterator& operator=(const FakeFilterOccZCArrayIterator& other);
...
public:
    ...
    FakeFilterOccZCArrayIterator(const uint64_t* compressed, int bitOffset, uint32_t docIdLimit,
...
FakeFilterOccZCArrayIterator::FakeFilterOccZCArrayIterator(const uint64_t* compressed, int bitOffset,
                                                           uint32_t                            docIdLimit,
                                                           const fef::TermFieldMatchDataArray& matchData)
...
void FakeFilterOccZCArrayIterator::initRange(uint32_t begin, uint32_t end) {
    ...
    bcompr += header._l4_skip_size, d.setByteCompr(bcompr);
    uint32_t oDocId;
...
FakeFilterOccZCArrayIterator::~FakeFilterOccZCArrayIterator() {
}

void FakeFilterOccZCArrayIterator::doSeek(uint32_t docId) {
...
void FakeFilterOccZCArrayIterator::doUnpack(uint32_t docId) {
...
std::unique_ptr<SearchIterator> FakeZcFilterOcc::createIterator(const TermFieldMatchDataArray& matchData) const {
    return std::make_unique<FakeFilterOccZCArrayIterator>(_compressed.first, 0, _posting_params._doc_id_limit,
                                                          matchData);
}
...
static FPFactoryInit initSkip(std::make_pair("ZcSkipFilterOcc", makeFPFactory<FPFactoryT<FakeZcSkipFilterOcc>>));

FakeZcSkipFilterOcc::FakeZcSkipFilterOcc(const FakeWord& fw)
    : FakeZcFilterOcc(fw, true, Zc4PostingParams(force_skip, disable_chunking, fw._docIdLimit, true, false, false),
                      ".zc5skipfilterocc") {
    setup(fw);
...
std::unique_ptr<SearchIterator> FakeZcSkipFilterOcc::createIterator(const TermFieldMatchDataArray& matchData) const {
    return create_zc_posocc_iterator(true, _counts, Position(_compressed.first, 0), _compressedBits, _posting_params,
                                     _fieldsParams, matchData);
}

template <bool bigEndian> class FakeEGCompr64PosOcc : public FakeZcFilterOcc {
    search::index::PostingListCounts _counts;
...
FakeEGCompr64PosOcc<bigEndian>::FakeEGCompr64PosOcc(const FakeWord& fw)
    : FakeZcFilterOcc(fw, bigEndian,
                      Zc4PostingParams(disable_skip, disable_chunking, fw._docIdLimit, true, true, false),
...
template <bool bigEndian> FakeEGCompr64PosOcc<bigEndian>::~FakeEGCompr64PosOcc() {
}

template <bool bigEndian> size_t FakeEGCompr64PosOcc<bigEndian>::bitSize() const {
    return _compressedBits;
}

template <bool bigEndian> bool FakeEGCompr64PosOcc<bigEndian>::hasWordPositions() const {
    return true;
}

template <bool bigEndian>
std::unique_ptr<SearchIterator>
FakeEGCompr64PosOcc<bigEndian>::createIterator(const TermFieldMatchDataArray& matchData) const {
...
template <bool bigEndian> class FakeEG2Compr64PosOcc : public FakeZcFilterOcc {
    search::index::PostingListCounts _counts;
...
FakeEG2Compr64PosOcc<bigEndian>::FakeEG2Compr64PosOcc(const FakeWord& fw)
    : FakeZcFilterOcc(fw, bigEndian,
                      Zc4PostingParams(disable_skip, disable_chunking, fw._docIdLimit, false, true, false),
...
template <bool bigEndian> FakeEG2Compr64PosOcc<bigEndian>::~FakeEG2Compr64PosOcc() {
}

template <bool bigEndian> size_t FakeEG2Compr64PosOcc<bigEndian>::bitSize() const {
    return _compressedBits;
}

template <bool bigEndian> bool FakeEG2Compr64PosOcc<bigEndian>::hasWordPositions() const {
    return true;
}

template <bool bigEndian>
std::unique_ptr<SearchIterator>
FakeEG2Compr64PosOcc<bigEndian>::createIterator(const TermFieldMatchDataArray& matchData) const {
    return create_zc_posocc_iterator(bigEndian, _counts, Position(_compressed.first, 0), _compressedBits,
                                     _posting_params, _fieldsParams, matchData);
}

template <bool bigEndian> class FakeZcSkipPosOcc : public FakeZcFilterOcc {
    search::index::PostingListCounts _counts;
...
FakeZcSkipPosOcc<bigEndian>::FakeZcSkipPosOcc(const FakeWord& fw)
    : FakeZcFilterOcc(fw, bigEndian,
                      Zc4PostingParams(force_skip, disable_chunking, fw._docIdLimit, true, true, false),
...
template <bool bigEndian> FakeZcSkipPosOcc<bigEndian>::~FakeZcSkipPosOcc() {
}

template <bool bigEndian> size_t FakeZcSkipPosOcc<bigEndian>::bitSize() const {
    return _compressedBits - _l1SkipSize - _l2SkipSize - _l3SkipSize - _l4SkipSize;
}

template <bool bigEndian> bool FakeZcSkipPosOcc<bigEndian>::hasWordPositions() const {
    return true;
}

template <bool bigEndian>
std::unique_ptr<SearchIterator>
FakeZcSkipPosOcc<bigEndian>::createIterator(const TermFieldMatchDataArray& matchData) const {
    return create_zc_posocc_iterator(bigEndian, _counts, Position(_compressed.first, 0), _compressedBits,
                                     _posting_params, _fieldsParams, matchData);
}

template <bool bigEndian> class FakeZc4SkipPosOcc : public FakeZcFilterOcc {
    search::index::PostingListCounts _counts;
...
template <bool bigEndian>
FakeZc4SkipPosOcc<bigEndian>::FakeZc4SkipPosOcc(const FakeWord& fw, const Zc4PostingParams& posting_params,
...
FakeZc4SkipPosOcc<bigEndian>::FakeZc4SkipPosOcc(const FakeWord& fw)
    : FakeZc4SkipPosOcc<bigEndian>(fw,
                                   Zc4PostingParams(force_skip, disable_chunking, fw._docIdLimit, false, true, false),
                                   (bigEndian ? ".zc4skipposoccbe" : ".zc4skipposoccle")) {
}

template <bool bigEndian> FakeZc4SkipPosOcc<bigEndian>::~FakeZc4SkipPosOcc() = default;

template <bool bigEndian> size_t FakeZc4SkipPosOcc<bigEndian>::bitSize() const {
    return _compressedBits - _l1SkipSize - _l2SkipSize - _l3SkipSize - _l4SkipSize;
}

template <bool bigEndian> bool FakeZc4SkipPosOcc<bigEndian>::hasWordPositions() const {
    return true;
}
...
template <bool bigEndian> class FakeZc4SkipPosOccCf : public FakeZc4SkipPosOcc<bigEndian> {
public:
    FakeZc4SkipPosOccCf(const FakeWord& fw)
        : FakeZc4SkipPosOcc<bigEndian>(
              fw, Zc4PostingParams(force_skip, disable_chunking, fw._docIdLimit, false, true, true),
              (bigEndian ? ".zc4skipposoccbe.cf" : ".zc4skipposoccle.cf")) {}
    ~FakeZc4SkipPosOccCf() override;
};

template <bool bigEndian> FakeZc4SkipPosOccCf<bigEndian>::~FakeZc4SkipPosOccCf() = default;

class FakeZc4SkipPosOccCfNoNormalUnpack : public FakeZc4SkipPosOcc<true> {
public:
    FakeZc4SkipPosOccCfNoNormalUnpack(const FakeWord& fw)
        : FakeZc4SkipPosOcc<true>(fw,
                                  Zc4PostingParams(force_skip, disable_chunking, fw._docIdLimit, false, true, true),
...
template <bool bigEndian> class FakeZc4NoSkipPosOccCf : public FakeZc4SkipPosOcc<bigEndian> {
public:
    FakeZc4NoSkipPosOccCf(const FakeWord& fw)
        : FakeZc4SkipPosOcc<bigEndian>(
              fw, Zc4PostingParams(disable_skip, disable_chunking, fw._docIdLimit, false, true, true),
              (bigEndian ? ".zc4noskipposoccbe.cf" : "zc4noskipposoccle.cf")) {}
    ~FakeZc4NoSkipPosOccCf() override;
};

template <bool bigEndian> FakeZc4NoSkipPosOccCf<bigEndian>::~FakeZc4NoSkipPosOccCf() = default;
...
public:
    FakeZc4NoSkipPosOccCfNoNormalUnpack(const FakeWord& fw)
        : FakeZc4SkipPosOcc<true>(fw,
                                  Zc4PostingParams(disable_skip, disable_chunking, fw._docIdLimit, false, true, true),
...
template <bool bigEndian> class FakeZc5NoSkipPosOccCf : public FakeZc4SkipPosOcc<bigEndian> {
public:
    FakeZc5NoSkipPosOccCf(const FakeWord& fw)
        : FakeZc4SkipPosOcc<bigEndian>(
              fw, Zc4PostingParams(disable_skip, disable_chunking, fw._docIdLimit, true, true, true),
              (bigEndian ? ".zc5noskipposoccbe.cf" : ".zc5noskipposoccle.cf")) {}
    ~FakeZc5NoSkipPosOccCf() override;
};

template <bool bigEndian> FakeZc5NoSkipPosOccCf<bigEndian>::~FakeZc5NoSkipPosOccCf() = default;

static FPFactoryInit initPosbe(std::make_pair("EGCompr64PosOccBE",
                                              makeFPFactory<FPFactoryT<FakeEGCompr64PosOcc<true>>>));

static FPFactoryInit initPosle(std::make_pair("EGCompr64PosOccLE",
                                              makeFPFactory<FPFactoryT<FakeEGCompr64PosOcc<false>>>));

static FPFactoryInit initPos0be(std::make_pair("EG2Compr64PosOccBE",
                                               makeFPFactory<FPFactoryT<FakeEG2Compr64PosOcc<true>>>));

static FPFactoryInit initPos0le(std::make_pair("EG2Compr64PosOccLE",
                                               makeFPFactory<FPFactoryT<FakeEG2Compr64PosOcc<false>>>));

static FPFactoryInit initSkipPosbe(std::make_pair("ZcSkipPosOccBE",
                                                  makeFPFactory<FPFactoryT<FakeZcSkipPosOcc<true>>>));

static FPFactoryInit initSkipPosle(std::make_pair("ZcSkipPosOccLE",
                                                  makeFPFactory<FPFactoryT<FakeZcSkipPosOcc<false>>>));

static FPFactoryInit initSkipPos0be(std::make_pair("Zc4SkipPosOccBE",
                                                   makeFPFactory<FPFactoryT<FakeZc4SkipPosOcc<true>>>));

static FPFactoryInit initSkipPos0le(std::make_pair("Zc4SkipPosOccLE",
                                                   makeFPFactory<FPFactoryT<FakeZc4SkipPosOcc<false>>>));

static FPFactoryInit initSkipPos0becf(std::make_pair("Zc4SkipPosOccBE.cf",
                                                     makeFPFactory<FPFactoryT<FakeZc4SkipPosOccCf<true>>>));

static FPFactoryInit initSkipPos0lecf(std::make_pair("Zc4SkipPosOccLE.cf",
                                                     makeFPFactory<FPFactoryT<FakeZc4SkipPosOccCf<false>>>));

static FPFactoryInit initSkipPos0becfnnu(
    std::make_pair("Zc4SkipPosOccBE.cf.nnu", makeFPFactory<FPFactoryT<FakeZc4SkipPosOccCfNoNormalUnpack>>));

static FPFactoryInit initSkipPos0becfncu(std::make_pair("Zc4SkipPosOccBE.cf.ncu",
                                                        makeFPFactory<FPFactoryT<FakeZc4SkipPosOccCfNoCheapUnpack>>));

static FPFactoryInit initNoSkipPos0becf(std::make_pair("Zc4NoSkipPosOccBE.cf",
                                                       makeFPFactory<FPFactoryT<FakeZc4NoSkipPosOccCf<true>>>));

static FPFactoryInit initNoSkipPos0becfnnu(
    std::make_pair("Zc4NoSkipPosOccBE.cf.nnu", makeFPFactory<FPFactoryT<FakeZc4NoSkipPosOccCfNoNormalUnpack>>));

static FPFactoryInit initNoSkipPos0becfncu(
    std::make_pair("Zc4NoSkipPosOccBE.cf.ncu", makeFPFactory<FPFactoryT<FakeZc4NoSkipPosOccCfNoCheapUnpack>>));

static FPFactoryInit initNoSkipPos0lecf(std::make_pair("Zc4NoSkipPosOccLE.cf",
                                                       makeFPFactory<FPFactoryT<FakeZc4NoSkipPosOccCf<false>>>));

static FPFactoryInit initNoSkipPosbecf(std::make_pair("Zc5NoSkipPosOccBE.cf",
                                                      makeFPFactory<FPFactoryT<FakeZc5NoSkipPosOccCf<true>>>));

static FPFactoryInit initNoSkipPoslecf(std::make_pair("Zc5NoSkipPosOccLE.cf",
