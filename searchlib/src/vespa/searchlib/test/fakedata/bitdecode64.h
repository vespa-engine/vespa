...
template <bool bigEndian> class BitDecode64 : public bitcompression::DecodeContext64<bigEndian> {
private:
...
public:
    ...
    uint64_t getOffset() const { return 64 * (_valI - _comprBase - 1) - this->_preRead - _bitOffsetBase; }
