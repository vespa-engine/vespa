...
void StringFieldBuilder::start_annotate() {
...
StringFieldBuilder& StringFieldBuilder::token(const std::string& val, bool is_word) {
    if (val.empty()) {
        return *this;
    }
    if (!_span_tree) {
...
StringFieldBuilder& StringFieldBuilder::tokenize(const std::string& val) {
...
document::StringFieldValue StringFieldBuilder::build() {
