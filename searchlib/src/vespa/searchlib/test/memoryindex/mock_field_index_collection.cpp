...
MockFieldIndexCollection::MockFieldIndexCollection(FieldIndexRemover&                remover,
    ...
    : _remover(remover), _inserter_backend(inserter_backend), _calculator(calculator) {
}

MockFieldIndexCollection::~MockFieldIndexCollection() = default;

FieldIndexRemover& MockFieldIndexCollection::get_remover(uint32_t) {
    return _remover;
}

IOrderedFieldIndexInserter& MockFieldIndexCollection::get_inserter(uint32_t field_id) {
...
index::FieldLengthCalculator& MockFieldIndexCollection::get_calculator(uint32_t) {
    return _calculator;
}
