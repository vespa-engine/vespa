...
public:
    ...
    SearchIterator::UP createIntermediateSearch(MultiSearch::Children subSearches, fef::MatchData& md) const override;
    SearchIterator::UP createFilterSearchImpl(FilterConstraint constraint) const override;
    NearBlueprint(uint32_t window, uint32_t num_negative_terms, uint32_t exclusion_distance,
                  const IElementGapInspector& element_gap_inspector) noexcept
        : _window(window),
...
public:
    ...
    SearchIterator::UP createIntermediateSearch(MultiSearch::Children subSearches, fef::MatchData& md) const override;
    SearchIterator::UP createFilterSearchImpl(FilterConstraint constraint) const override;
    ONearBlueprint(uint32_t window, uint32_t num_negative_terms, uint32_t exclusion_distance,
                   const IElementGapInspector& element_gap_inspector) noexcept
        : _window(window),
          _num_negative_terms(num_negative_terms),
          _exclusion_distance(exclusion_distance),
