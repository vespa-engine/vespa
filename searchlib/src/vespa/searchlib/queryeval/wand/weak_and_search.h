...
struct WeakAndSearch : SearchIterator {
    ...
    template <typename Scorer>
    static SearchIterator::UP createHeapWand(const Terms& terms, const MatchParams& matchParams, const Scorer& scorer,
                                             uint32_t n, bool strict, bool readonly_scores_heap);
    template <typename Scorer>
    static SearchIterator::UP create(const Terms& terms, const MatchParams& matchParams, const Scorer& scorer,
                                     uint32_t n, bool strict, bool readonly_scores_heap);
    static SearchIterator::UP create(const Terms& terms, const MatchParams& matchParams, uint32_t n, bool strict,
                                     bool readonly_scores_heap);
};
