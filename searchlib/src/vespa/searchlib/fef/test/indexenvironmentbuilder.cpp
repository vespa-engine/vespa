...
IndexEnvironmentBuilder::IndexEnvironmentBuilder(IndexEnvironment& env) : _env(env) {
}

IndexEnvironmentBuilder& IndexEnvironmentBuilder::addField(const FieldType&                 type,
