...
std::string lookupString(const Properties& props, const std::string& name, const std::string& defaultValue) {
...
std::vector<std::string> lookupStringVector(const Properties& props, const std::string& name,
...
std::optional<double> lookup_opt_double(const Properties& props, std::string_view name,
...
double lookupDouble(const Properties& props, const std::string& name, double defaultValue) {
    return lookup_opt_double(props, name, defaultValue).value();
}

uint32_t lookupUint32(const Properties& props, const std::string& name, uint32_t defaultValue) {
    Property p = props.lookup(name);
...
bool lookupBool(const Properties& props, const std::string& name, bool defaultValue) {
    Property p = props.lookup(name);
    if (p.found()) {
        return (p.get() == "true");
    }
...
bool checkIfTrue(const Properties& props, const std::string& name, const std::string& defaultValue) {
...
bool LazyExpressions::check(const Properties& props, bool default_value) {
...
bool UseFastForest::check(const Properties& props) {
    return lookupBool(props, NAME, DEFAULT_VALUE);
}
...
std::string FirstPhase::lookup(const Properties& props) {
...
std::string Attribute::lookup(const Properties& props, const std::string& defaultValue) {
    return lookupString(props, NAME, defaultValue);
}

std::string Operation::lookup(const Properties& props, const std::string& defaultValue) {
    return lookupString(props, NAME, defaultValue);
}
...
std::vector<std::pair<std::string, std::string>> Rename::lookup(const Properties& props) {
...
bool IgnoreDefaultFeatures::check(const Properties& props) {
...
double TermwiseLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double TermwiseLimit::lookup(const Properties& props, double defaultValue) {
...
uint32_t NumThreadsPerSearch::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t NumThreadsPerSearch::lookup(const Properties& props, uint32_t defaultValue) {
...
uint32_t NumSearchPartitions::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t NumSearchPartitions::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}
...
uint32_t MinHitsPerThread::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t MinHitsPerThread::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}
...
double GlobalFilterLowerLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double GlobalFilterLowerLimit::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
double GlobalFilterUpperLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double GlobalFilterUpperLimit::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
double WeakAndStopWordAdjustLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}
...
double WeakAndStopWordDropLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}
...
bool WeakAndAllowDropAll::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}
...
std::optional<search::fef::ElementGap> ElementGap::lookup_for_field(const Properties&  props,
...
void ElementGap::set_for_field(Properties& props, const std::string& field_name, const std::string& element_gap) {
...
const double FilterFirstUpperLimit::DEFAULT_VALUE(0.2);

double FilterFirstUpperLimit::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double FilterFirstUpperLimit::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
double FilterFirstExploration::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double FilterFirstExploration::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
double ExplorationSlack::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

double ExplorationSlack::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
bool TensorsPrefetch::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

bool TensorsPrefetch::lookup(const Properties& props, bool defaultValue) {
    return lookupBool(props, NAME, defaultValue);
}
...
double TargetHitsMaxAdjustmentFactor::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}
...
vespalib::FuzzyMatchingAlgorithm FuzzyAlgorithm::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

vespalib::FuzzyMatchingAlgorithm FuzzyAlgorithm::lookup(const Properties&                props,
                                                        vespalib::FuzzyMatchingAlgorithm default_value) {
...
bool KeepBlueprintOrder::check(const Properties& props, bool fallback) {
    return lookupBool(props, NAME, fallback);
}
...
std::string DegradationAttribute::lookup(const Properties& props, const std::string& defaultValue) {
    return lookupString(props, NAME, defaultValue);
}

bool DegradationAscendingOrder::lookup(const Properties& props, bool defaultValue) {
    return lookupBool(props, NAME, defaultValue);
}

uint32_t DegradationMaxHits::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}

double DegradationSamplePercentage::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}

double DegradationMaxFilterCoverage::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}

double DegradationPostFilterMultiplier::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}

std::string DiversityAttribute::lookup(const Properties& props, const std::string& defaultValue) {
    return lookupString(props, NAME, defaultValue);
}

uint32_t DiversityMinGroups::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}

double DiversityCutoffFactor::lookup(const Properties& props, double defaultValue) {
    return lookupDouble(props, NAME, defaultValue);
}

std::string DiversityCutoffStrategy::lookup(const Properties& props, const std::string& defaultValue) {
    return lookupString(props, NAME, defaultValue);
}
...
uint32_t Level::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t Level::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}
...
uint32_t HeapSize::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t HeapSize::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}
...
uint32_t ArraySize::lookup(const Properties& props) {
    return lookup(props, DEFAULT_VALUE);
}

uint32_t ArraySize::lookup(const Properties& props, uint32_t defaultValue) {
    return lookupUint32(props, NAME, defaultValue);
}
...
uint32_t EstimatePoint::lookup(const Properties& props) {
    return lookupUint32(props, NAME, DEFAULT_VALUE);
}
...
uint32_t EstimateLimit::lookup(const Properties& props) {
    return lookupUint32(props, NAME, DEFAULT_VALUE);
}
...
std::optional<feature_t> FirstPhaseRankScoreDropLimit::lookup(const Properties&        props,
                                                              std::optional<feature_t> default_value) {
    return lookup_opt_double(props, NAME, default_value);
}
...
std::optional<feature_t> SecondPhaseRankScoreDropLimit::lookup(const Properties& props) {
    return lookup_opt_double(props, NAME, DEFAULT_VALUE);
}
...
uint32_t FieldWeight::lookup(const Properties& props, const std::string& fieldName) {
...
void IsFilterField::set(Properties& props, const std::string& fieldName) {
    props.add(BASE_NAME + fieldName, "true");
}

bool IsFilterField::check(const Properties& props, const std::string& fieldName) {
...
std::string Attribute::lookup(const Properties& props, const std::string& attributeName) {
    return lookupString(props, BASE_NAME + attributeName, DEFAULT_VALUE);
}

void Attribute::set(Properties& props, const std::string& attributeName, const std::string& type) {
...
std::string QueryFeature::lookup(const Properties& props, const std::string& queryFeatureName) {
    return lookupString(props, BASE_NAME + queryFeatureName, DEFAULT_VALUE);
}

void QueryFeature::set(Properties& props, const std::string& queryFeatureName, const std::string& type) {
