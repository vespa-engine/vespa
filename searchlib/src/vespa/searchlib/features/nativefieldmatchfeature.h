...
struct NativeFieldMatchParam : public NativeParamBase
{
    ...
    NativeFieldMatchParam() noexcept : NativeParamBase(), firstOccTable(nullptr), numOccTable(nullptr), averageFieldLength(NOT_DEF_FIELD_LENGTH), firstOccImportance(0.5) { }
