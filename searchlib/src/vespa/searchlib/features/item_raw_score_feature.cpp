...
void ItemRawScoreExecutor::execute(uint32_t docId) {
...
void ItemRawScoreExecutor::handle_bind_match_data(const MatchData& md) {
    _md = &md;
}

//-----------------------------------------------------------------------------

void SimpleItemRawScoreExecutor::execute(uint32_t docId) {
    feature_t                 output = 0.0;
...
void SimpleItemRawScoreExecutor::handle_bind_match_data(const MatchData& md) {
    _md = &md;
}
...
FeatureExecutor& ItemRawScoreBlueprint::createExecutor(const IQueryEnvironment& queryEnv,
