...
SubqueriesExecutor::SubqueriesExecutor(const IQueryEnvironment& env, uint32_t fieldId)
...
void SubqueriesExecutor::handle_bind_match_data(const fef::MatchData& md) {
    _md = &md;
}
...
bool SubqueriesBlueprint::setup(const IIndexEnvironment&, const ParameterList& params) {
...
FeatureExecutor& SubqueriesBlueprint::createExecutor(const IQueryEnvironment& queryEnv,
