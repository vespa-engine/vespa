...
public:
     ...
     */
    ProximityExecutor(const fef::IQueryEnvironment& env, const ProximityConfig& config);
...
private:
    ...
    bool findBest(const fef::TermFieldMatchData& matchA, const fef::TermFieldMatchData& matchB);
