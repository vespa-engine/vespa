...
public:
    IndexFieldInfoExecutor(feature_t type, feature_t isFilter, uint32_t field, fef::TermFieldHandle fieldHandle);
...
public:
    ...
    fef::ParameterDescriptions getDescriptions() const override {
        return fef::ParameterDescriptions().desc(0).desc(1).string();
    }
    bool setup(const fef::IIndexEnvironment& env, const fef::ParameterList& params) override;
    fef::FeatureExecutor& createExecutor(const fef::IQueryEnvironment& queryEnv,
