...
FirstPhaseRankLookup::FirstPhaseRankLookup() : _map() {
}
...
feature_t FirstPhaseRankLookup::lookup(uint32_t docid) const noexcept {
...
FirstPhaseRankLookup* FirstPhaseRankLookup::get_mutable_shared_state(fef::IObjectStore& store) {
...
const FirstPhaseRankLookup* FirstPhaseRankLookup::get_shared_state(const fef::IObjectStore& store) {
