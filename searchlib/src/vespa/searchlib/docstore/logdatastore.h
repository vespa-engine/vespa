...
public:
    ...
    public:
        ...
        size_t getMaxRemovesPerFile() const { return _maxRemovesPerFile; }
        Config & setMaxRemovesPerFile(size_t v) { _maxRemovesPerFile = v; return *this; }
