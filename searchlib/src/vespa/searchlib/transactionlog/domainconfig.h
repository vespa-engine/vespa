...
public:
    ...
    DomainConfig& setPartSizeLimit(size_t v) {
        _partSizeLimit = v;
        return *this;
    }
    DomainConfig& setChunkSizeLimit(size_t v) {
        _chunkSizeLimit = v;
        return *this;
    }
    DomainConfig& setCompressionLevel(uint8_t v) {
        _compressionLevel = v;
        return *this;
    }
    DomainConfig& setFSyncOnCommit(bool v) {
        _fSyncOnCommit = v;
        return *this;
    }
...
struct PartInfo {
    ...
    std::string    file;
    PartInfo(SerialNumRange range_in, size_t numEntries_in, size_t byteSize_in, uint64_t size_on_disk_in,
...
struct DomainInfo {
    ...
    DomainInfo(SerialNumRange range_in, size_t numEntries_in, size_t byteSize_in, uint64_t size_on_disk_in,
               DurationSeconds maxSessionRunTime_in);
    DomainInfo();
    ~DomainInfo();
};
