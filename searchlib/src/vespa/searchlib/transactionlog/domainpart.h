...
public:
    ...
    size_t byteSize() const { return _byteSize.load(std::memory_order_acquire); }
...
private:
    ...
    static Packet readPacket(FastOS_FileInterface& file, SerialNumRange wanted, size_t targetSize,
                             bool allowTruncate);
