...
uint64_t CodingTables::_intMask64[65] = {
    (UINT64_C(1) << 0) - 1,    (UINT64_C(1) << 1) - 1,  (UINT64_C(1) << 2) - 1,  (UINT64_C(1) << 3) - 1,
    (UINT64_C(1) << 4) - 1,    (UINT64_C(1) << 5) - 1,  (UINT64_C(1) << 6) - 1,  (UINT64_C(1) << 7) - 1,
    (UINT64_C(1) << 8) - 1,    (UINT64_C(1) << 9) - 1,  (UINT64_C(1) << 10) - 1, (UINT64_C(1) << 11) - 1,
    (UINT64_C(1) << 12) - 1,   (UINT64_C(1) << 13) - 1, (UINT64_C(1) << 14) - 1, (UINT64_C(1) << 15) - 1,
    (UINT64_C(1) << 16) - 1,   (UINT64_C(1) << 17) - 1, (UINT64_C(1) << 18) - 1, (UINT64_C(1) << 19) - 1,
    (UINT64_C(1) << 20) - 1,   (UINT64_C(1) << 21) - 1, (UINT64_C(1) << 22) - 1, (UINT64_C(1) << 23) - 1,
    (UINT64_C(1) << 24) - 1,   (UINT64_C(1) << 25) - 1, (UINT64_C(1) << 26) - 1, (UINT64_C(1) << 27) - 1,
    (UINT64_C(1) << 28) - 1,   (UINT64_C(1) << 29) - 1, (UINT64_C(1) << 30) - 1, (UINT64_C(1) << 31) - 1,
    (UINT64_C(1) << 32) - 1,   (UINT64_C(1) << 33) - 1, (UINT64_C(1) << 34) - 1, (UINT64_C(1) << 35) - 1,
    (UINT64_C(1) << 36) - 1,   (UINT64_C(1) << 37) - 1, (UINT64_C(1) << 38) - 1, (UINT64_C(1) << 39) - 1,
    (UINT64_C(1) << 40) - 1,   (UINT64_C(1) << 41) - 1, (UINT64_C(1) << 42) - 1, (UINT64_C(1) << 43) - 1,
    (UINT64_C(1) << 44) - 1,   (UINT64_C(1) << 45) - 1, (UINT64_C(1) << 46) - 1, (UINT64_C(1) << 47) - 1,
    (UINT64_C(1) << 48) - 1,   (UINT64_C(1) << 49) - 1, (UINT64_C(1) << 50) - 1, (UINT64_C(1) << 51) - 1,
    (UINT64_C(1) << 52) - 1,   (UINT64_C(1) << 53) - 1, (UINT64_C(1) << 54) - 1, (UINT64_C(1) << 55) - 1,
    (UINT64_C(1) << 56) - 1,   (UINT64_C(1) << 57) - 1, (UINT64_C(1) << 58) - 1, (UINT64_C(1) << 59) - 1,
    (UINT64_C(1) << 60) - 1,   (UINT64_C(1) << 61) - 1, (UINT64_C(1) << 62) - 1, (UINT64_C(1) << 63) - 1,
    static_cast<uint64_t>(-1),
};

uint64_t CodingTables::_intMask64le[65] = {
    /**/ 0,
    -(UINT64_C(1) << 63),
    -(UINT64_C(1) << 62),
    -(UINT64_C(1) << 61),
...
template <> void EncodeContext64EBase<false>::writeBits(uint64_t data, uint32_t length) {
...
void DecodeContext64Base::readBytes(uint8_t* buf, size_t len) {
    while (len > 0) {
...
uint32_t DecodeContext64Base::readHeader(vespalib::GenericHeader& header, int64_t fileSize) {
    ...
    if (headerLen > hhSize) {
        ...
        readBytes(reinterpret_cast<uint8_t*>(dataBuffer.getFree()), headerLen - hhSize);
...
bool DecodeContext64Base::is_padded_for_memory_map(uint64_t file_bit_size, uint64_t file_size) noexcept {
...
void FeatureEncodeContext<bigEndian>::writeBits(const uint64_t* bits, uint32_t bitOffset, uint64_t bitLength) {
    ...
    if (bitOffset + bitLength < 64) {
        ...
        if (bigEndian) {
            ...
            uint64_t data = (EC::bswap(*bits) >> bitOffset) & CodingTables::_intMask64[length];
        ...
        do {
            ...
            bitsLeft -= length;
            if (bigEndian) {
                uint64_t data = EC::bswap(*bits) & CodingTables::_intMask64[length];
                UC64BE_WRITEBITS_NS(o, EC);
            } else {
                uint64_t data = (EC::bswap(*bits) >> bitOffset) & CodingTables::_intMask64[length];
                UC64LE_WRITEBITS_NS(o, EC);
...
template <bool bigEndian> void FeatureEncodeContext<bigEndian>::writeBytes(std::span<const char> buf) {
...
template <bool bigEndian> void FeatureEncodeContext<bigEndian>::writeBytes(std::span<const unsigned char> buf) {
    for (unsigned char c : buf) {
        writeBits(c, 8);
...
template <bool bigEndian> void FeatureEncodeContext<bigEndian>::writeString(std::string_view buf) {
    size_t len = buf.size();
...
template <bool bigEndian> void FeatureEncodeContext<bigEndian>::writeHeader(const vespalib::GenericHeader& header) {
    vespalib::DataBuffer                  dataBuffer(32_Ki);
...
template <bool bigEndian>
void FeatureDecodeContext<bigEndian>::readHeader(const vespalib::GenericHeader& header, const std::string& prefix) {
    (void)header;
    (void)prefix;
}

template <bool bigEndian> const std::string& FeatureDecodeContext<bigEndian>::getIdentifier() const {
    return noFeatures;
}

template <bool bigEndian> void FeatureDecodeContext<bigEndian>::readFeatures(DocIdAndFeatures& features) {
    (void)features;
}

template <bool bigEndian> void FeatureDecodeContext<bigEndian>::skipFeatures(unsigned int count) {
    (void)count;
}

template <bool bigEndian>
void FeatureDecodeContext<bigEndian>::unpackFeatures(const search::fef::TermFieldMatchDataArray& matchData,
                                                     uint32_t                                    docId) {
    if (matchData.size() == 1) {
...
template <bool bigEndian> void FeatureDecodeContext<bigEndian>::setParams(const PostingListParams& params) {
    (void)params;
}

template <bool bigEndian> void FeatureDecodeContext<bigEndian>::getParams(PostingListParams& params) const {
    params.clear();
}

template <bool bigEndian> void FeatureEncodeContext<bigEndian>::pad_for_memory_map_and_flush() {
...
template <bool bigEndian>
void FeatureEncodeContext<bigEndian>::readHeader(const vespalib::GenericHeader& header, const std::string& prefix) {
    (void)header;
    (void)prefix;
}

template <bool bigEndian>
void FeatureEncodeContext<bigEndian>::writeHeader(vespalib::GenericHeader& header, const std::string& prefix) const {
    (void)header;
    (void)prefix;
}

template <bool bigEndian> const std::string& FeatureEncodeContext<bigEndian>::getIdentifier() const {
    return noFeatures;
}

template <bool bigEndian> void FeatureEncodeContext<bigEndian>::writeFeatures(const DocIdAndFeatures& features) {
    (void)features;
}

template <bool bigEndian> void FeatureEncodeContext<bigEndian>::setParams(const PostingListParams& params) {
    (void)params;
}

template <bool bigEndian> void FeatureEncodeContext<bigEndian>::getParams(PostingListParams& params) const {
    params.clear();
}

template <> void EncodeContext64EBase<true>::writeBits(uint64_t data, uint32_t length) {
    // While there are enough bits remaining in "data",
    // fill the cacheInt and flush it to vector
    if (length >= _cacheFree) [[unlikely]] {
        // Shift new bits into cacheInt
        _cacheInt |= ((data >> (length - _cacheFree)) & CodingTables::_intMask64[_cacheFree]);
        *_valI++ = bswap(_cacheInt);
