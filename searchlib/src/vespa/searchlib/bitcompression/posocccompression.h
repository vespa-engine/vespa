...
template <bool bigEndian> class EG2PosOccDecodeContext : public FeatureDecodeContext<bigEndian> {
public:
    ...
    EG2PosOccDecodeContext(const PosOccFieldsParams* fieldsParams)
        : FeatureDecodeContext<bigEndian>(), _fieldsParams(fieldsParams) {}

    EG2PosOccDecodeContext(const uint64_t* compr, int bitOffset, const PosOccFieldsParams* fieldsParams)
        : FeatureDecodeContext<bigEndian>(compr, bitOffset), _fieldsParams(fieldsParams) {}

    EG2PosOccDecodeContext(const uint64_t* compr, int bitOffset, uint64_t bitLength,
                           const PosOccFieldsParams* fieldsParams)
        : FeatureDecodeContext<bigEndian>(compr, bitOffset, bitLength), _fieldsParams(fieldsParams) {}

    EG2PosOccDecodeContext& operator=(const EG2PosOccDecodeContext& rhs) {
...
template <bool bigEndian> class EG2PosOccDecodeContextCooked : public EG2PosOccDecodeContext<bigEndian> {
public:
    ...
    EG2PosOccDecodeContextCooked(const uint64_t* compr, int bitOffset, const PosOccFieldsParams* fieldsParams)
        : EG2PosOccDecodeContext<bigEndian>(compr, bitOffset, fieldsParams) {}

    EG2PosOccDecodeContextCooked(const uint64_t* compr, int bitOffset, uint64_t bitLength,
                                 const PosOccFieldsParams* fieldsParams)
        : EG2PosOccDecodeContext<bigEndian>(compr, bitOffset, bitLength, fieldsParams) {}

    EG2PosOccDecodeContextCooked& operator=(const EG2PosOccDecodeContext<bigEndian>& rhs) {
...
template <bool bigEndian> class EG2PosOccEncodeContext : public FeatureEncodeContext<bigEndian> {
public:
    ...
    EG2PosOccEncodeContext(const PosOccFieldsParams* fieldsParams)
        : FeatureEncodeContext<bigEndian>(), _fieldsParams(fieldsParams) {}

    EG2PosOccEncodeContext& operator=(const EG2PosOccEncodeContext& rhs) {
...
template <bool bigEndian> class EGPosOccDecodeContext : public EG2PosOccDecodeContext<bigEndian> {
public:
    using ParentClass = EG2PosOccDecodeContext<bigEndian>;
    using DocIdAndFeatures = index::DocIdAndFeatures;
    using PostingListParams = index::PostingListParams;
    ...
    EGPosOccDecodeContext(const PosOccFieldsParams* fieldsParams) : EG2PosOccDecodeContext<bigEndian>(fieldsParams) {}

    EGPosOccDecodeContext(const uint64_t* compr, int bitOffset, const PosOccFieldsParams* fieldsParams)
        : EG2PosOccDecodeContext<bigEndian>(compr, bitOffset, fieldsParams) {}

    EGPosOccDecodeContext(const uint64_t* compr, int bitOffset, uint64_t bitLength,
                          const PosOccFieldsParams* fieldsParams)
        : EG2PosOccDecodeContext<bigEndian>(compr, bitOffset, bitLength, fieldsParams) {}

    EGPosOccDecodeContext& operator=(const EGPosOccDecodeContext& rhs) {
        EG2PosOccDecodeContext<bigEndian>::operator=(rhs);
        return *this;
    }
...
template <bool bigEndian> class EGPosOccDecodeContextCooked : public EGPosOccDecodeContext<bigEndian> {
public:
    ...
    EGPosOccDecodeContextCooked(const uint64_t* compr, int bitOffset, const PosOccFieldsParams* fieldsParams)
        : EGPosOccDecodeContext<bigEndian>(compr, bitOffset, fieldsParams) {}

    EGPosOccDecodeContextCooked(const uint64_t* compr, int bitOffset, uint64_t bitLength,
                                const PosOccFieldsParams* fieldsParams)
        : EGPosOccDecodeContext<bigEndian>(compr, bitOffset, bitLength, fieldsParams) {}

    EGPosOccDecodeContextCooked& operator=(const EGPosOccDecodeContext<bigEndian>& rhs) {
...
template <bool bigEndian> class EGPosOccEncodeContext : public EG2PosOccEncodeContext<bigEndian> {
public:
    ...
    EGPosOccEncodeContext(const PosOccFieldsParams* fieldsParams) : EG2PosOccEncodeContext<bigEndian>(fieldsParams) {}

    EGPosOccEncodeContext& operator=(const EGPosOccEncodeContext& rhs) {
