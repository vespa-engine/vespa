...
public:
    ...
    private:
        void execute(vespalib::Identifiable& obj) override {
            static_cast<HitsAggregationResult&>(obj)._isOrdered = true;
        }
    ...
    HitsAggregationResult setSummaryClass(std::string_view summaryClass) {
