...
SingleRawAttributeLoader::SingleRawAttributeLoader(AttributeVector& attr, RefVector& ref_vector,
                                                   RawBufferStore& raw_store)
    : _attr(attr), _ref_vector(ref_vector), _raw_store(raw_store) {
}

SingleRawAttributeLoader::~SingleRawAttributeLoader() = default;

void SingleRawAttributeLoader::load_raw_store(BlobSequenceReader& reader, uint32_t docid_limit) {
...
bool SingleRawAttributeLoader::on_load(vespalib::Executor*) {
