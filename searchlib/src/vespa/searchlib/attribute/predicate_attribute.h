...
struct AttributeVectorDocIdLimitProvider : public predicate::DocIdLimitProvider {
    ...
    uint32_t getCommittedDocIdLimit() const override { return _attribute_vector.getCommittedDocIdLimit(); }
...
public:
    ...
    const IntervalRange* getIntervalRangeVector() const { return &_interval_range_vector.acquire_elem_ref(0); }

    IntervalRange getMaxIntervalRange() const { return _max_interval_range; }
