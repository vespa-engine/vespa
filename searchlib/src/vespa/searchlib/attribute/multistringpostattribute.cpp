...
IEnumStore::Index StringEnumIndexMapper::map(IEnumStore::Index original) const {
...
template class MultiValueStringPostingAttributeT<EnumAttribute<StringAttribute>,
