...
public:
    ...
    void set(DocId doc, T v) { vespalib::atomic::store_ref_relaxed(_data[doc], v); }

    T getFast(DocId doc) const { return vespalib::atomic::load_ref_relaxed(_data.acquire_elem_ref(doc)); }
