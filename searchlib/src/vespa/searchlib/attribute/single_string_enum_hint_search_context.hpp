...
SingleStringEnumHintSearchContextT<Matcher>::SingleStringEnumHintSearchContextT(
    ...
    const AttributeVector& toBeSearched, typename SingleStringEnumHintSearchContextT::EnumIndices enum_indices,
    const EnumStoreT<const char*>& enum_store, uint64_t num_values)
    : SingleStringEnumSearchContextT<Matcher>(std::move(qTerm), cased, fuzzy_matching_algorithm, toBeSearched,
