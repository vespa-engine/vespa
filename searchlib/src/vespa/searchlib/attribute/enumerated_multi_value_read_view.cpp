...
EnumeratedMultiValueReadView<MultiValueType, RawMultiValueType, EnumEntryType>::EnumeratedMultiValueReadView(
    MultiValueMappingReadView<RawMultiValueType> mv_mapping_read_view, const EnumStoreT<EnumEntryType>& enum_store)
    : _mv_mapping_read_view(mv_mapping_read_view), _enum_store(enum_store), _copy() {
}
