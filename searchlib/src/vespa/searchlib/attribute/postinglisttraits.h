...
template <> class PostingListTraits<vespalib::btree::BTreeNoLeafData> {
private:
...
public:
    ...
    using const_iterator = vespalib::btree::BTreeConstIterator<uint32_t, vespalib::btree::BTreeNoLeafData,
                                                               AggregatedType, std::less<uint32_t>, BTreeTraits>;
    using PostingStoreBase = vespalib::btree::BTreeStore<uint32_t, vespalib::btree::BTreeNoLeafData, AggregatedType,
...
template <> class PostingListTraits<int32_t> {
private:
...
public:
    ...
    using const_iterator =
        vespalib::btree::BTreeConstIterator<uint32_t, int32_t, AggregatedType, std::less<uint32_t>, BTreeTraits>;
    using PostingStoreBase = vespalib::btree::BTreeStore<uint32_t, int32_t, AggregatedType, std::less<uint32_t>,
                                                         BTreeTraits, AggrCalcType>;
