...
void MatchingElements::add_matching_elements(uint32_t docid, const std::string& field_name,
...
const std::vector<uint32_t>& MatchingElements::get_matching_elements(uint32_t           docid,
