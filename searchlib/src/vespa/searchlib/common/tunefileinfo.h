...
public:
    enum TuneControl { NORMAL, DIRECTIO };
...
public:
    ...
    template <typename Config> void setFromConfig(const enum Config::Io& config) noexcept {
        switch (config) {
    ...
    bool operator==(const TuneFileSeqRead& rhs) const noexcept { return _tuneControl == rhs._tuneControl; }
...
public:
    enum TuneControl { NORMAL, OSYNC, DIRECTIO };
...
public:
    TuneFileRandRead() noexcept : _tuneControl(NORMAL), _mmapFlags(0), _advise(0) {}
    ...
    template <typename MMapConfig> void setFromMmapConfig(const MMapConfig& mmapFlags) noexcept;
...
public:
    ...
    bool operator==(const TuneFileIndexing& rhs) const noexcept { return _read == rhs._read && _write == rhs._write; }
...
public:
    ...
    bool operator==(const TuneFileSearch& rhs) const noexcept {
        return _read == rhs._read && _force_memory_map_posting_list == rhs._force_memory_map_posting_list;
    }
...
public:
    ...
    bool operator==(const TuneFileAttributes& rhs) const noexcept { return _write == rhs._write; }
...
public:
    ...
    bool operator==(const TuneFileSummary& rhs) const noexcept {
        return _seqRead == rhs._seqRead && _write == rhs._write && _randRead == rhs._randRead;
    }
...
public:
    ...
    bool operator==(const TuneFileDocumentDB& rhs) const noexcept {
        return _index == rhs._index && _attr == rhs._attr && _summary == rhs._summary;
    }
