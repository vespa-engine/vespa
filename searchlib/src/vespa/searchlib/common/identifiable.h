...
#define CID_search_expression_FieldValue2ResultNode SEARCHLIB_CID(58)
...
#define CID_search_aggregation_ExpressionCountAggregationResult SEARCHLIB_CID(88)
#define CID_search_aggregation_StandardDeviationAggregationResult SEARCHLIB_CID(89)
...
#define CID_search_aggregation_FirstAggregationResult SEARCHLIB_CID(183)
