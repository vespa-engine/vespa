...
protected:
    ...
    public:
        ...
        void check(const Zc4PostingReaderBase& rb, const std::string& level_name, const NoSkipBase& no_skip,
                   bool top_level, bool decode_features);
    ...
    public:
        L2Skip();
        void setup(DecodeContext& decode_context, uint32_t size, uint32_t doc_id, uint32_t last_doc_id);
        void check(const Zc4PostingReaderBase& rb, const std::string& level_name, const L1Skip& l1_skip,
                   bool top_level, bool decode_features);
    ...
    public:
        L3Skip();
        void setup(DecodeContext& decode_context, uint32_t size, uint32_t doc_id, uint32_t last_doc_id);
        void check(const Zc4PostingReaderBase& rb, const std::string& level_name, const L2Skip& l2_skip,
                   bool top_level, bool decode_features);
    ...
    public:
        L4Skip();
        void setup(DecodeContext& decode_context, uint32_t size, uint32_t doc_id, uint32_t last_doc_id);
        void check(const Zc4PostingReaderBase& rb, const std::string& level_name, const L3Skip& l3_skip,
                   bool decode_features);
    };
    uint32_t                     _doc_id_k;
    ...
    void read_word_start_with_skip(bitcompression::DecodeContext64Base& decode_context,
...
public:
    ...
    void set_word_and_counts(bitcompression::DecodeContext64Base& decode_context, const std::string& word,
