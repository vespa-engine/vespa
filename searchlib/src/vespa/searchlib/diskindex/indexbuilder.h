...
public:
    ...
    IndexBuilder(const index::Schema& schema, std::string_view prefix, uint32_t docIdLimit, uint64_t numWordIds,
                 const index::IFieldLengthInspector& field_length_inspector, const TuneFileIndexing& tuneFileIndexing,
