...
size_t PredicateIndex::reserved_memory_for_flush() const noexcept {
    return _features_store.reserved_memory_for_flush() + _interval_index.reserved_memory_for_flush() +
           _bounds_index.reserved_memory_for_flush();
};
