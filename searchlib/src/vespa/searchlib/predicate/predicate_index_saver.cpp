...
PredicateIndexSaver::PredicateIndexSaver(std::unique_ptr<ISaver> features_store_saver, uint32_t arity,
...
void PredicateIndexSaver::save(BufferWriter& writer) const {
