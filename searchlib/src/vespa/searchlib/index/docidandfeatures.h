...
public:
    WordDocElementFeatures() noexcept
        : _elementId(0u), _numOccs(0u), _weight(1), _elementLen(SEARCHLIB_FEF_UNKNOWN_FIELD_LENGTH) {}

    WordDocElementFeatures(uint32_t elementId) noexcept
        : _elementId(elementId), _numOccs(0u), _weight(1), _elementLen(SEARCHLIB_FEF_UNKNOWN_FIELD_LENGTH) {}

    WordDocElementFeatures(uint32_t elementId, uint32_t weight, uint32_t elementLen) noexcept
        : _elementId(elementId), _numOccs(0u), _weight(weight), _elementLen(elementLen) {}
...
public:
    WordDocElementWordPosFeatures() noexcept : _wordPos(0u) {}

    WordDocElementWordPosFeatures(uint32_t wordPos) noexcept : _wordPos(wordPos) {}
