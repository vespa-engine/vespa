...
CatSerializer& CatSerializer::get(bool& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(uint8_t& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(uint16_t& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(uint32_t& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(uint64_t& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(double& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(float& value) {
    return nop(&value);
}
CatSerializer& CatSerializer::get(string& value) {
    return nop(&value);
}
