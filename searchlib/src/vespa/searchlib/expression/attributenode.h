...
public:
    ...
    private:
        ...
        bool check(const vespalib::Identifiable& obj) const override { return obj.inherits(ExpressionNode::classId); }
...
protected:
    ...
    void setScratchResult(std::unique_ptr<AttributeResult> result) noexcept { _scratchResult = std::move(result); }
