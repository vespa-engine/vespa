...
std::string Status::createName(std::string_view index, std::string_view attr) {
...
void Status::updateStatistics(uint64_t numValues, uint64_t numUniqueValue, uint64_t allocated, uint64_t used,
...
void Status::updateSizes(uint64_t numValues, uint64_t numUniqueValue) {
    store_relaxed(_numValues, numValues);
    store_relaxed(_numUniqueValues, numUniqueValue);
}
