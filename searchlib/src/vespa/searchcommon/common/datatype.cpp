...
const char* datatype_str[] = {"BOOL",        "UINT2",  "UINT4",     "INT8",    "INT16", "INT32",
                              "INT64",       "FLOAT",  "DOUBLE",    "STRING",  "RAW",   "FEATURE_NOTUSED",
                              "BOOLEANTREE", "TENSOR", "REFERENCE", "COMBINED"};
...
CollectionType collectionTypeFromName(std::string_view name) {
    if (name == "SINGLE") {
        return CollectionType::SINGLE;
    } else if (name == "ARRAY") {
        return CollectionType::ARRAY;
    } else if (name == "WEIGHTEDSET") {
...
const char* collectiontype_str[] = {"SINGLE", "ARRAY", "WEIGHTEDSET"};
