...
public:
    ...
    */
    ...
    static Value getPriority(const string& priorityName) {
        ...
        if (priorityName == ("VERY_HIGH")) {
            return PRI_VERY_HIGH;
        }
        if (priorityName == ("HIGH_1")) {
            return PRI_HIGH_1;
        }
        if (priorityName == ("HIGH_2")) {
            return PRI_HIGH_2;
        }
        if (priorityName == ("HIGH_3")) {
            return PRI_HIGH_3;
        }
        if (priorityName == ("NORMAL_1")) {
            return PRI_NORMAL_1;
        }
        if (priorityName == ("NORMAL_2")) {
            return PRI_NORMAL_2;
        }
        if (priorityName == ("NORMAL_3")) {
            return PRI_NORMAL_3;
        }
        if (priorityName == ("NORMAL_4")) {
            return PRI_NORMAL_4;
        }
        if (priorityName == ("NORMAL_5")) {
            return PRI_NORMAL_5;
        }
        if (priorityName == ("NORMAL_6")) {
            return PRI_NORMAL_6;
        }
        if (priorityName == ("LOW_1")) {
            return PRI_LOW_1;
        }
        if (priorityName == ("LOW_2")) {
            return PRI_LOW_2;
        }
        if (priorityName == ("LOW_3")) {
            return PRI_LOW_3;
        }
        if (priorityName == ("VERY_LOW")) {
            return PRI_VERY_LOW;
        }
