...
void MessageTypePolicy::configure(std::unique_ptr<MessagetyperouteselectorpolicyConfig> cfg) {
...
void MessageTypePolicy::select(mbus::RoutingContext& context) {
...
void MessageTypePolicy::merge(mbus::RoutingContext& context) {
