...
mbus::IRoutingPolicy::UP RoutingPolicyFactories::AndPolicyFactory::createPolicy(const string& param) const {
    return std::make_unique<ANDPolicy>(param);
}

mbus::IRoutingPolicy::UP RoutingPolicyFactories::MessageTypePolicyFactory::createPolicy(const string& param) const {
    return std::make_unique<MessageTypePolicy>(config::ConfigUri(param));
}

mbus::IRoutingPolicy::UP RoutingPolicyFactories::ContentPolicyFactory::createPolicy(const string& param) const {
...
mbus::IRoutingPolicy::UP RoutingPolicyFactories::LoadBalancerPolicyFactory::createPolicy(const string& param) const {
...
RoutingPolicyFactories::DocumentRouteSelectorPolicyFactory::DocumentRouteSelectorPolicyFactory(
    const document::IDocumentTypeRepo& repo, const string& configId)
    : _repo(repo), _configId(configId) {
    // empty
}
...
RoutingPolicyFactories::DocumentRouteSelectorPolicyFactory::createPolicy(const string& param) const {
    auto ret =
        std::make_unique<DocumentRouteSelectorPolicy>(_repo, config::ConfigUri(param.empty() ? _configId : param));
...
mbus::IRoutingPolicy::UP RoutingPolicyFactories::ExternPolicyFactory::createPolicy(const string& param) const {
...
mbus::IRoutingPolicy::UP RoutingPolicyFactories::LocalServicePolicyFactory::createPolicy(const string& param) const {
    return std::make_unique<LocalServicePolicy>(param);
}

mbus::IRoutingPolicy::UP RoutingPolicyFactories::RoundRobinPolicyFactory::createPolicy(const string& param) const {
    return std::make_unique<RoundRobinPolicy>(param);
}

mbus::IRoutingPolicy::UP RoutingPolicyFactories::SubsetServicePolicyFactory::createPolicy(const string& param) const {
