...
bool RoutableFactories60::DocumentMessageFactory::encode(const mbus::Routable&         obj,
                                                         vespalib::GrowableByteBuffer& out) const {
...
mbus::Routable::UP RoutableFactories60::DocumentMessageFactory::decode(document::ByteBuffer& in) const {
    uint8_t pri;
    in.getByte(pri);
    (void)decodeInt(in);
...
bool RoutableFactories60::DocumentReplyFactory::encode(const mbus::Routable&         obj,
                                                       vespalib::GrowableByteBuffer& out) const {
...
mbus::Routable::UP RoutableFactories60::DocumentReplyFactory::decode(document::ByteBuffer& in) const {
    uint8_t pri;
    in.getByte(pri);
...
DocumentMessage::UP RoutableFactories60::CreateVisitorMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::CreateVisitorMessageFactory::doEncode(const DocumentMessage&        obj,
...
bool RoutableFactories60::CreateVisitorMessageFactory::encodeBucketSpace(std::string_view              bucketSpace,
                                                                         vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::DestroyVisitorMessageFactory::doDecode(document::ByteBuffer& buf) const {
    auto msg = std::make_unique<DestroyVisitorMessage>();
    msg->setInstanceId(decodeString(buf));
    return msg;
}

bool RoutableFactories60::DestroyVisitorMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                 vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::CreateVisitorReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::CreateVisitorReplyFactory::doEncode(const DocumentReply&          obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::DestroyVisitorReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_DESTROYVISITOR);
}

bool RoutableFactories60::DestroyVisitorReplyFactory::doEncode(const DocumentReply&,
                                                               vespalib::GrowableByteBuffer&) const {
    return true;
}

DocumentReply::UP RoutableFactories60::DocumentIgnoredReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<DocumentIgnoredReply>();
}

bool RoutableFactories60::DocumentIgnoredReplyFactory::doEncode(const DocumentReply&,
                                                                vespalib::GrowableByteBuffer&) const {
    return true;
}

DocumentMessage::UP RoutableFactories60::DocumentListMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::DocumentListMessageFactory::doEncode(const DocumentMessage&        obj,
                                                               vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::DocumentListReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_DOCUMENTLIST);
}

bool RoutableFactories60::DocumentListReplyFactory::doEncode(const DocumentReply&,
                                                             vespalib::GrowableByteBuffer&) const {
    return true;
}

DocumentMessage::UP RoutableFactories60::EmptyBucketsMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::EmptyBucketsMessageFactory::doEncode(const DocumentMessage&        obj,
                                                               vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::EmptyBucketsReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_EMPTYBUCKETS);
}

bool RoutableFactories60::EmptyBucketsReplyFactory::doEncode(const DocumentReply&,
                                                             vespalib::GrowableByteBuffer&) const {
    return true;
}
...
DocumentMessage::UP RoutableFactories60::GetBucketListMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::GetBucketListMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::GetBucketListReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::GetBucketListReplyFactory::doEncode(const DocumentReply&          obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::GetBucketStateMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::GetBucketStateMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                 vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::GetBucketStateReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::GetBucketStateReplyFactory::doEncode(const DocumentReply&          obj,
                                                               vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::GetDocumentMessageFactory::doDecode(document::ByteBuffer& buf) const {
    document::DocumentId docId = decodeDocumentId(buf);
    return std::make_unique<GetDocumentMessage>(docId, decodeString(buf));
}

bool RoutableFactories60::GetDocumentMessageFactory::doEncode(const DocumentMessage&        obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
std::shared_ptr<document::Document> decodeDocument(const document::DocumentTypeRepo& repo,
...
DocumentReply::UP RoutableFactories60::GetDocumentReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::GetDocumentReplyFactory::doEncode(const DocumentReply&          obj,
                                                            vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::MapVisitorMessageFactory::doDecode(document::ByteBuffer& buf) const {
    auto msg = std::make_unique<MapVisitorMessage>();
    msg->getData().deserialize(buf);
    return msg;
}

bool RoutableFactories60::MapVisitorMessageFactory::doEncode(const DocumentMessage&        obj,
                                                             vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::MapVisitorReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_MAPVISITOR);
}

bool RoutableFactories60::MapVisitorReplyFactory::doEncode(const DocumentReply&,
                                                           vespalib::GrowableByteBuffer&) const {
    return true;
}

void RoutableFactories60::PutDocumentMessageFactory::decodeInto(PutDocumentMessage&   msg,
...
bool RoutableFactories60::PutDocumentMessageFactory::doEncode(const DocumentMessage&        obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::PutDocumentReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::PutDocumentReplyFactory::doEncode(const DocumentReply&          obj,
                                                            vespalib::GrowableByteBuffer& buf) const {
...
void RoutableFactories60::RemoveDocumentMessageFactory::decodeInto(RemoveDocumentMessage& msg,
                                                                   document::ByteBuffer&  buf) const {
    msg.setDocumentId(decodeDocumentId(buf));
    decodeTasCondition(msg, buf);
}

bool RoutableFactories60::RemoveDocumentMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                 vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::RemoveDocumentReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::RemoveDocumentReplyFactory::doEncode(const DocumentReply&          obj,
                                                               vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::RemoveLocationMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::RemoveLocationMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                 vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::RemoveLocationReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<DocumentReply>(DocumentProtocol::REPLY_REMOVELOCATION);
}

bool RoutableFactories60::RemoveLocationReplyFactory::doEncode(const DocumentReply&,
                                                               vespalib::GrowableByteBuffer&) const {
    return true;
}

DocumentMessage::UP RoutableFactories60::QueryResultMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::QueryResultMessageFactory::doEncode(const DocumentMessage&        obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::QueryResultReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_QUERYRESULT);
}

bool RoutableFactories60::QueryResultReplyFactory::doEncode(const DocumentReply&,
                                                            vespalib::GrowableByteBuffer&) const {
    return true;
}
...
DocumentMessage::UP RoutableFactories60::StatBucketMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::StatBucketMessageFactory::doEncode(const DocumentMessage&        obj,
                                                             vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::StatBucketReplyFactory::doDecode(document::ByteBuffer& buf) const {
    auto reply = std::make_unique<StatBucketReply>();
    reply->setResults(decodeString(buf));
    return reply;
}

bool RoutableFactories60::StatBucketReplyFactory::doEncode(const DocumentReply&          obj,
                                                           vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::StatDocumentMessageFactory::doDecode(document::ByteBuffer&) const {
    return {}; // TODO: remove message type
}

bool RoutableFactories60::StatDocumentMessageFactory::doEncode(const DocumentMessage&,
                                                               vespalib::GrowableByteBuffer&) const {
    return false;
}

DocumentReply::UP RoutableFactories60::StatDocumentReplyFactory::doDecode(document::ByteBuffer&) const {
    return {}; // TODO: remove reply type
}

bool RoutableFactories60::StatDocumentReplyFactory::doEncode(const DocumentReply&,
                                                             vespalib::GrowableByteBuffer&) const {
    return false;
}

void RoutableFactories60::UpdateDocumentMessageFactory::decodeInto(UpdateDocumentMessage& msg,
                                                                   document::ByteBuffer&  buf) const {
    vespalib::nbostream stream(buf.getBufferAtPos(), buf.getRemaining());
...
bool RoutableFactories60::UpdateDocumentMessageFactory::doEncode(const DocumentMessage&        obj,
                                                                 vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::UpdateDocumentReplyFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::UpdateDocumentReplyFactory::doEncode(const DocumentReply&          obj,
                                                               vespalib::GrowableByteBuffer& buf) const {
...
DocumentMessage::UP RoutableFactories60::VisitorInfoMessageFactory::doDecode(document::ByteBuffer& buf) const {
...
bool RoutableFactories60::VisitorInfoMessageFactory::doEncode(const DocumentMessage&        obj,
                                                              vespalib::GrowableByteBuffer& buf) const {
...
DocumentReply::UP RoutableFactories60::VisitorInfoReplyFactory::doDecode(document::ByteBuffer&) const {
    return std::make_unique<VisitorReply>(DocumentProtocol::REPLY_VISITORINFO);
}

bool RoutableFactories60::VisitorInfoReplyFactory::doEncode(const DocumentReply&,
                                                            vespalib::GrowableByteBuffer&) const {
    return true;
}

DocumentReply::UP RoutableFactories60::WrongDistributionReplyFactory::doDecode(document::ByteBuffer& buf) const {
    auto reply = std::make_unique<WrongDistributionReply>();
    reply->setSystemState(decodeString(buf));
    return reply;
}

bool RoutableFactories60::WrongDistributionReplyFactory::doEncode(const DocumentReply&          obj,
                                                                  vespalib::GrowableByteBuffer& buf) const {
...
string RoutableFactories60::decodeString(document::ByteBuffer& in) {
...
bool RoutableFactories60::decodeBoolean(document::ByteBuffer& in) {
    char ret;
    in.getBytes(&ret, 1);
    return (bool)ret;
}

int32_t RoutableFactories60::decodeInt(document::ByteBuffer& in) {
    int32_t ret;
    in.getIntNetwork(ret);
    return ret;
}

int64_t RoutableFactories60::decodeLong(document::ByteBuffer& in) {
    int64_t ret;
    in.getLongNetwork(ret);
    return ret;
}

document::DocumentId RoutableFactories60::decodeDocumentId(document::ByteBuffer& in) {
...
void RoutableFactories60::encodeDocumentId(const document::DocumentId& id, vespalib::GrowableByteBuffer& out) {
