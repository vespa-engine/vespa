...
#define ERROR_CODE_KV(code_name) {#code_name, DocumentProtocol::code_name}

NamedErrorCodes all_document_protocol_error_codes() {
    using documentapi::DocumentProtocol;
    return {ERROR_CODE_KV(ERROR_MESSAGE_IGNORED),
...
void write_file(const std::filesystem::path& file_name, const std::string& content) {
