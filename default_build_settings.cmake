...
function(vespa_use_default_build_settings)
  ...
  if(NOT DEFINED DEFAULT_VESPA_CPU_ARCH_FLAGS)
    ...
    elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
      set(DEFAULT_VESPA_CPU_ARCH_FLAGS "-march=armv8.2-a+dotprod+crypto -mtune=neoverse-n1")
    endif()
  endif()
...
function(vespa_use_default_cxx_compiler)
  ...
  if(NOT DEFINED VESPA_COMPILER_VARIANT OR VESPA_COMPILER_VARIANT STREQUAL "gcc")
    ...
    elseif(VESPA_OS_DISTRO_COMBINED STREQUAL "ubuntu 24.04" AND
	EXISTS "/usr/bin/gcc-14" AND EXISTS "/usr/bin/g++-14")
      set(DEFAULT_CMAKE_C_COMPILER "/usr/bin/gcc-14")
      set(DEFAULT_CMAKE_CXX_COMPILER "/usr/bin/g++-14")
    endif()
