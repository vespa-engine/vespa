...
function(vespa_use_default_build_settings)
  ...
  if(EXISTS "/opt/arm/armpl_25.07.1_gcc/lib")
    message("-- found Arm Performance libraries")
    list(APPEND DEFAULT_EXTRA_LINK_DIRECTORY "/opt/arm/armpl_25.07.1_gcc/lib")
    list(APPEND DEFAULT_EXTRA_INCLUDE_DIRECTORY "/opt/arm/armpl_25.07.1_gcc/include")
    set(BLA_VENDOR "Arm" PARENT_SCOPLE)
    set(BLA_PKGCONFIG_BLAS "armpl-dynamic-lp64-seq" PARENT_SCOPE)
    set(BLA_PREFER_PKGCONFIG "yes" PARENT_SCOPE)
    # Add ArmPL to CMAKE_PREFIX_PATH so pkg-config can find the .pc files
    if(NOT DEFINED CMAKE_PREFIX_PATH)
      set(CMAKE_PREFIX_PATH "/opt/arm/armpl_25.07.1_gcc" PARENT_SCOPE)
    else()
      list(APPEND CMAKE_PREFIX_PATH "/opt/arm/armpl_25.07.1_gcc")
    ...
    set(BLA_VENDOR "OpenBLAS" PARENT_SCOPLE)
  endif()
...
function(vespa_use_default_cxx_compiler)
  ...
  if(NOT DEFINED VESPA_COMPILER_VARIANT OR VESPA_COMPILER_VARIANT STREQUAL "gcc")
    if(APPLE)
      set(DEFAULT_CMAKE_C_COMPILER "${VESPA_HOMEBREW_PREFIX}/bin/gcc-15")
      set(DEFAULT_CMAKE_CXX_COMPILER "${VESPA_HOMEBREW_PREFIX}/bin/g++-15")
    elseif(VESPA_OS_DISTRO_COMBINED STREQUAL "amzn 2023")
      set(DEFAULT_CMAKE_C_COMPILER "/usr/bin/gcc14-gcc")
      set(DEFAULT_CMAKE_CXX_COMPILER "/usr/bin/gcc14-g++")
