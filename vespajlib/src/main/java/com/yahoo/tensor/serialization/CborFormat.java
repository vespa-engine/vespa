...
public class CborFormat {
     ...
     */
    public static byte[] encode(Tensor tensor, boolean shortForm, boolean directValues, DataDisclosure dataDisclosure) {
        return encode(tensor, new EncodeOptions(shortForm, directValues, false), dataDisclosure);
    }
     ...
     */
    public static byte[] encode(Tensor tensor, EncodeOptions options, DataDisclosure dataDisclosure) {
        ...
        if (options.shortForm()) {
            ...
            return com.yahoo.slime.CborFormat.discloseCbor(slime, dataDisclosure);
        }
        else {
            Cursor parent = target.apply("cells").insertARRAY();
            encodeCells(tensor, parent);
    ...
    public static byte[] encode(Tensor tensor, DataDisclosure dataDisclosure) {
        return encode(tensor, false, false, dataDisclosure);
    }
    ...
    public static byte[] encodeWithType(Tensor tensor, DataDisclosure dataDisclosure) {
        return encode(tensor, false, false, dataDisclosure);
    }
     ...
     */
    @Deprecated // TODO: Remove on Vespa 9
    public static byte[] encodeShortForm(Tensor tensor, DataDisclosure dataDisclosure) {
        return encode(tensor, true, false, dataDisclosure);
    }
