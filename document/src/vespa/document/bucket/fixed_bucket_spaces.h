...
struct FixedBucketSpaces {
    ...
    static const vespalib::string & default_space_name() { return to_string(default_space()); }
    static const vespalib::string & global_space_name() { return to_string(global_space()); }
    ...
    static const vespalib::string & to_string(BucketSpace space);
};
