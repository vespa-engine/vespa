...
StructDataType::UP PositionDataType::createInstance() {
...
const StructDataType& PositionDataType::getInstance() {
...
bool PositionDataType::isZCurveFieldName(std::string_view name) {
