...
PredicateSlimeBuilder& PredicateSlimeBuilder::range(int64_t lower, int64_t upper) {
...
namespace {
template <typename InitList> void intermediateNode(long type, InitList list, Cursor& cursor) {
...
PredicateSlimeBuilder& PredicateSlimeBuilder::and_node(std::initializer_list<SlimeUP> list) {
    intermediateNode(Predicate::TYPE_CONJUNCTION, list, *_cursor);
    return *this;
}

PredicateSlimeBuilder& PredicateSlimeBuilder::or_node(std::initializer_list<SlimeUP> list) {
    intermediateNode(Predicate::TYPE_DISJUNCTION, list, *_cursor);
    return *this;
}

PredicateSlimeBuilder& PredicateSlimeBuilder::and_node(SlimeUP s1, SlimeUP s2) {
