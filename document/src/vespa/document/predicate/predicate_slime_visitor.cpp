...
void PredicateSlimeVisitor::visit(const Inspector& inspector) {
    ...
    case Predicate::TYPE_CONJUNCTION:
        visitConjunction(inspector);
        break;
    case Predicate::TYPE_DISJUNCTION:
        visitDisjunction(inspector);
        break;
    case Predicate::TYPE_NEGATION:
        visitNegation(inspector);
        break;
    case Predicate::TYPE_FEATURE_SET:
        visitFeatureSet(inspector);
        break;
    case Predicate::TYPE_FEATURE_RANGE:
        visitFeatureRange(inspector);
        break;
    case Predicate::TYPE_TRUE:
        visitTrue(inspector);
        break;
    case Predicate::TYPE_FALSE:
        visitFalse(inspector);
        break;
    default:
        break;
    }
