...
public:
    enum Type { STRUCT_FIELD, ARRAY_INDEX, MAP_KEY, MAP_ALL_KEYS, MAP_ALL_VALUES, VARIABLE, NONE };
    FieldPathEntry();
    ...
    */
    FieldPathEntry(const DataType& dataType, const DataType& keyType, const DataType& valueType, bool keysOnly,
                   bool valuesOnly);
