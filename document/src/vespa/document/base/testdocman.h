...
public:
    ...
    std::unique_ptr<Document> createRandomDocument(int seed = 0, int maxContentSize = 0x80) const;
    /** Create random document from given seed belonging to given location */
    std::unique_ptr<Document> createRandomDocumentAtLocation(int location, int seed = 0,
                                                             int maxContentSize = 0x80) const;
    std::unique_ptr<Document> createRandomDocumentAtLocation(int location, int seed, int minContentSize,
