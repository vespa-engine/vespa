...
InvalidDataTypeException::InvalidDataTypeException(const DataType& actual, const DataType& expected,
...
InvalidDataTypeConversionException::InvalidDataTypeConversionException(const DataType&    actual,
...
DocumentTypeNotFoundException::operator=(const DocumentTypeNotFoundException&) = default;
