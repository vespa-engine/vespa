...
void RemoveFieldPathUpdate::deserialize(const DocumentTypeRepo& repo, const DataType& type, nbostream& stream) {
...
public:
    ...
    ModificationStatus doModify(FieldValue&) override { return ModificationStatus::REMOVED; }
};

} // namespace

std::unique_ptr<IteratorHandler> RemoveFieldPathUpdate::getIteratorHandler(Document&, const DocumentTypeRepo&) const {
