...
public:
    enum SerializationFlag { ARITHMETIC_EXPRESSION = 1u, REMOVE_IF_ZERO = 2u, CREATE_MISSING_PATH = 4u };
    ...
    AssignFieldPathUpdate(const DataType& type, string_view fieldPath, string_view whereClause,
