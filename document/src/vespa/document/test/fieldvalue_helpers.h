...
public:
    ...
    bool add(std::string_view val) { return _cfv.add(*_cfv.createNested() = val); }
    ...
    bool contains(std::string_view val) { return _cfv.contains(*_cfv.createNested() = val); }
    ...
    bool remove(std::string_view val) { return _cfv.remove(*_cfv.createNested() = val); }
...
public:
    ...
    bool add(std::string_view val, int32_t weight = 1) { return _ws.add(*_ws.createNested() = val, weight); }
    bool add(int32_t val, int32_t weight = 1) {
        return _ws.add(_ws.createNested()->assign(IntFieldValue(val)), weight);
    }
    bool add(int64_t val, int32_t weight = 1) {
        return _ws.add(_ws.createNested()->assign(LongFieldValue(val)), weight);
    }
    bool add(float val, int32_t weight = 1) {
        return _ws.add(_ws.createNested()->assign(FloatFieldValue(val)), weight);
    }
    bool add(double val, int32_t weight = 1) {
        return _ws.add(_ws.createNested()->assign(DoubleFieldValue(val)), weight);
    }

    int32_t get(std::string_view val) const { return _ws.get(*_ws.createNested() = val); }
    ...
    void increment(std::string_view val, int32_t weight = 1) { _ws.increment(*_ws.createNested() = val, weight); }
    void increment(int32_t val, int32_t weight = 1) {
        _ws.increment(_ws.createNested()->assign(IntFieldValue(val)), weight);
    }
    void increment(int64_t val, int32_t weight = 1) {
        _ws.increment(_ws.createNested()->assign(LongFieldValue(val)), weight);
    }
    void increment(float val, int32_t weight = 1) {
        _ws.increment(_ws.createNested()->assign(FloatFieldValue(val)), weight);
    }
    void increment(double val, int32_t weight = 1) {
        _ws.increment(_ws.createNested()->assign(DoubleFieldValue(val)), weight);
    }

    void decrement(std::string_view val, int32_t weight = 1) { _ws.decrement(*_ws.createNested() = val, weight); }
    void decrement(int32_t val, int32_t weight = 1) {
        _ws.decrement(_ws.createNested()->assign(IntFieldValue(val)), weight);
    }
    void decrement(int64_t val, int32_t weight = 1) {
        _ws.decrement(_ws.createNested()->assign(LongFieldValue(val)), weight);
    }
    void decrement(float val, int32_t weight = 1) {
        _ws.decrement(_ws.createNested()->assign(FloatFieldValue(val)), weight);
    }
    void decrement(double val, int32_t weight = 1) {
        _ws.decrement(_ws.createNested()->assign(DoubleFieldValue(val)), weight);
    }
