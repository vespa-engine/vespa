...
ResultList Value::regexTrace(const Value& value, std::ostream& trace) const {
...
void StringValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
    out << "\"" << _value << "\"";
}
...
void IntegerValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
    out << _value << 'i';
}
...
void FloatValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
    out << _value << 'f';
}
...
ResultList ArrayValue::regexTrace(const Value& value, std::ostream& trace) const {
    trace << "Regex compare of lhs ArrayValue, rhs " << value << "\n";
    // TODO: have trace be propagated down to comparison ops?
    return doCompare(value, RegexComparator());
}

void ArrayValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
...
ResultList StructValue::operator<(const Value& value) const {
...
void StructValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
...
fieldvalue::VariableMap cloneMap(const fieldvalue::VariableMap& map) {
...
template <typename Predicate> ResultList ArrayValue::doCompare(const Value& value, const Predicate& cmp) const {
    if (value.getType() == Type::Array) {
        ...
        if (_values.size() != val->_values.size()) {
            return ResultList(cmp(_values.size(), val->_values.size()) ? Result::True : Result::False);
        }
...
ResultList TensorValue::operator==(const Value& rhs) const {
...
void TensorValue::print(std::ostream& out, bool verbose, const std::string& indent) const {
    (void)verbose;
    (void)indent;
