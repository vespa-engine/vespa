...
namespace {
template <typename T>
ResultList traceAndValue(const T& value, std::ostream& out, const Node& leftNode, const Node& rightNode) {
    out << "And (lhs):\n";
...
ResultList And::trace(const Context& context, std::ostream& out) const {
...
namespace {
template <typename T>
ResultList traceOrValue(const T& value, std::ostream& out, const Node& leftNode, const Node& rightNode) {
    out << "Or (lhs):\n";
    (void)leftNode.trace(value, out);
    out << "Or (rhs):\n";
    (void)rightNode.trace(value, out);
...
ResultList Or::trace(const Context& context, std::ostream& out) const {
...
namespace {
template <typename T> ResultList traceNotValue(const T& value, std::ostream& out, const Node& node) {
    out << "Not:\n";
    (void)node.trace(value, out);
    out << "Not - Child returned " << node.contains(value) << ". Returning opposite.\n";
    return !node.contains(value);
}
} // namespace

ResultList Not::trace(const Context& context, std::ostream& out) const {
