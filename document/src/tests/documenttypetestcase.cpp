...
{
    DocumentTypeRepo
        repo(readDocumenttypesConfig((DocumentTestUtils::srcDir() + "data/inheritancetest.cfg").c_str()));
...
{
    DocumentTypeRepo
        repo(readDocumenttypesConfig((DocumentTestUtils::srcDir() + "data/doctypesconfigtest.cfg").c_str()));
