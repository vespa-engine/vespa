...
/**
 * Tests for SimpleAnnotations - lightweight annotation representation.
 *
 * @author havardpe
 */
public class SimpleAnnotationsTestCase {

    @Test
    public void testBasicFunctionality() {
        SimpleAnnotations simple = new SimpleAnnotations();
    ...
    public void testSerializationCompatibility() {
        // This test verifies that SimpleAnnotations serializes to the same format as SpanTree
    ...
    public void testAPICompatibility() {
        // Test that SimpleAnnotations work with public API via lazy conversion
