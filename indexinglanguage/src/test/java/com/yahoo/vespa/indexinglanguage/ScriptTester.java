...
public class ScriptTester {
    ...
    public ScriptExpression scriptFrom(String string) {
        return scriptFrom(string, new SimpleLinguistics());
    }

    public ScriptExpression scriptFrom(String string, Linguistics linguistics) {
        try {
            return ScriptExpression.fromString(string, linguistics, chunkers, Map.of(), Map.of());
        }
        catch (ParseException e) {
            throw new IllegalArgumentException(e);
        }
