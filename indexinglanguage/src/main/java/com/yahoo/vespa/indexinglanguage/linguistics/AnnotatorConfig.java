...
public class AnnotatorConfig implements Cloneable {
    ...
    public AnnotatorConfig setField(String field) {
        this.field = field;
        return this;
    }
    ...
    public LinguisticsParameters asLinguisticsParameters() {
        return new LinguisticsParameters(field, false, language, stemMode, removeAccents, lowercase);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getClass(), field, language.hashCode(), stemMode.hashCode(),
