...
Cloud. See https://docs.vespa.ai/en/operations/deleting-applications.html for how to remove
...
$ vespa destroy --force`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if env != "dev" && env != "perf" {
				return errHint(fmt.Errorf("cannot remove production %s", description), "See https://docs.vespa.ai/en/operations/deleting-applications.html")
			}
			ok := force
			if !ok {
