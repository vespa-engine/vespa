...
MatchCandidateTest::MatchCandidateTest() : Test("MatchCandidate"), test_methods_() {
    init();
}
...
void MatchCandidateTest::testMatches_limit() {
    ...
    juniper::Summary* sum = juniper::GetTeaser(*res);
    _test(strcmp(sum->Text(), "This is a simple text where a <b>phrase</b> <b>match</b> can be found not"
...
void MatchCandidateTest::testAccept() {
    ...
    juniper::Summary* sum = juniper::GetTeaser(*res);
    _test(strcmp(sum->Text(), "This is a <b>simple</b> <b>test</b> where we should get a perfect match") == 0);
}
...
void MatchCandidateTest::testAdd_to_keylist() {
    ...
    juniper::Summary* sum = juniper::GetTeaser(*res);
    std::string       s(sum->Text());
    _test_equal(s, "connect truende. <b>phr1</b> <b>phr2</b> www www www <b>phr3</b>"
...
void MatchCandidateTest::testLength() {
...

    {
        ...
        std::string s(sum->Text());
        _test_equal(s, "this <b>simple</b> text <b>with</b> <b>adjacent</b> words of "
...
void MatchCandidateTest::requireThatMaxNumberOfMatchCandidatesCanBeControlled() {
    ...
    for (size_t i = 0; i < proc._cands.size(); ++i) { _test(proc._cands[i] <= 4u); }
...
void MatchCandidateTest::init() {
    test_methods_["testSetDocid"] = &MatchCandidateTest::testSetDocid;
    test_methods_["testLog"] = &MatchCandidateTest::testLog;
    test_methods_["testDump"] = &MatchCandidateTest::testDump;
    test_methods_["testorder"] = &MatchCandidateTest::testorder;
    test_methods_["testMatches_limit"] = &MatchCandidateTest::testMatches_limit;
    test_methods_["testAccept"] = &MatchCandidateTest::testAccept;
    test_methods_["testRank"] = &MatchCandidateTest::testRank;
    test_methods_["testMake_keylist"] = &MatchCandidateTest::testMake_keylist;
    test_methods_["testAdd_to_keylist"] = &MatchCandidateTest::testAdd_to_keylist;
    test_methods_["testLength"] = &MatchCandidateTest::testLength;
    ...
    test_methods_["testOrder"] = &MatchCandidateTest::testOrder;
    test_methods_["testSize"] = &MatchCandidateTest::testSize;
    test_methods_["testEndpos"] = &MatchCandidateTest::testEndpos;
    test_methods_["testCtxt_startpos"] = &MatchCandidateTest::testCtxt_startpos;
    test_methods_["testStarttoken"] = &MatchCandidateTest::testStarttoken;
    test_methods_["testWord_distance"] = &MatchCandidateTest::testWord_distance;
    test_methods_["testDistance"] = &MatchCandidateTest::testDistance;
    test_methods_["testElem_store_sz"] = &MatchCandidateTest::testElem_store_sz;
    test_methods_["testElems"] = &MatchCandidateTest::testElems;
    test_methods_["testDistance1"] = &MatchCandidateTest::testDistance1;
    test_methods_["testSet_valid"] = &MatchCandidateTest::testSet_valid;
}
