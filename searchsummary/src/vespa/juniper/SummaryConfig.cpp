...
SummaryConfig* CreateSummaryConfig(const char* highlight_on, const char* highlight_off, const char* dots,
                                   const char* separators, const unsigned char* connectors,
                                   const ConfigFlag escape_markup, const ConfigFlag preserve_white_space) {
    return new SummaryConfig(highlight_on, highlight_off, dots, separators, connectors, escape_markup,
