...
struct QueryTermLengthComparator {
    bool operator()(const QueryTerm* m1, const QueryTerm* m2) { return m1->len() <= m2->len(); }
};

typedef Fast_HashTable<ucs4_t, QueryTerm*, 0x20, QueryTermLengthComparator> queryterm_hashtable;
