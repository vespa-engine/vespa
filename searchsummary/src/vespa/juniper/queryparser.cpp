...
std::string_view QueryParserQueryItem::get_index() const {
    return _index;
}

int QueryParserQueryItem::get_weight() const {
    return 100;
}

ItemCreator QueryParserQueryItem::get_creator() const {
...
std::unique_ptr<QueryItem> QueryParser::ParseIndexTerm() {
...
std::unique_ptr<QueryParserQueryItem> QueryParser::ParseKeyword() {
