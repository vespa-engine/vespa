...
public:
    ...
    void insert_summary_field(const std::string& field_name, ElementIds selected_documents, vespalib::slime::Inserter& inserter) const {
        insert_summary_field(field_name, selected_documents, inserter, nullptr);
    }
    virtual void insert_summary_field(const std::string& field_name, ElementIds selected_elements, vespalib::slime::Inserter& inserter, IStringFieldConverter* converter) const = 0;
    virtual void insert_juniper_field(const std::string& field_name, ElementIds selected_elements, vespalib::slime::Inserter& inserter, IJuniperConverter& converter) const = 0;
