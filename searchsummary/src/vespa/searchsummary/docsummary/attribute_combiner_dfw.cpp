...
AttributeCombinerDFW::AttributeCombinerDFW() : DocsumFieldWriter(), _stateIndex(0) {
}

AttributeCombinerDFW::~AttributeCombinerDFW() = default;

bool AttributeCombinerDFW::setFieldWriterStateIndex(uint32_t fieldWriterStateIndex) {
...
void AttributeCombinerDFW::insert_field(uint32_t docid, const IDocsumStoreDocument*, GetDocsumsState& state,
