...
PriorityConverter::PriorityConverter() : _mapping(), _reverse_mapping() {
    init_static_priority_mappings();
}

PriorityConverter::~PriorityConverter() = default;

void PriorityConverter::init_static_priority_mappings() {
...
uint8_t PriorityConverter::toStoragePriority(documentapi::Priority::Value documentApiPriority) const noexcept {
