...
void DistributorComponentRegisterImpl::handleNewState() noexcept {
...
void DistributorComponentRegisterImpl::registerDistributorComponent(DistributorManagedComponent& smc) {
...
void DistributorComponentRegisterImpl::setTimeCalculator(UniqueTimeCalculator& utc) {
    std::lock_guard lock(_componentLock);
    if (_timeCalculator != nullptr) {
...
void DistributorComponentRegisterImpl::setDistributorConfig(const DistributorManagerConfig& cfg) {
    std::lock_guard lock(_componentLock);
...
void DistributorComponentRegisterImpl::setVisitorConfig(const VisitorDispatcherConfig& cfg) {
    std::lock_guard lock(_componentLock);
...
void DistributorComponentRegisterImpl::setNodeStateUpdater(NodeStateUpdater& updater) {
