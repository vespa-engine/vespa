...
public:
    ApplyBucketDiffEntryComplete(std::shared_ptr<ApplyBucketDiffState> state, document::DocumentId doc_id,
                                 ThrottleToken op_throttle_token, ThrottleToken maintenance_throttle_token,
