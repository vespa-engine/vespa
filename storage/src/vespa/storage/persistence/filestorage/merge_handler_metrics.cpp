...
MergeHandlerMetrics::MergeHandlerMetrics(metrics::MetricSet* owner)
    : bytesMerged("bytesmerged", {}, "Total number of bytes merged into this node.", owner),
      ...
      mergeAverageDataReceivedNeeded("mergeavgdatareceivedneeded", {},
                                     ...
                                     "in chain that we needed to apply locally.",
                                     owner),
      merge_put_latency("merge_put_latency", {}, "Latency of individual puts that are part of merge operations",
                        owner),
      merge_remove_latency("merge_remove_latency", {},
                           "Latency of individual removes that are part of merge operations", owner) {
}
