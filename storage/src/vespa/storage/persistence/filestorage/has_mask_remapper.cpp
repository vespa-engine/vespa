...
uint16_t HasMaskRemapper::operator()(uint16_t mask) const {
...
uint16_t HasMaskRemapper::operator()(uint16_t mask, uint16_t keep_from_full_mask) const {
