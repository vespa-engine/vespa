 ...
 */
class ServiceLayerHostInfoReporter : public HostReporter, public spi::ResourceUsageListener {
...
public:
    ServiceLayerHostInfoReporter(NodeStateUpdater& node_state_updater, double noise_level = 0.001);
