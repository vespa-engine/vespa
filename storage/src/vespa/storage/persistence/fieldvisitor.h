...
public:
    explicit FieldVisitor(const document::DocumentType& docType) : _docType(docType), _fields() {}
    ...
    template <typename BinaryNode> void visitBothBranches(const BinaryNode& node) {
