...
public:
    ...
    public:
        ...
        constexpr bool valid() const noexcept { return _index < MAX_INDEX; }
    ...
    public:
        NonRetiredOrMaintenance2Index(const IdealServiceLayerNodesBundle& idealState) noexcept
    ...
    void set_nodes(ConstNodesRef nodes, ConstNodesRef nonretired_nodes,
    ...
    ConstNodesRef available_nonretired_nodes() const noexcept {
        return {_nodes.data() + _available_sz, _nonretired_sz};
    }
