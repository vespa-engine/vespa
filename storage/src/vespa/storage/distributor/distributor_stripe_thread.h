...
public:
    DistributorStripeThread(TickableStripe& stripe, DistributorStripePool& stripe_pool);
...
private:
    ...
    [[nodiscard]] bool should_park_relaxed() const noexcept { return _should_park.load(std::memory_order_relaxed); }
