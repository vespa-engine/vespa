...
public:
    ...
    [[nodiscard]] virtual document::BucketId make_split_bit_constrained_bucket_id(const document::DocumentId& docId) const = 0;
    ...
    [[nodiscard]] virtual bool has_pending_message(uint16_t node_index,
                                                   const document::Bucket& bucket,
                                                   uint32_t message_type) const = 0;
    [[nodiscard]] virtual const lib::ClusterState* pending_cluster_state_or_null(const document::BucketSpace& bucket_space) const = 0;
