...
public:
    struct GlobalMaintenanceStats {
        ...
        GlobalMaintenanceStats() noexcept : pending() {}
...
public:
    ...
    const PendingMaintenanceStats& getPendingMaintenanceStats() const noexcept { return _pendingMaintenance; }
};

std::ostream& operator<<(std::ostream&, const SimpleMaintenanceScanner::GlobalMaintenanceStats&);
