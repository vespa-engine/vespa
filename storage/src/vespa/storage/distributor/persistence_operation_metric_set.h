...
public:
    ...
    public:
        explicit LockWrapper(PersistenceOperationMetricSet& self) : _lock(self._mutex), _self(self) {}

        PersistenceOperationMetricSet* operator->() noexcept { return &_self; }
    };
    LockWrapper locked() noexcept { return LockWrapper(*this); }
};
