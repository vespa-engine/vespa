...
uint64_t DistributorMessageSender::sendToNode(const lib::NodeType& nodeType, uint16_t node,
    ...
    cmd->setAddress(useDocumentAPI ? api::StorageMessageAddress::createDocApi(cluster_np, nodeType, node)
