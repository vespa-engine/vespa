...
VisitorMetrics::VisitorMetrics()
    : metrics::MetricSet("visitor", {{"visitor"}}, ""),
      ...
      queueSkips("cv_skipqueue", {},
                 ...
                 "spots",
                 this),
      queueFull("cv_queuefull", {}, "Number of create visitor messages failed as queue is full", this),
      queueWaitTime("cv_queuewaittime", {},
                    "Milliseconds waiting in create visitor queue, for visitors "
                    "that was added to visitor queue but scheduled later",
                    this),
      queueTimeoutWaitTime("cv_queuetimeoutwaittime", {},
                           "Milliseconds waiting in create visitor queue, for visitors "
                           "that timed out while in the visitor queue",
                           this),
...
void VisitorMetrics::initThreads(uint16_t threadCount) {
    if (!threads.empty()) {
