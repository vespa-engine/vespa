...
VisitorThreadMetrics::VisitorThreadMetrics(const std::string& name, const std::string& desc)
    : metrics::MetricSet(name, {{"visitor"}, {"partofsum"}, {"thread"}}, desc),
      ...
      averageVisitorCreationTime("averagevisitorcreationtime", {}, "Average time spent creating a visitor instance",
                                 this),
      averageMessageSendTime("averagemessagesendtime", {},
                             "Average time it takes for messages to be sent to their target (and be replied to)",
                             this),
      ...
      visitorDestinationFailureReplies("destination_failure_replies", {},
                                       "Number of failure replies received from the visitor destination", this) {
