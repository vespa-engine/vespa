...
ContentBucketSpaceRepo::ContentBucketSpaceRepo(const ContentBucketDbOptions& db_opts) : _map() {
...
ContentBucketSpaceRepo::BucketSpaces ContentBucketSpaceRepo::getBucketSpaces() const {
    BucketSpaces result;
...
size_t ContentBucketSpaceRepo::getBucketMemoryUsage() const {
    size_t result = 0;
    for (const auto& elem : _map) {
