...
public:
    using BucketSpaceMap =
        std::unordered_map<document::BucketSpace, ContentBucketSpace::UP, document::BucketSpace::hash>;
...
public:
    ...
    template <typename Functor> void for_each_bucket(Functor functor) const {
