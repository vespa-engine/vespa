...
CreateBucketCommand::CreateBucketCommand(const document::Bucket& bucket)
    : MaintenanceCommand(MessageType::CREATEBUCKET, bucket), _active(false) {
}

void CreateBucketCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
CreateBucketReply::CreateBucketReply(const CreateBucketCommand& cmd) : BucketInfoReply(cmd) {
}

void CreateBucketReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
void DeleteBucketCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
DeleteBucketReply::DeleteBucketReply(const DeleteBucketCommand& cmd) : BucketInfoReply(cmd) {
}

void DeleteBucketReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
MergeBucketCommand::MergeBucketCommand(const document::Bucket& bucket, const std::vector<Node>& nodes,
...
void MergeBucketCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
void MergeBucketReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
GetBucketDiffCommand::Entry::Entry() : _timestamp(0), _gid(), _headerSize(0), _bodySize(0), _flags(0), _hasMask(0) {
}

void GetBucketDiffCommand::Entry::print(std::ostream& out, bool verbose, const std::string& indent) const {
    out << "Entry(timestamp: " << _timestamp << ", " << _gid.toString() << ", hasMask: 0x" << _hasMask;
    if (verbose) {
        out << ",\n"
            << indent << "      " << "header size: " << std::dec << _headerSize << ", body size: " << _bodySize
...
bool GetBucketDiffCommand::Entry::operator==(const Entry& e) const {
    return (_timestamp == e._timestamp && _headerSize == e._headerSize && _bodySize == e._bodySize &&
            _gid == e._gid && _flags == e._flags);
}

GetBucketDiffCommand::GetBucketDiffCommand(const document::Bucket& bucket, const std::vector<Node>& nodes,
                                           Timestamp maxTimestamp)
    : BucketCommand(MessageType::GETBUCKETDIFF, bucket), _nodes(nodes), _maxTimestamp(maxTimestamp) {
}
...
GetBucketDiffReply::GetBucketDiffReply(const GetBucketDiffCommand& cmd)
    : BucketReply(cmd), _nodes(cmd.getNodes()), _maxTimestamp(cmd.getMaxTimestamp()), _diff(cmd.getDiff()) {
}
...
ApplyBucketDiffCommand::Entry::Entry() : _entry(), _docName(), _headerBlob(), _bodyBlob(), _repo() {
}

ApplyBucketDiffCommand::Entry::Entry(const GetBucketDiffCommand::Entry& e)
    : _entry(e), _docName(), _headerBlob(), _bodyBlob(), _repo() {
}
...
bool ApplyBucketDiffCommand::Entry::filled() const {
    return ((_headerBlob.size() > 0 || (_entry._headerSize == 0 && !_docName.empty())) &&
            (_bodyBlob.size() > 0 || _entry._bodySize == 0));
}

void ApplyBucketDiffCommand::Entry::print(std::ostream& out, bool verbose, const std::string& indent) const {
    out << "ApplyEntry(";
    _entry.print(out, verbose, indent + "           ");
    out << ",\n"
        << indent << "  name(" << _docName << "), headerBlob(" << _headerBlob.size() << "), bodyBlob("
        << _bodyBlob.size() << ")";
    if (_headerBlob.size() > 0) {
        vespalib::nbostream buf(&_headerBlob[0], _headerBlob.size());
        if (_repo) {
...
bool ApplyBucketDiffCommand::Entry::operator==(const Entry& e) const {
    return (_entry == e._entry && _headerBlob == e._headerBlob && _bodyBlob == e._bodyBlob);
}

ApplyBucketDiffCommand::ApplyBucketDiffCommand(const document::Bucket& bucket, const std::vector<Node>& nodes)
    : BucketInfoCommand(MessageType::APPLYBUCKETDIFF, bucket), _nodes(nodes), _diff() {
}

ApplyBucketDiffCommand::~ApplyBucketDiffCommand() = default;

void ApplyBucketDiffCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
ApplyBucketDiffReply::ApplyBucketDiffReply(const ApplyBucketDiffCommand& cmd)
    : BucketInfoReply(cmd), _nodes(cmd.getNodes()), _diff(cmd.getDiff()) {
}

ApplyBucketDiffReply::~ApplyBucketDiffReply() = default;

void ApplyBucketDiffReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
    uint32_t totalSize = 0;
    uint32_t filled = 0;
...
RequestBucketInfoCommand::RequestBucketInfoCommand(document::BucketSpace                  bucketSpace,
...
RequestBucketInfoCommand::RequestBucketInfoCommand(document::BucketSpace bucketSpace, uint16_t distributor,
                                                   const lib::ClusterState& state, std::string_view distributionHash)
    : StorageCommand(MessageType::REQUESTBUCKETINFO),
      _bucketSpace(bucketSpace),
      _buckets(),
...
document::Bucket RequestBucketInfoCommand::getBucket() const {
    return document::Bucket(_bucketSpace, document::BucketId());
}

document::BucketId RequestBucketInfoCommand::super_bucket_id() const {
    return _buckets.empty() ? document::BucketId() : _buckets[0];
}

void RequestBucketInfoCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
    ...
    if (verbose && !_buckets.empty()) {
        ...
        std::copy(_buckets.begin(), _buckets.end(),
                  std::ostream_iterator<document::BucketId>(out, ("\n" + indent + "    ").c_str()));
    }
    out << ")";
    if (verbose) {
        out << " : ";
...
void RequestBucketInfoReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
NotifyBucketChangeCommand::NotifyBucketChangeCommand(const document::Bucket& bucket, const BucketInfo& info)
    : BucketCommand(MessageType::NOTIFYBUCKETCHANGE, bucket), _info(info) {
}

void NotifyBucketChangeCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
NotifyBucketChangeReply::NotifyBucketChangeReply(const NotifyBucketChangeCommand& cmd) : BucketReply(cmd) {
}

void NotifyBucketChangeReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
SetBucketStateCommand::SetBucketStateCommand(const document::Bucket& bucket, BUCKET_STATE state)
    : MaintenanceCommand(MessageType::SETBUCKETSTATE, bucket), _state(state) {
}

void SetBucketStateCommand::print(std::ostream& out, bool verbose, const std::string& indent) const {
...
std::string SetBucketStateCommand::getSummary() const {
...
SetBucketStateReply::SetBucketStateReply(const SetBucketStateCommand& cmd) : BucketInfoReply(cmd) {
}

void SetBucketStateReply::print(std::ostream& out, bool verbose, const std::string& indent) const {
