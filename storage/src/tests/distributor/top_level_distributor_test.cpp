...
struct TopLevelDistributorTest : Test, TopLevelDistributorTestUtil {
    ...
    BucketSpacesStatsProvider::GlobalStats distributor_global_stats() {
        return _distributor->global_stats();
    }
...
TEST_F(TopLevelDistributorTest, entering_recovery_mode_resets_bucket_space_and_min_replica_stats_across_all_stripes) {
    ...
    add_nodes_to_stripe_bucket_db(document::BucketId(16, 1), "0=1/1/10/t/a");
    add_nodes_to_stripe_bucket_db(document::BucketId(16, 2), "0=1/1/10/t/a");
    add_nodes_to_stripe_bucket_db(document::BucketId(16, 3), "0=2/2/20/t/a");
