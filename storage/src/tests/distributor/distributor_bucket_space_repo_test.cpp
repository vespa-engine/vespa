...
TEST_F(DistributorBucketSpaceRepoTest,
       enabled_bundle_with_pending_global_merges_tags_default_space_as_merge_inhibited) {
...
TEST_F(DistributorBucketSpaceRepoTest,
       pending_bundle_with_pending_global_merges_tags_default_space_as_merge_inhibited) {
    _repo.enable_cluster_state_bundle(bundle_without_global_merges());
