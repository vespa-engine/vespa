...
std::shared_ptr<api::CreateVisitorCommand> getCommand(std::string_view name, vespalib::duration timeout,
                                                      uint8_t priority = 0) {
...
const std::string& getCommandString(const std::shared_ptr<api::CreateVisitorCommand>& cmd) {
