...
StorageLinkTest::StorageLinkTest() : _feeder(), _middle(nullptr), _replier(nullptr) {
}
...
TEST_F(StorageLinkTest, printing) {
    ...
    actual << *_feeder;
    std::string expected = "StorageChain(3)\n"
...
TEST_F(StorageLinkTest, not_implemented) {
    ...
    EXPECT_EQ(dynamic_cast<api::StatBucketReply&>(*_feeder->getReply(0)).getResult(),
