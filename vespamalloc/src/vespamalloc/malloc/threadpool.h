...
template <typename MemBlockPtrT, typename ThreadStatT> class ThreadPoolT {
public:
...
private:
    ...
    static constexpr SizeClassT ALWAYS_REUSE_SC_LIMIT =
        std::max(MemBlockPtrT::sizeClass(ALWAYS_REUSE_LIMIT), SizeClassT(MemBlockPtrT::SizeClassSpan));
