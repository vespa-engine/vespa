...
public:
    ...
    template <typename Object> void traverseDepth(Object func) {
        if (_root) {
            _root->traverseDepth(0, 0, func);
        }
    }
    template <typename Object> void traverseWidth(Object func) {
        if (_root) {
            _root->traverseWidth(0, 0, func);
        }
    }
