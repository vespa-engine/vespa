...
/**
 * Created by dybdahl on 6/28/16.
 */
public class NodeMechanisms {
    ...
    private static final Logger logger = Logger.getLogger(NodeMechanisms.class.getName());
    private final Docker docker;

    public NodeMechanisms(Docker docker) {
        this.docker = docker;
    }
