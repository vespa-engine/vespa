...
TEST_F(MetricManagerTest, test_text_output) {
    ...
    mm.init(ConfigUri("raw:"
                      ...
                      "consumer[1].tags[1]\n"
                      "consumer[1].tags[0] snaptest\n"));
    std::string        expected("snapshot \"Active metrics showing updates since last snapshot\" from 1970-01-01 "
                                       "00:16:40.000 UTC to 1970-01-01 00:00:00.000 UTC period 0\n"
