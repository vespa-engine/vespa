...
public enum SearchNodeMetrics implements VespaMetrics {
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_APPROXIMATE_NNS_NODES_VISITED("content.proton.documentdb.matching.approximate_nns_nodes_visited", Unit.DOCUMENT, "Number of nodes visited in approximate nearest-neighbor search"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_APPROXIMATE_NNS_NODES_VISITED("content.proton.documentdb.matching.rank_profile.approximate_nns_nodes_visited", Unit.DOCUMENT, "Number of nodes visited in approximate nearest-neighbor search"),
