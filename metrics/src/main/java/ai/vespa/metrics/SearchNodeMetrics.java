...
public enum SearchNodeMetrics implements VespaMetrics {
    ...
    CONTENT_PROTON_RESOURCE_USAGE_DISK_USAGE_RESERVED("content.proton.resource_usage.disk_usage.reserved", Unit.FRACTION,
        "The relative amount of reserved disk space for this content node (value in the range [0, 1])"),
    CONTENT_PROTON_RESOURCE_USAGE_DISK_USAGE_USED_AND_RESERVED("content.proton.resource_usage.disk_usage.used_and_reserved", Unit.FRACTION,
        "The relative amount of disk used and reserved disk space by this content node (transient usage not included, value in the range [0, 1])"),
    ...
    CONTENT_PROTON_RESOURCE_USAGE_MEMORY_USAGE_RESERVED("content.proton.resource_usage.memory_usage.reserved", Unit.FRACTION,
        "The relative amount of reserved memory for this content node (value in the range [0, 1])"),
    CONTENT_PROTON_RESOURCE_USAGE_MEMORY_USAGE_USED_AND_RESERVED("content.proton.resource_usage.memory_usage.used_and_reserved", Unit.FRACTION,
        "The relative amount of used and reserved memory for this content node (transient usage not included, value in the range [0, 1])"),
    ...
    CONTENT_PROTON_DOCUMENTDB_READY_ATTRIBUTE_DISK_USAGE("content.proton.documentdb.ready.attribute.disk_usage", Unit.BYTE, "Disk space usage (in bytes) of the flushed snapshot of this attribute for this document type"),
    ...
    // index
    CONTENT_PROTON_INDEX_CACHE_POSTINGLIST_ELEMENTS("content.proton.index.cache.postinglist.elements", Unit.ITEM, "Number of elements in the cache. Contains disk index posting list files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_POSTINGLIST_MEMORY_USAGE("content.proton.index.cache.postinglist.memory_usage", Unit.BYTE, "Memory usage of the cache (in bytes). Contains disk index posting list files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_POSTINGLIST_HIT_RATE("content.proton.index.cache.postinglist.hit_rate", Unit.FRACTION, "Rate of hits in the cache compared to number of lookups. Contains disk index posting list files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_POSTINGLIST_LOOKUPS("content.proton.index.cache.postinglist.lookups", Unit.OPERATION, "Number of lookups in the cache (hits + misses). Contains disk index posting list files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_POSTINGLIST_INVALIDATIONS("content.proton.index.cache.postinglist.invalidations", Unit.OPERATION, "Number of invalidations (erased elements) in the cache. Contains disk index posting list files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_BITVECTOR_ELEMENTS("content.proton.index.cache.bitvector.elements", Unit.ITEM, "Number of elements in the cache. Contains disk index bitvector files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_BITVECTOR_MEMORY_USAGE("content.proton.index.cache.bitvector.memory_usage", Unit.BYTE, "Memory usage of the cache (in bytes). Contains disk index bitvector files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_BITVECTOR_HIT_RATE("content.proton.index.cache.bitvector.hit_rate", Unit.FRACTION, "Rate of hits in the cache compared to number of lookups. Contains disk index bitvector files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_BITVECTOR_LOOKUPS("content.proton.index.cache.bitvector.lookups", Unit.OPERATION, "Number of lookups in the cache (hits + misses). Contains disk index bitvector files across all document types"),
    CONTENT_PROTON_INDEX_CACHE_BITVECTOR_INVALIDATIONS("content.proton.index.cache.bitvector.invalidations", Unit.OPERATION, "Number of invalidations (erased elements) in the cache. Contains disk index bitvector files across all document types"),
    CONTENT_PROTON_DOCUMENTDB_INDEX_MEMORY_USAGE_ALLOCATED_BYTES("content.proton.documentdb.index.memory_usage.allocated_bytes", Unit.BYTE, "The number of allocated bytes for the memory index for this document type"),
    CONTENT_PROTON_DOCUMENTDB_INDEX_MEMORY_USAGE_USED_BYTES("content.proton.documentdb.index.memory_usage.used_bytes", Unit.BYTE, "The number of used bytes (<= allocated_bytes) for the memory index for this document type"),
    ...
    CONTENT_PROTON_DOCUMENTDB_READY_INDEX_DISK_USAGE("content.proton.documentdb.ready.index.disk_usage", Unit.BYTE, "Disk space usage (in bytes) of this index field in all disk indexes for this document type"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_APPROXIMATE_NNS_TIMED_OUT_QUERIES("content.proton.documentdb.matching.approximate_nns_timed_out_queries", Unit.QUERY, "Number of queries hitting the approximate nearest-neighbor search timeout"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_QUERY_APPROXIMATE_NNS_TIME("content.proton.documentdb.matching.query_approximate_nns_time", Unit.SECOND, "Average time (sec) spent on approximate nearest-neighbor search in queries that perform such searches"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_EXACT_NNS_DISTANCES_COMPUTED("content.proton.documentdb.matching.exact_nns_distances_computed", Unit.DISTANCE, "Number of distances computed in exact nearest-neighbor search"),
    CONTENT_PROTON_DOCUMENTDB_MATCHING_APPROXIMATE_NNS_DISTANCES_COMPUTED("content.proton.documentdb.matching.approximate_nns_distances_computed", Unit.DISTANCE, "Number of distances computed in approximate nearest-neighbor search"),
    CONTENT_PROTON_DOCUMENTDB_MATCHING_APPROXIMATE_NNS_NODES_VISITED("content.proton.documentdb.matching.approximate_nns_nodes_visited", Unit.GRAPH_NODE, "Number of nodes visited in approximate nearest-neighbor search"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_APPROXIMATE_NNS_TIMED_OUT_QUERIES("content.proton.documentdb.matching.rank_profile.approximate_nns_timed_out_queries", Unit.QUERY, "Number of queries hitting the approximate nearest-neighbor search timeout"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_QUERY_APPROXIMATE_NNS_TIME("content.proton.documentdb.matching.rank_profile.query_approximate_nns_time", Unit.SECOND, "Average time (sec) spent on approximate nearest-neighbor search in queries that perform such searches"),
    ...
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_EXACT_NNS_DISTANCES_COMPUTED("content.proton.documentdb.matching.rank_profile.exact_nns_distances_computed", Unit.DISTANCE, "Number of distances computed in exact nearest-neighbor search"),
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_APPROXIMATE_NNS_DISTANCES_COMPUTED("content.proton.documentdb.matching.rank_profile.approximate_nns_distances_computed", Unit.DISTANCE, "Number of distances computed in approximate nearest-neighbor search"),
    CONTENT_PROTON_DOCUMENTDB_MATCHING_RANK_PROFILE_APPROXIMATE_NNS_NODES_VISITED("content.proton.documentdb.matching.rank_profile.approximate_nns_nodes_visited", Unit.GRAPH_NODE, "Number of nodes visited in approximate nearest-neighbor search"),
