...
public class MetricSetDocumentation {
    ...
    protected static void writeMetricSetDocumentation(String path, String name, MetricSet metricSet, Map<String, VespaMetrics[]> metricsByType) {
        ...
        referenceBuilder.append(String.format(Locale.ROOT, """
                ...
                title: "%s Metric Set"
                redirect_from:
                - en/reference/%s-set-metrics-reference.html
                ---
                <p>
                ...
                </p>""", name, metricSet.getId().toLowerCase(Locale.ROOT), name));
        metricsByType.keySet()
                ...
                .forEach(type ->
                        referenceBuilder.append(String.format(Locale.ROOT, """
                            ...
                            """, type.toLowerCase(Locale.ROOT), type, htmlRows(metricTypeByName.get(type))))
                );
        try (FileWriter fileWriter = new FileWriter(path + "/" + metricSet.getId().toLowerCase(Locale.ROOT) + "-metric-set.html", StandardCharsets.UTF_8)) {
        ...
        return metrics.entrySet()
                ...
                .map(entry ->
                        String.format(Locale.ROOT,
                                ...
                                entry.getKey().unit().toString().toLowerCase(Locale.ROOT),
