...
public enum ContainerMetrics implements VespaMetrics {
    ...
    INFERENCE_PENDING("inference.pending", Unit.REQUEST, "Number of pending inference requests"),
    ...
    INFERENCE_QUEUE_COMPUTE_RATIO("inference.queue_compute.ratio", Unit.FRACTION, "Ratio of inference queue time to compute time");
