...
public enum ConfigServerMetrics implements VespaMetrics {
    ...
    CLUSTER_AUTOSCALE_PEAK_LOAD_CPU("clusterAutoscale.peakLoad.cpu", Unit.VCPU, "The CPU load adjustment of a cluster"),
    CLUSTER_AUTOSCALE_IDEAL_LOAD_MEMORY("clusterAutoscale.idealLoad.memory", Unit.GIGABYTE, "The ideal memory load of a cluster"),
    CLUSTER_AUTOSCALE_PEAK_LOAD_MEMORY("clusterAutoscale.peakLoad.memory", Unit.GIGABYTE, "The memory load adjustment of a cluster"),
    CLUSTER_AUTOSCALE_IDEAL_LOAD_DISK("clusterAutoscale.idealLoad.disk", Unit.GIGABYTE, "The ideal disk load of a cluster"),
    CLUSTER_AUTOSCALE_PEAK_LOAD_DISK("clusterAutoscale.peakLoad.disk", Unit.GIGABYTE, "The disk load adjustment of a cluster"),
    CLUSTER_AUTOSCALE_IDEAL_LOAD_GPU("clusterAutoscale.idealLoad.gpu", Unit.VCPU, "The ideal GPU load of a cluster"),
    CLUSTER_AUTOSCALE_PEAK_LOAD_GPU("clusterAutoscale.peakLoad.gpu", Unit.VCPU, "The GPU load adjustment of a cluster"),
