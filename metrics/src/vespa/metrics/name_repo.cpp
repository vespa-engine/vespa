...
const std::string& NameRepo::metricName(MetricNameId id) {
    return metricNames.lookup(id.id());
}

const std::string& NameRepo::description(DescriptionId id) {
    return descriptions.lookup(id.id());
}

const std::string& NameRepo::tagKey(TagKeyId id) {
    return tagKeys.lookup(id.id());
}

const std::string& NameRepo::tagValue(TagValueId id) {
