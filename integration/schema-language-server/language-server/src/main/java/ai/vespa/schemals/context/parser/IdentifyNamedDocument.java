...
public class IdentifyNamedDocument extends Identifier {
	...
	public ArrayList<Diagnostic> identify(SchemaNode node) {
        ...
        if (context.schemaIndex().findSymbolInDocument(context.fileURI(), TokenType.SCHEMA, documentName) == null
         && context.schemaIndex().findSymbolInDocument(context.fileURI(), TokenType.SEARCH, documentName) == null) {
            // TODO: Quickfix
