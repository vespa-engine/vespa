...
public class SessionActiveHandlerTest extends SessionHandlerTest {
    ...
    public void testThatPreviousSessionIsDeactivated() throws Exception {
        RemoteSession firstSession = activateAndAssertOK();
        activateAndAssertOK();
    ...
    public void require_that_session_created_from_active_that_is_no_longer_active_cannot_be_activated() throws Exception {
        ...
        ActivateRequest activateRequest = new ActivateRequest("").invoke();
    ...
    public void testActivationWithActivationInBetween() throws Exception {
        activateAndAssertOK();
        activateAndAssertError(Response.Status.CONFLICT, HttpErrorResponse.errorCodes.ACTIVATION_CONFLICT,
    ...
    public void require_that_handler_gives_error_when_provisioner_activated_fails() throws Exception {
        ...
        activateAndAssertError(BAD_REQUEST, HttpErrorResponse.errorCodes.BAD_REQUEST, "Cannot activate application");
    ...
    private ActivateRequest activateAndAssertOKPut(String subPath) throws Exception {
        ActivateRequest activateRequest = new ActivateRequest(subPath);
    ...
    private void activateAndAssertErrorPut(int statusCode, HttpErrorResponse.errorCodes errorCode, String expectedError) throws Exception {
    ...
    protected class ActivateRequest {
        ...
        ActivateRequest(String subPath) {
            this(Session.Status.PREPARE, subPath);
        }

        ActivateRequest(Session.Status initialStatus, String subPath) {
    ...
    private RemoteSession activateAndAssertOK() throws Exception {
        ActivateRequest activateRequest = activateAndAssertOKPut("");
    ...
    private void activateAndAssertError(int statusCode, HttpErrorResponse.errorCodes errorCode, String expectedError) throws Exception {
        hostProvisioner.activated = false;
        activateAndAssertErrorPut(statusCode, errorCode, expectedError);
        assertFalse(hostProvisioner.activated);
    }
