...
struct ClientArguments {
    ...
    ClientArguments(int myNum, const std::string& filenamePattern, const std::string& outputPattern,
                    const char* hostname, int port, long cycle, long delay, int ignoreCount, int byteLimit,
                    int restartLimit, int maxLineSize, bool keepAlive, bool base64Decode,
                    bool headerBenchmarkdataCoverage, uint64_t queryfileOffset, uint64_t queryfileEndOffset,
