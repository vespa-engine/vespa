...
void assertParseFail(std::string exp_what, std::string log_line) {
    LogMessage message;
    try {
...
TEST_F(LogMessageTest, require_that_empty_line_fails) { assertParseFail("Bad 1st tab: ", ""); }

TEST_F(LogMessageTest, require_that_tab_at_start_of_line_fails) { assertParseFail("Bad 1st tab: \t", "\t"); }

TEST_F(LogMessageTest, require_that_no_tab_after_time_fails) { assertParseFail("Bad 1st tab: 10", "10"); }

TEST_F(LogMessageTest, require_that_malformed_time_fails) { assertParseFail("Bad time field: 10x", "10x\t"); }
...
TEST_F(LogMessageTest, require_that_malformed_pid_fails) { assertParseFail("Bad pid field: x", "10\tlocalhost\tx\t"); }
