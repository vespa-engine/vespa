...
int main(int argc, char** argv) {
    ...
    assertShouldReject(
        ...
        "E 23-235018.067240 14650 23/10/2012 23:50:18 yjava_preload.so: [preload.c:350] Using FILTER_NONE:  This "
        "must be paranoid approved, and since you are using FILTER_NONE you must live with this error.");
