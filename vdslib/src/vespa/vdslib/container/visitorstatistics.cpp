...
VisitorStatistics::VisitorStatistics()
    : _bucketsVisited(0), _documentsVisited(0), _bytesVisited(0), _documentsReturned(0), _bytesReturned(0) {
}

VisitorStatistics VisitorStatistics::operator+(const VisitorStatistics& other) {
...
void VisitorStatistics::print(std::ostream& out, bool, const std::string& indent) const {
