...
group[0].nodes[2].index 2
    ...
    EXPECT_EQ(gd->getNodeGraph().getDistributionConfigHash(), "(0;0;1;2)");
...
group[2].nodes[2].index 5
    ...
    EXPECT_EQ(gd->getNodeGraph().getDistributionConfigHash(), "(0d*|*(0;0;1;2)(1;3;4;5))");
...
group[6].nodes[0].index 3
    ...
    EXPECT_EQ(gd->getNodeGraph().getDistributionConfigHash(), "(0d*|*(0d*|*(0;0)(1;1))(1d*|*(0;2)(1;3)))");
...
group[2].nodes[1].index 2
    ...
    EXPECT_EQ(gd->getReadyCopies(), 3);
    EXPECT_EQ(gd->getReadyCopies(), 3);
    EXPECT_EQ(gd->getNodeGraph().getDistributionConfigHash(), "(0d*|*(0;0;1)(1;2))");
