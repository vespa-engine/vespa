...
public:
    ...
    std::unique_ptr<ConfigUpdate> provide() override { return std::move(_update); }

    bool wait_until(vespalib::steady_time) override { return true; }
...
static TimingValues testTimingValues(2000ms, // successTimeout
                                     500ms,  // errorTimeout
