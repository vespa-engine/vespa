...
/**
 * A simple trace interface which can be used to create a serial trace log of events. Each entry is given a timestamp.
 * The trace can be serialized to/constructed from slime. Is not thread safe.
 */
class Trace {
public:
