...
struct SystemClock : public Clock {
    vespalib::system_time currentTime() const override { return vespalib::system_clock::now(); }
};
...
void Trace::deserializeTraceLog(const Inspector& root) {
