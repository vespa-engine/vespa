...
public:
     ...
     */
    template <typename... ConfigTypes> ConfigKeySet& add(const std::string& configId);
...
private:
    template <typename ConfigType, typename... ConfigTypes> void addImpl(const std::string& configId);
};
