...
public:
    ...
    SlimeConfigRequest(Connection* connection, const ConfigKey& key, const std::string& configXxhash64,
...
private:
    void populateSlimeRequest(const ConfigKey& key, const std::string& configXxhash64, int64_t currentGeneration,
