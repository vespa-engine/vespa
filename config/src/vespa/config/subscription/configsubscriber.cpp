...
bool ConfigSubscriber::nextConfig(vespalib::duration timeout) {
    return _set.acquireSnapshot(timeout, false);
}

bool ConfigSubscriber::nextGeneration(vespalib::duration timeout) {
...
int64_t ConfigSubscriber::getGeneration() const {
