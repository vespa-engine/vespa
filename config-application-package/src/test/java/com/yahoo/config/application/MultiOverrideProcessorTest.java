...
public class MultiOverrideProcessorTest {
    ...
    private void assertOverride(Environment environment, RegionName region, String expected) throws TransformerException {
        ...
        Document newDoc = new OverrideProcessor(ApplicationName.defaultName(), InstanceName.from("default"), environment, region, Cloud.defaultCloud().name(), Tags.empty()).process(inputDoc);
