...
public class QueryProperties extends Properties {
    ...
    private static Map<CompoundName, GetterSetter> createPropertySetterMap() {
        ...
        addDualCasedRM(map, Matching.RESILIENT_FILTER_FIRST, GetterSetter.of(query -> query.getRanking().getMatching().getResilientFilterFirst(), (query, value) -> query.getRanking().getMatching().setResilientFilterFirst(asBoolean(value, false))));
