...
public class MatchingTestCase {
    ...
    void testQueryOverrides() {
        Query query = new Query("?query=test" +
                ...
                "&ranking.matching.adaptiveBeamSearchSlack=0.09" +
        ...
        assertEquals(Double.valueOf(0.09), query.getRanking().getMatching().getAdaptiveBeamSearchSlack());
        ...
        assertEquals("0.09", query.getRanking().getProperties().get("vespa.matching.nns.adaptive_beam_search_slack").get(0));
