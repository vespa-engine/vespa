...
public class MatchingTestCase {
    ...
    void testQueryOverrides() {
        Query query = new Query("?query=test" +
                ...
                "&ranking.matching.acornOneExploration=0.012" +
        ...
        assertEquals(Double.valueOf(0.012), query.getRanking().getMatching().getAcornOneExploration());
        ...
        assertEquals("0.2", query.getRanking().getProperties().get("vespa.matching.nns.acorn_one_upper_limit").get(0));
        assertEquals("0.012", query.getRanking().getProperties().get("vespa.matching.nns.acorn_one_exploration").get(0));
