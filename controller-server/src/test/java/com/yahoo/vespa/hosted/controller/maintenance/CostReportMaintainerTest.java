...
public class CostReportMaintainerTest {
    ...
    public void maintain() {
        ...
        CostReportMaintainer maintainer = new CostReportMaintainer(tester.controller(), Duration.ofDays(1), mockConsumer, new JobControl(tester.curator()), new NodeRepositoryClientMock());
        maintainer.maintain();
    }
}