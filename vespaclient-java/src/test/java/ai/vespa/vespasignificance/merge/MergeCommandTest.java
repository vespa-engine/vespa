...
class MergeCommandTest {
    ...
    void appliesMinKeep() throws Exception {
        // Three files so batching can happen in TermDfExternalMerger depending on HalfSystemLimitBudget
        ...
        // total is 6 >= 5; if intermediate filtering happened, 't' would be dropped.
