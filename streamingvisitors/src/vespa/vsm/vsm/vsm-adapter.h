...
public:
    ...
    [[nodiscard]] std::shared_ptr<const search::IDocumentIdProvider>
    get_document_id_provider() const noexcept override;
};
...
public:
    ...
    ~VSMConfigSnapshot();
    template <typename ConfigType> std::unique_ptr<ConfigType> getConfig() const;
};
