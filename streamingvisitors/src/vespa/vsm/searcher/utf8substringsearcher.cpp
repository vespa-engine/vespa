...
std::unique_ptr<FieldSearcher> UTF8SubStringFieldSearcher::duplicate() const {
    return std::make_unique<UTF8SubStringFieldSearcher>(*this);
}

size_t UTF8SubStringFieldSearcher::matchTerms(const FieldRef& f, const size_t mintsz) {
...
size_t UTF8SubStringFieldSearcher::matchTerm(const FieldRef& f, QueryTerm& qt) {
