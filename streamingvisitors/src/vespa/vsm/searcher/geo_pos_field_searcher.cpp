...
GeoPosFieldSearcher::GeoPosFieldSearcher(FieldIdT fId) : FieldSearcher(fId), _geoPosTerm() {
}

GeoPosFieldSearcher::~GeoPosFieldSearcher() {
}

void GeoPosFieldSearcher::prepare(search::streaming::QueryTermList& qtl, const SharedSearcherBuf& buf,
