...
public:
    ...
    RankProcessor(std::shared_ptr<const RankManager::Snapshot> snapshot, const std::string& rankProfile,
                  search::streaming::Query& query, const std::string& location,
                  const search::fef::Properties& queryProperties, const search::fef::Properties& featureOverrides,
