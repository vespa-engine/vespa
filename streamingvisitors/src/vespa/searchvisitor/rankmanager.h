...
public:
    ...
    std::unique_ptr<IndexEnvironment> clone() const { return std::make_unique<IndexEnvironment>(_prototype); }
...
public:
    ...
    public:
        ...
        const IndexEnvironment& get_proto_index_environment() const { return _protoEnv.current(); }
