 ...
 *
 * <p>This class can also be used for any provider exposing an OpenAI-compatible API. Declare one component per
 * provider, each with a unique id and its own endpoint/model configuration, and select it by id from the
 * searcher's {@code providerId} config. For example, to use OrcaRouter (https://www.orcarouter.ai)
 * alongside OpenAI:</p>
 * <pre>{@code
 * <component id="openai" class="ai.vespa.llm.clients.OpenAI">
 *   <config name="ai.vespa.llm.clients.llm-client">
 *     <apiKeySecretRef>openai</apiKeySecretRef>
 *   </config>
 * </component>
 *
 * <component id="orcarouter" class="ai.vespa.llm.clients.OpenAI">
 *   <config name="ai.vespa.llm.clients.llm-client">
 *     <apiKeySecretRef>orcarouter</apiKeySecretRef>
 *     <endpoint>https://api.orcarouter.ai/v1/</endpoint>
 *     <model>orcarouter/fusion-mini</model>
 *   </config>
 * </component>
 * }</pre>
 *
