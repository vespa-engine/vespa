...
public class StemmerImplTestCase {
    ...
    public void requireThatSpecialTokensAreNotDecompounded() {
        ...
        assertEquals(List.of(new StemList("c"),
                                   ...
                                   new StemList("p")),
                     stemmer.stem("c++",
                                  new LinguisticsParameters("default", false, Language.ENGLISH, StemMode.SHORTEST, true, true)));

        token.setSpecialToken(true);
        assertEquals(List.of(new StemList("c++")),
                     stemmer.stem("c++", new LinguisticsParameters("default", false, Language.ENGLISH, StemMode.SHORTEST, true, true)));
    }
    ...
    private static void assertStem(String input, List<String> expectedStems, boolean removeAccents) {
        ...
        var parameters = new LinguisticsParameters("default", false, Language.ENGLISH, StemMode.ALL, removeAccents, true);
