...
function(vespa_add_library TARGET)
    ...
    if (ARG_OBJECT OR ARG_INTERFACE OR TARGET ${TARGET}_object OR NOT NON_TARGET_SOURCE_FILES OR VESPA_DISABLE_IMPLICIT_OBJECT_LIBRARIES)
...
function(vespa_add_executable TARGET)
    ...
    __check_target_parameters()
    __split_sources_list()
    if(TARGET ${TARGET}_object OR NOT NON_TARGET_SOURCE_FILES OR VESPA_DISABLE_IMPLICIT_OBJECT_LIBRARIES)
        unset(VESPA_ADD_IMPLICIT_OBJECT_LIBRARY)
...
function(vespa_detect_clion)
  if ($ENV{CLION_IDE})
    # Implicit object libraries interfere with how CLion detects targets for tests.
    set(VESPA_DISABLE_IMPLICIT_OBJECT_LIBRARIES True PARENT_SCOPE)
  endif()
endfunction()
