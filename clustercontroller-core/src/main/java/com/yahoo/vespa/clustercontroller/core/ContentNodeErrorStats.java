 ...
 * <em>towards</em> a particular content node. If no errors have been observed by a
 * distributor, it will not have an entry in this mapping (hence the sparseness).
 *
 * @author vekterli
 */
public class ContentNodeErrorStats {
    ...
    public ContentNodeErrorStats(int myNodeIndex) {
        this.myNodeIndex = myNodeIndex;
        this.statsFromDistributors = new HashMap<>();
    }

    public ContentNodeErrorStats(int myNodeIndex, Map<Integer, DistributorErrorStats> statsFromDistributors) {
        this.myNodeIndex = myNodeIndex;
