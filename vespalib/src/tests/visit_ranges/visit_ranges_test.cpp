...
TEST(VisitRangeExample, set_intersection) {
    ...
    vespalib::visit_ranges(
        overload{[](visit_ranges_either, int) {}, [&result](visit_ranges_both, int x, int) { result.push_back(x); }},
...
TEST(VisitRangeExample, set_subtraction) {
    ...
    vespalib::visit_ranges(overload{[&result](visit_ranges_first, int a) { result.push_back(a); },
                                    [](visit_ranges_second, int) {}, [](visit_ranges_both, int, int) {}},
                           first.begin(), first.end(), second.begin(), second.end());
...
TEST(VisitRangesTest, empty_ranges_can_be_visited) {
    ...
    std::vector<int> b;
    std::vector<int> c;
    auto             visitor = overload{[&c](visit_ranges_either, int) { c.push_back(42); },
                            [&c](visit_ranges_both, int, int) { c.push_back(42); }};
...
TEST(VisitRangesTest, simple_merge_can_be_implemented) {
    ...
    std::vector<int> c;
    auto             visitor = overload{[&c](visit_ranges_either, int x) { c.push_back(x); },
...
TEST(VisitRangesTest, simple_union_can_be_implemented) {
    ...
    std::vector<int> c;
    auto             visitor = overload{[&c](visit_ranges_either, int x) { c.push_back(x); },
                            [&c](visit_ranges_both, int x, int) { c.push_back(x); }};
    vespalib::visit_ranges(visitor, a.begin(), a.end(), b.begin(), b.end());
...
TEST(VisitRangesTest, asymmetric_merge_can_be_implemented) {
    ...
    std::vector<int> b({2, 3, 8});
    std::vector<int> c;
    auto visitor = overload{[&c](visit_ranges_first, int x) { c.push_back(x); }, [](visit_ranges_second, int) {},
                            [&c](visit_ranges_both, int x, int y) { c.push_back(x * y); }};
    vespalib::visit_ranges(visitor, a.begin(), a.end(), b.begin(), b.end());
