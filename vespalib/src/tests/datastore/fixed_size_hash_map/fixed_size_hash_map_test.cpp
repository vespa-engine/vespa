...
FixedSizeHashMapHeld::FixedSizeHashMapHeld(size_t size, std::unique_ptr<const FixedSizeHashMap> data)
    : GenerationHeldBase(size), _data(std::move(data)) {}
...
DataStoreFixedSizeHashTest::~DataStoreFixedSizeHashTest() { commit(); }

void DataStoreFixedSizeHashTest::commit() {
...
size_t DataStoreFixedSizeHashTest::size() const noexcept { return _hash_map->size(); }

void DataStoreFixedSizeHashTest::insert(uint32_t key) {
...
void DataStoreFixedSizeHashTest::remove(uint32_t key) {
    auto comp = _comparator.make_for_lookup(key);
...
bool DataStoreFixedSizeHashTest::has_key(uint32_t key) {
    auto comp = _comparator.make_for_lookup(key);
...
void DataStoreFixedSizeHashTest::use_single_hash_chain() { _hash_map = std::make_unique<FixedSizeHashMap>(1, 40, 1); }

void DataStoreFixedSizeHashTest::setup_single_hash_chain_three_elems() {
...
std::vector<bool> DataStoreFixedSizeHashTest::check_three_elems() {
