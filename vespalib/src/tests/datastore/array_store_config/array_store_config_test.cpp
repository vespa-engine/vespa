...
struct Fixture {
    ...
    Fixture(uint32_t max_type_id, size_t hugePageSize, size_t smallPageSize, size_t max_buffer_size,
        ...
        : cfg(ArrayStoreConfig::optimizeForHugePage(max_type_id, type_id_to_entry_size, hugePageSize, smallPageSize,
                                                    EntryRefType::offsetSize(), max_buffer_size,
                                                    min_num_entries_for_new_buffer, ALLOC_GROW_FACTOR)) {}
