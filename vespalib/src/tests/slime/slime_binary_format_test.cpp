...
template <> void setSlimeValue<BOOL>(Slime& slime, const TypeTraits<BOOL>::PassType& value) {
    slime.setBool(value);
}
template <> void setSlimeValue<LONG>(Slime& slime, const TypeTraits<LONG>::PassType& value) {
    slime.setLong(value);
}
...
template <> void setSlimeValue<DATA>(Slime& slime, const TypeTraits<DATA>::PassType& value) {
    slime.setData(value);
}
