...
void CompressTest::verifyPositiveNumber(uint64_t n, const uint8_t* expected, size_t sz) {
    uint8_t buf[8];
...
void CompressTest::verifyNumber(int64_t n, const uint8_t* expected, size_t sz) {
    uint8_t buf[8];
