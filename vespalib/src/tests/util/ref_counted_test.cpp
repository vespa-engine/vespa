...
void (*copy_assign_ref_counted_leaf)(ref_counted<Leaf>&       lhs,
                                     const ref_counted<Leaf>& rhs) = copy_assign_ref_counted_leaf_real;

void move_assign_ref_counted_leaf_real(ref_counted<Leaf>& lhs, ref_counted<Leaf>&& rhs) {
    lhs = std::move(rhs);
}

void (*move_assign_ref_counted_leaf)(ref_counted<Leaf>&  lhs,
                                     ref_counted<Leaf>&& rhs) = move_assign_ref_counted_leaf_real;
