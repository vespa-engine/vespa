...
TEST(ComponentTest, testText) {
    ...
    VESPA_EXPECT_EXCEPTION(v = VersionSpecification("-1"), IllegalArgumentException,
                           "integer must start with a digit");
    VESPA_EXPECT_EXCEPTION(v = VersionSpecification("1.-1"), IllegalArgumentException,
                           "integer must start with a digit");
    VESPA_EXPECT_EXCEPTION(v = VersionSpecification("1.2.-1"), IllegalArgumentException,
                           "integer must start with a digit");
    VESPA_EXPECT_EXCEPTION(v = VersionSpecification("1.2.3.-1"), IllegalArgumentException,
                           "Invalid character in qualifier");
}
