...
struct LevenshteinDfaTest : TestWithParam<CasingAndDfaType> {
    ...
    static std::optional<uint32_t> prefix_calculate(std::string_view left, std::string_view right,
                                                    uint32_t threshold) {
...
INSTANTIATE_TEST_SUITE_P(AllCasingAndDfaTypes, LevenshteinDfaTest,
                         Combine(Values(LevenshteinDfa::Casing::Uncased, LevenshteinDfa::Casing::Cased),
                                 Values(LevenshteinDfa::DfaType::Explicit, LevenshteinDfa::DfaType::Implicit,
...
struct LevenshteinDfaCasingTest : TestWithParam<LevenshteinDfa::DfaType> {
    ...
    static std::optional<uint32_t> calculate_cased(std::string_view left, std::string_view right,
                                                   uint32_t threshold) {
        return do_calculate(left, right, threshold, LevenshteinDfa::Casing::Cased, dfa_type());
    }

    static std::optional<uint32_t> calculate_uncased(std::string_view left, std::string_view right,
                                                     uint32_t threshold) {
        return do_calculate(left, right, threshold, LevenshteinDfa::Casing::Uncased, dfa_type());
    }
};

INSTANTIATE_TEST_SUITE_P(AllDfaTypes, LevenshteinDfaCasingTest,
                         Values(LevenshteinDfa::DfaType::Explicit, LevenshteinDfa::DfaType::Implicit,
                                LevenshteinDfa::DfaType::Table),
...
INSTANTIATE_TEST_SUITE_P(SupportedMaxEdits, LevenshteinDfaSuccessorTest,
                         Combine(Values(LevenshteinDfa::Casing::Uncased, LevenshteinDfa::Casing::Cased),
                                 Values(LevenshteinDfa::DfaType::Explicit, LevenshteinDfa::DfaType::Implicit,
                                        LevenshteinDfa::DfaType::Table),
                                 Values(LevenshteinDfa::Matching::FullString, LevenshteinDfa::Matching::Prefix),
                                 Values(1, 2)),
...
INSTANTIATE_TEST_SUITE_P(AllDfaTypes, LevenshteinBenchmarkTest,
                         Combine(Values(BenchmarkType::DfaExplicit, BenchmarkType::DfaImplicit,
