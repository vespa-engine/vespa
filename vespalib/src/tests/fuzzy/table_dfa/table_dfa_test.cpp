...
TEST(TableDfaTest, list_states_for_max_edits_1) {
    list_states<1>();
}
TEST(TableDfaTest, list_states_for_max_edits_2) {
    list_states<2>();
}
...
TEST(TableDfaTest, list_edits_at_input_end_for_max_edits_1) {
    list_edits<1>();
}
TEST(TableDfaTest, list_edits_at_input_end_for_max_edits_2) {
    list_edits<2>();
}
...
TEST(TableDfaTest, list_transitions_for_max_edits_1) {
    list_transitions<1>();
}
