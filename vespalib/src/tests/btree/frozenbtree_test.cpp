...
protected:
    ...
    void traverseTreeIterator(const Tree& tree, NodeAllocator& allocator, const std::vector<KeyType>& sorted,
                              bool frozen);
...
void FrozenBTreeTest::lookupRandomValues(const Tree& tree, NodeAllocator& allocator,
...
void FrozenBTreeTest::lookupGoneRandomValues(const Tree& tree, NodeAllocator& allocator,
                                             const std::vector<KeyType>& values) {
    std::vector<KeyType>::const_iterator i(values.begin());
    std::vector<KeyType>::const_iterator ie(values.end());
    Iterator                             p;
...
void FrozenBTreeTest::lookupFrozenRandomValues(const Tree& tree, NodeAllocator& allocator,
                                               const std::vector<KeyType>& values) {
    std::vector<KeyType>::const_iterator i(values.begin());
    std::vector<KeyType>::const_iterator ie(values.end());
    ConstIterator                        p;
...
void FrozenBTreeTest::traverseTreeIterator(const Tree& tree, NodeAllocator& allocator,
