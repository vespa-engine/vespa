...
void FastOS_FileInterface::WriteBuf(const void* buffer, size_t length) {
...
size_t FastOS_FileInterface::getMaxDirectIOMemAlign() {
    return 1u;
}

void* FastOS_FileInterface::AllocateDirectIOBuffer(size_t byteSize) {
...
const char* FastOS_FileInterface::GetFileName() const {
...
bool FastOS_FileInterface::OpenWriteOnly(const char* filename) {
