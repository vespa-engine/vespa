...
std::string combine_paths(const std::string& base_path, const std::string& controller,
...
void CGroupResourceLimits::foreach_cgroup_v1_level(const std::string&                             controller,
                                                   const std::function<void(const std::string&)>& callback) {
