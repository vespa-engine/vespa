...
[[noreturn]] void abort_due_to_guard_bits_tampered_with() { abort(); }

[[noreturn]] void abort_due_to_PROTECTED_guard_bits_tampered_with() __attribute__((noinline));
[[noreturn]] void abort_due_to_PROTECTED_guard_bits_tampered_with() { abort(); }
...
MemoryRangeTrapper::~MemoryRangeTrapper() { check_and_release(); }
...
bool has_4k_pages() noexcept { return (sysconf(_SC_PAGESIZE) == 4096); }

constexpr bool is_4k_aligned(size_t v) noexcept { return (v % 4096) == 0; }

constexpr size_t align_up_4k(size_t v) noexcept { return (v + 4095) & ~4095ULL; }

constexpr size_t align_down_4k(size_t v) noexcept { return v & ~4095ULL; }
...
bool MemoryRangeTrapper::hw_trapping_enabled() noexcept { return mprotect_trapping_is_enabled(); }
