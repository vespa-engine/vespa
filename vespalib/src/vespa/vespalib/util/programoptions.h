...
public:
    ...
    OptionParser& addOption(
        const std::string& optionNameList, Type& value, const Type& defaultValue, const std::string& description);

    template <typename Type>
    OptionParser& addArgument(const std::string& optionNameList, Type& value, const std::string& description);

    template <typename Type>
    OptionParser& addArgument(
        const std::string& optionNameList, Type& value, const Type& defaultValue, const std::string& description);

    template <typename Type>
    OptionParser& addListArgument(
        const std::string& optionNameList, std::vector<Type>& value, const std::string& description);
...
struct ProgramOptions::FlagOptionParser : public OptionParser {
    ...
    FlagOptionParser(
        const std::string& nameList, bool& value, const bool& unsetValue, const std::string& description);
...
struct ProgramOptions::StringOptionParser : public OptionParser {
    ...
    StringOptionParser(
        const std::string& nameList, std::string& value, const std::string& defVal, const std::string& desc);
