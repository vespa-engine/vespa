...
public:
    HwInfo() noexcept : _disk(0, false, false), _memory(0), _cpu(1) {}

    HwInfo(const Disk& disk_, const Memory& memory_, const Cpu& cpu_) noexcept
        : _disk(disk_), _memory(memory_), _cpu(cpu_) {}
