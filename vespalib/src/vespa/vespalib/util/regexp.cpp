...
bool is_special(char c) {
    return special.find(c) != special.npos;
}
...
std::string RegexpUtil::make_from_suffix(std::string_view suffix) {
    return escape(suffix) + "$";
}

std::string RegexpUtil::make_from_substring(std::string_view substring) {
