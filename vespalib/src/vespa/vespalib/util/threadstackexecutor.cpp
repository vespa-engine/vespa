...
bool ThreadStackExecutor::acceptNewTask(unique_lock&, std::condition_variable&) { return isRoomForNewTask(); }

void ThreadStackExecutor::wakeup(unique_lock&, std::condition_variable&) {}
...
ThreadStackExecutor::~ThreadStackExecutor() { cleanup(); }
