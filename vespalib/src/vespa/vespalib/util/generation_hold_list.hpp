...
void GenerationHoldList<T, track_bytes_held, use_deque>::assign_generation_internal(generation_t current_gen) {
...
void GenerationHoldList<T, track_bytes_held, use_deque>::reclaim_internal(generation_t oldest_used_gen, Func func) {
...
GenerationHoldList<T, track_bytes_held, use_deque>::GenerationHoldList() noexcept
    : _phase_1_list(), _phase_2_list(), _held_bytes() {}
...
template <typename T, bool track_bytes_held, bool use_deque>
void GenerationHoldList<T, track_bytes_held, use_deque>::insert(T data) {
...
template <typename T, bool track_bytes_held, bool use_deque>
void GenerationHoldList<T, track_bytes_held, use_deque>::reclaim_all() {
    _phase_1_list.clear();
    _phase_2_list.clear();
    _held_bytes = 0;
}
...
template <typename T, bool track_bytes_held, bool use_deque>
template <typename Func>
void GenerationHoldList<T, track_bytes_held, use_deque>::reclaim_all(Func func) {
