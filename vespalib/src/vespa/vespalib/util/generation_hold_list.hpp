...
void GenerationHoldList<T, track_bytes_held, use_deque>::assign_generation_internal(Generation current_gen) {
...
void GenerationHoldList<T, track_bytes_held, use_deque>::reclaim_internal(Generation oldest_used_gen, Func func) {
