...
public:
    ...
    virtual bool process(CompressionConfig config, const void* input, size_t inputLen, void* output,
                         size_t& outputLen) = 0;
...
CompressionConfig::Type compress(CompressionConfig::Type compression, const ConstBufferRef& org, DataBuffer& dest,
                                 bool allowSwap);
CompressionConfig::Type compress(CompressionConfig compression, const vespalib::ConstBufferRef& org,
