...
void StateExplorerUtils::address_space_to_slime(const AddressSpace& address_space, slime::Cursor& object) {
...
void StateExplorerUtils::memory_usage_to_slime(const MemoryUsage& usage, Cursor& object) {
