...
const char* ExceptionWithPayload::what() const noexcept { return _msg.c_str(); }
...
PortListenException::PortListenException(
    int port, std::string_view protocol, std::string_view msg, std::string_view location, int skipStack)
...
IoException::IoException(
    std::string_view msg, Type type, const Exception& cause, std::string_view location, int skipStack)
...
template <typename T> bool check_type(const std::exception& e) { return (dynamic_cast<const T*>(&e) != nullptr); }
