...
SingleExecutor::SingleExecutor(init_fun_t func, uint32_t reservedQueueSize, bool isQueueSizeHard, uint32_t watermark,
...
size_t SingleExecutor::getNumThreads() const {
    return 1;
}
...
void SingleExecutor::setTaskLimit(uint32_t taskLimit) {
