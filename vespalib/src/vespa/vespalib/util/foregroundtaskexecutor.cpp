...
ForegroundTaskExecutor::ForegroundTaskExecutor() : ForegroundTaskExecutor(1) {}

ForegroundTaskExecutor::ForegroundTaskExecutor(uint32_t threads) : ISequencedTaskExecutor(threads), _accepted(0) {}
...
void ForegroundTaskExecutor::sync_all() {}
...
ISequencedTaskExecutor::ExecutorId ForegroundTaskExecutor::getExecutorId(uint64_t componentId) const {
