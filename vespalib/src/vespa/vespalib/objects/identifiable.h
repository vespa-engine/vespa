...
#define IMPLEMENT_IDENTIFIABLE_BASE(cclass, name, base, id, factory, ctypeInfo, tryCast, typeinfo) \
    vespalib::Identifiable::RuntimeInfo cclass::_RTInfo = {                                        \
        name, typeinfo, id, factory, ctypeInfo, tryCast, &base::_RTInfo};                          \
    IMPLEMENT_IDENTIFIABLE_COMMON(cclass)

#define IMPLEMENT_IDENTIFIABLE_ABSTRACT(cclass, base)                                                      \
    IMPLEMENT_IDENTIFIABLE_BASE(                                                                           \
        cclass, #cclass, base, IDENTIFIABLE_CLASSID(cclass), nullptr, cclass::typeId, cclass::tryCast, "")
...
#define IMPLEMENT_IDENTIFIABLE_ABSTRACT_NS2(ns1, ns2, cclass, base)                                               \
    IMPLEMENT_IDENTIFIABLE_BASE(                                                                                  \
        ns1::ns2::cclass, #ns1 "::" #ns2 "::" #cclass, base, IDENTIFIABLE_CLASSID_NS2(ns1, ns2, cclass), nullptr, \
        cclass::typeId, cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_NS2(ns1, ns2, cclass, base)                                               \
    IMPLEMENT_IDENTIFIABLE_CONCRET(ns1::ns2::cclass)                                                     \
    IMPLEMENT_IDENTIFIABLE_BASE(                                                                         \
        ns1::ns2::cclass, #ns1 "::" #ns2 "::" #cclass, base, IDENTIFIABLE_CLASSID_NS2(ns1, ns2, cclass), \
        cclass::createAsIdentifiable, cclass::typeId, cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_ABSTRACT_NS3(ns1, ns2, ns3, cclass, base)                               \
    IMPLEMENT_IDENTIFIABLE_BASE(                                                                       \
        ns1::ns2::ns3::cclass, #ns1 "::" #ns2 "::" #ns3 "::" #cclass, base,                            \
        IDENTIFIABLE_CLASSID_NS3(ns1, ns2, ns3, cclass), nullptr, cclass::typeId, cclass::tryCast, "")
