...
#define DECLARE_IDENTIFIABLE_STATIC_BASE_COMMON(cclass)    \
    ...
    static const std::type_info& typeId() {                \
        return typeid(cclass);                             \
    }                                                      \
    static bool tryCast(const vespalib::Identifiable* v) { \
        return dynamic_cast<const cclass*>(v) != nullptr;  \
    }                                                      \
    static cclass* identifyClassAsIdentifiable() {         \
        return nullptr;                                    \
    } /* no implementation */
...
#define DECLARE_IDENTIFIABLE_ABSTRACT_NS(ns, cclass)                           \
    DECLARE_IDENTIFIABLE_BASE(ns::cclass, IDENTIFIABLE_CLASSID_NS(ns, cclass))
#define DECLARE_IDENTIFIABLE_ABSTRACT_NS2(ns1, ns2, cclass)                                 \
    DECLARE_IDENTIFIABLE_BASE(ns1::ns2::cclass, IDENTIFIABLE_CLASSID_NS2(ns1, ns2, cclass))
#define DECLARE_IDENTIFIABLE_ABSTRACT_NS3(ns1, ns2, ns3, cclass)                                      \
...
#define DECLARE_IDENTIFIABLE_STATIC_COMMON(cclass) \
    ...
    static Identifiable* createAsIdentifiable() {  \
...
#define IMPLEMENT_IDENTIFIABLE_COMMON(cclass)                              \
    ...
    const vespalib::Identifiable::RuntimeClass& cclass::getClass() const { \
        return _RTClass;                                                   \
    }
...
#define IMPLEMENT_IDENTIFIABLE_BASE(cclass, name, base, id, factory, ctypeInfo, tryCast, typeinfo)         \
    vespalib::Identifiable::RuntimeInfo cclass::_RTInfo = {name,    typeinfo,      id, factory, ctypeInfo, \
                                                           tryCast, &base::_RTInfo};                       \
    IMPLEMENT_IDENTIFIABLE_COMMON(cclass)

#define IMPLEMENT_IDENTIFIABLE_ABSTRACT(cclass, base)                                                         \
    IMPLEMENT_IDENTIFIABLE_BASE(cclass, #cclass, base, IDENTIFIABLE_CLASSID(cclass), nullptr, cclass::typeId, \
                                cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE(cclass, base)                                                                       \
    IMPLEMENT_IDENTIFIABLE_CONCRET(cclass)                                                                         \
    IMPLEMENT_IDENTIFIABLE_BASE(cclass, #cclass, base, IDENTIFIABLE_CLASSID(cclass), cclass::createAsIdentifiable, \
                                cclass::typeId, cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_ABSTRACT_NS(ns, cclass, base)                                                      \
    IMPLEMENT_IDENTIFIABLE_BASE(ns::cclass, #ns "::" #cclass, base, IDENTIFIABLE_CLASSID_NS(ns, cclass), nullptr, \
                                cclass::typeId, cclass::tryCast, "")
...
#define IMPLEMENT_IDENTIFIABLE_ABSTRACT_NS2(ns1, ns2, cclass, base)                                  \
    IMPLEMENT_IDENTIFIABLE_BASE(ns1::ns2::cclass, #ns1 "::" #ns2 "::" #cclass, base,                 \
                                IDENTIFIABLE_CLASSID_NS2(ns1, ns2, cclass), nullptr, cclass::typeId, \
                                cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_NS2(ns1, ns2, cclass, base)                                                \
    IMPLEMENT_IDENTIFIABLE_CONCRET(ns1::ns2::cclass)                                                      \
    IMPLEMENT_IDENTIFIABLE_BASE(ns1::ns2::cclass, #ns1 "::" #ns2 "::" #cclass, base,                      \
                                IDENTIFIABLE_CLASSID_NS2(ns1, ns2, cclass), cclass::createAsIdentifiable, \
                                cclass::typeId, cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_ABSTRACT_NS3(ns1, ns2, ns3, cclass, base)                                  \
    IMPLEMENT_IDENTIFIABLE_BASE(ns1::ns2::ns3::cclass, #ns1 "::" #ns2 "::" #ns3 "::" #cclass, base,       \
                                IDENTIFIABLE_CLASSID_NS3(ns1, ns2, ns3, cclass), nullptr, cclass::typeId, \
                                cclass::tryCast, "")
#define IMPLEMENT_IDENTIFIABLE_NS3(ns1, ns2, ns3, cclass, base)                                                \
    IMPLEMENT_IDENTIFIABLE_CONCRET(ns1::ns2::ns3::cclass)                                                      \
    IMPLEMENT_IDENTIFIABLE_BASE(ns1::ns2::ns3::cclass, #ns1 "::" #ns2 "::" #ns3 "::" #cclass, base,            \
                                IDENTIFIABLE_CLASSID_NS3(ns1, ns2, ns3, cclass), cclass::createAsIdentifiable, \
                                cclass::typeId, cclass::tryCast, "")
...
public:
    ...
    template <typename T> struct BaseType<T&> {
        using type = T;
    };
    template <typename T> struct BaseType<T*> {
        using type = T;
    };
    template <typename T> struct BaseType<const T&> {
        using type = T;
    };
    template <typename T> struct BaseType<const T*> {
        using type = T;
     ...
     *                  on the selected (sub-)objects
     **/
    virtual void selectMembers(const ObjectPredicate& predicate, ObjectOperation& operation);
     ...
     * @return outputstream
     */
    template <typename T> static Serializer& serialize(const T& v, Serializer& os);
     ...
     * @return outputstream
     */
    template <typename T> static Deserializer& deserialize(T& v, Deserializer& is);
...
protected:
     ...
     */
    int cmpClassId(const Identifiable& b) const { return getClass().id() - b.getClass().id(); }
