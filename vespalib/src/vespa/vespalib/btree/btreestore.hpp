...
BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::lower_bound(const KeyDataType* b, const KeyDataType* e,
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::makeTree(EntryRef& ref, const KeyDataType* array,
                                                                            uint32_t clusterSize) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::makeArray(EntryRef& ref, EntryRef root,
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::applyCluster(const KeyDataType* o,
                                                                                const KeyDataType* oe, KeyDataType* d,
                                                                                const KeyDataType* de, AddIter a,
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::applyBuildTree(BTreeType* tree, AddIter a,
                                                                                  AddIter ae, RemoveIter r,
                                                                                  RemoveIter re, CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
bool BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::applyCluster(EntryRef& ref, uint32_t clusterSize,
                                                                                AddIter a, AddIter ae, RemoveIter r,
                                                                                RemoveIter re, CompareT comp) {
    size_t   additionSize(ae - a);
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::applyTree(BTreeType* tree, AddIter a, AddIter ae,
                                                                             RemoveIter r, RemoveIter re,
                                                                             CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::normalizeTree(EntryRef& ref, BTreeType* tree,
                                                                                 bool wasArray) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, typename AggrCalcT>
void BTreeStore<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::apply(EntryRef& ref, AddIter a, AddIter ae,
