...
void BTreeInserter<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::rebalanceLeafEntries(LeafNodeType* leafNode,
                                                                                           Iterator&     itr,
                                                                                           AggrCalcT     aggrCalc) {
    (void)aggrCalc;
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
void BTreeInserter<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::insert(BTreeNode::Ref& root, Iterator& itr,
