...
public:
    static void insert(BTreeNode::Ref& root, Iterator& itr, const KeyType& key, const DataType& data,
...
extern template class BTreeInserter<uint32_t, int32_t, MinMaxAggregated, std::less<uint32_t>, BTreeDefaultTraits,
                                    MinMaxAggrCalc>;
