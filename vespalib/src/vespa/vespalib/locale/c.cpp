...
double strtod(const char* startp, char** endp) { return strtod_l(startp, endp, _G_C_Locale.get()); }

float strtof(const char* startp, char** endp) { return strtof_l(startp, endp, _G_C_Locale.get()); }
