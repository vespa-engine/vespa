...
X509Certificate::DistinguishedName&
X509Certificate::DistinguishedName::operator=(DistinguishedName&&) noexcept = default;
...
X509Certificate::Params X509Certificate::Params::issued_by(SubjectInfo                      subject,
