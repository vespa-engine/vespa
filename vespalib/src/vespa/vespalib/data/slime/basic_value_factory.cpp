...
Value* BoolValueFactory::create(Stash& stash) const {
    return &stash.create<BasicBoolValue>(input);
}

Value* LongValueFactory::create(Stash& stash) const {
    return &stash.create<BasicLongValue>(input);
}

Value* DoubleValueFactory::create(Stash& stash) const {
    return &stash.create<BasicDoubleValue>(input);
}

Value* StringValueFactory::create(Stash& stash) const {
    return &stash.create<BasicStringValue>(input, stash);
}

Value* DataValueFactory::create(Stash& stash) const {
