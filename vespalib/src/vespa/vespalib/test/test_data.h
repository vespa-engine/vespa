...
template <class Derived> void TestData<Derived>::tear_down_test_data() {
    std::filesystem::remove(build_testdata());
}

template <class Derived>
void TestData<Derived>::remove_unchanged_build_testdata_file_or_fail(const nbostream&   buf,
