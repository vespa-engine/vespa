...
ArrayStoreConfig ArrayStoreConfig::optimizeForHugePage(
    ...
    allocSpecs.emplace_back(
        0, capped_max_entries, capped_min_num_entries_for_new_buffer, allocGrowFactor); // large array spec;
