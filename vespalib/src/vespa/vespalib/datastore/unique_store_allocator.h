 ...
 * 32-bit EntryRef.
 */
template <typename EntryT, typename RefT = EntryRefT<22>> class UniqueStoreAllocator : public ICompactable {
public:
...
public:
    ...
    const EntryType&     get(EntryRef ref) const { return get_wrapped(ref).value(); }
