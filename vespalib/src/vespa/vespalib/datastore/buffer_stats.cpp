...
void BufferStats::add_to_mem_stats(size_t entry_size, MemoryStats& stats) const noexcept {
...
InternalBufferStats::InternalBufferStats() noexcept : BufferStats() {}

void InternalBufferStats::clear() noexcept {
