...
public:
    ...
    void resume_primary_buffer(uint32_t buffer_id, std::atomic<EntryCount>* used_entries,
...
protected:
    ...
    private:
        struct ActiveBufferCounts {
            ...
            ActiveBufferCounts(const std::atomic<EntryCount>* used_ptr_in,
                               const std::atomic<EntryCount>* dead_ptr_in) noexcept
