...
CompactBufferCandidates::CompactBufferCandidates(uint32_t num_buffers, uint32_t max_buffers,
                                                 double active_buffers_ratio, double ratio, size_t slack)
    : _candidates(),
      _used(0),
      _dead(0),
...
void CompactBufferCandidates::set_free_buffers(uint32_t free_buffers) {
