...
void DataStoreBase::assign_generation(Generation current_gen) {
...
void DataStoreBase::reclaim_memory(Generation oldest_used_gen) {
...
DataStoreBase::start_compact_worst_buffers(CompactionSpec            compaction_spec,
