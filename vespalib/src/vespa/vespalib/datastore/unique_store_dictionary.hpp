...
template <typename BTreeDictionaryT, typename ParentT, typename HashDictionaryT>
void UniqueStoreDictionary<BTreeDictionaryT, ParentT, HashDictionaryT>::assign_generation(Generation current_gen) {
    if constexpr (has_btree_dictionary) {
...
template <typename BTreeDictionaryT, typename ParentT, typename HashDictionaryT>
void UniqueStoreDictionary<BTreeDictionaryT, ParentT, HashDictionaryT>::reclaim_memory(Generation oldest_used_gen) {
    if constexpr (has_btree_dictionary) {
