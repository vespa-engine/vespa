...
Version::Version(int major, int minor, int micro, const string& qualifier)
    : _major(major), _minor(minor), _micro(micro), _qualifier(qualifier), _stringValue(), _abbreviatedStringValue() {
    initialize();
}
...
Version::Version(const string& versionString)
    : _major(0), _minor(0), _micro(0), _qualifier(), _stringValue(), _abbreviatedStringValue() {
