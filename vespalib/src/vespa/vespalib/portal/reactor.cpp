...
void Reactor::Token::update(bool read, bool write) { _reactor._selector.update(_fd, _handler, read, write); }
...
void Reactor::cancel_token(const Token&) {
...
void Reactor::handle_wakeup() { _was_woken = true; }

void Reactor::handle_event(EventHandler& handler, bool read, bool write) {
    if (!_skip_events) {
...
Reactor::Token::UP Reactor::attach(EventHandler& handler, int fd, bool read, bool write) {
