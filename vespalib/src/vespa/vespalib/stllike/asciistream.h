...
inline asciistream::Width setw(size_t v) {
    return asciistream::Width(v);
}
inline asciistream::Fill setfill(char v) {
    return asciistream::Fill(v);
}
inline asciistream::Precision setprecision(size_t v) {
    return asciistream::Precision(v);
}
