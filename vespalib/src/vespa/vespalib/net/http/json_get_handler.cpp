...
JsonGetHandler::Response JsonGetHandler::Response::make_ok_with_content_type(std::string payload,
...
JsonGetHandler::Response JsonGetHandler::Response::make_not_found() {
