...
bool SocketOptions::set_nodelay(int fd, bool value) {
    return set_bool_opt(fd, IPPROTO_TCP, TCP_NODELAY, value);
}

bool SocketOptions::set_reuse_addr(int fd, bool value) {
    return set_bool_opt(fd, SOL_SOCKET, SO_REUSEADDR, value);
}

bool SocketOptions::set_ipv6_only(int fd, bool value) {
    return set_bool_opt(fd, IPPROTO_IPV6, IPV6_V6ONLY, value);
}

bool SocketOptions::set_keepalive(int fd, bool value) {
