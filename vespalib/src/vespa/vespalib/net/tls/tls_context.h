...
struct TlsContext {
    ...
    static std::shared_ptr<TlsContext>
    create_default_context(const TransportSecurityOptions&,
                           std::shared_ptr<CertificateVerificationCallback> cert_verify_callback, AuthorizationMode);
};
