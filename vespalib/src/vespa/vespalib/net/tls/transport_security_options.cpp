...
TransportSecurityOptions::TransportSecurityOptions(std::string ca_certs_pem, std::string cert_chain_pem,
                                                   std::string private_key_pem, AuthorizedPeers authorized_peers,
