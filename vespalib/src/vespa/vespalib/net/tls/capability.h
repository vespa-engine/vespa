...
private:
    ...
    constexpr static Capability of(Id id) noexcept { return Capability(id); }

public:
    Capability() = delete; // Only valid capabilities can be created.

    constexpr bool operator==(const Capability& rhs) const noexcept { return (_cap_id == rhs._cap_id); }

    constexpr bool operator!=(const Capability& rhs) const noexcept { return !(*this == rhs); }
    ...
    constexpr static Capability none() noexcept { return Capability(Id::None); }

    constexpr static Capability http_unclassified() noexcept { return Capability(Id::HttpUnclassified); }

    constexpr static Capability restapi_unclassified() noexcept { return Capability(Id::RestApiUnclassified); }

    constexpr static Capability rpc_unclassified() noexcept { return Capability(Id::RpcUnclassified); }

    constexpr static Capability client_filereceiver_api() noexcept { return Capability(Id::ClientFilereceiverApi); }

    constexpr static Capability client_slobrok_api() noexcept { return Capability(Id::ClientSlobrokApi); }

    constexpr static Capability cluster_controller_reindexing() noexcept {
        return Capability(Id::ClusterControllerReindexing);
    }

    constexpr static Capability cluster_controller_state() noexcept { return Capability(Id::ClusterControllerState); }

    constexpr static Capability cluster_controller_status() noexcept {
        return Capability(Id::ClusterControllerStatus);
    }

    constexpr static Capability configproxy_config_api() noexcept { return Capability(Id::ConfigproxyConfigApi); }
    ...
    constexpr static Capability configserver_config_api() noexcept { return Capability(Id::ConfigserverConfigApi); }
    ...
    constexpr static Capability container_document_api() noexcept { return Capability(Id::ContainerDocumentApi); }

    constexpr static Capability container_management_api() noexcept { return Capability(Id::ContainerManagementApi); }

    constexpr static Capability container_state_api() noexcept { return Capability(Id::ContainerStateApi); }

    constexpr static Capability content_storage_api() noexcept { return Capability(Id::ContentStorageApi); }

    constexpr static Capability content_document_api() noexcept { return Capability(Id::ContentDocumentApi); }

    constexpr static Capability content_search_api() noexcept { return Capability(Id::ContentSearchApi); }

    constexpr static Capability content_state_api() noexcept { return Capability(Id::ContentStateApi); }

    constexpr static Capability content_proton_admin_api() noexcept { return Capability(Id::ContentProtonAdminApi); }
    ...
    constexpr static Capability slobrok_api() noexcept { return Capability(Id::SlobrokApi); }

    constexpr static Capability content_status_pages() noexcept { return Capability(Id::ContentStatusPages); }

    constexpr static Capability content_metrics_api() noexcept { return Capability(Id::ContentMetricsApi); }

    constexpr static Capability logserver_api() noexcept { return Capability(Id::LogserverApi); }

    constexpr static Capability metricsproxy_management_api() noexcept {
        return Capability(Id::MetricsproxyManagementApi);
    }

    constexpr static Capability metricsproxy_metrics_api() noexcept { return Capability(Id::MetricsproxyMetricsApi); }
    ...
    constexpr static Capability sentinel_management_api() noexcept { return Capability(Id::SentinelManagementApi); }
};
