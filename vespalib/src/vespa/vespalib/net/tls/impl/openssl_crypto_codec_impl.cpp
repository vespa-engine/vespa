...
OpenSslCryptoCodecImpl::OpenSslCryptoCodecImpl(std::shared_ptr<OpenSslTlsContextImpl> ctx,
                                               const SocketSpec& peer_spec, const SocketAddress& peer_address,
                                               Mode mode)
    : _ctx(std::move(ctx)),
...
OpenSslCryptoCodecImpl::make_client_codec(std::shared_ptr<OpenSslTlsContextImpl> ctx, const SocketSpec& peer_spec,
...
HandshakeResult OpenSslCryptoCodecImpl::handshake(const char* from_peer, size_t from_peer_buf_size, char* to_peer,
                                                  size_t to_peer_buf_size) noexcept {
...
EncodeResult OpenSslCryptoCodecImpl::encode(const char* plaintext, size_t plaintext_size, char* ciphertext,
                                            size_t ciphertext_size) noexcept {
...
DecodeResult OpenSslCryptoCodecImpl::decode(const char* ciphertext, size_t ciphertext_size, char* plaintext,
                                            size_t plaintext_size) noexcept {
...
DecodeResult OpenSslCryptoCodecImpl::drain_and_produce_plaintext_from_ssl(char*  plaintext,
                                                                          size_t plaintext_size) noexcept {
    ::ERR_clear_error();
