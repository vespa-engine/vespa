...
AutoReloadingTlsCryptoEngine::AutoReloadingTlsCryptoEngine(std::string config_file_path, AuthorizationMode mode,
...
CryptoSocket::UP AutoReloadingTlsCryptoEngine::create_client_crypto_socket(SocketHandle      socket,
...
std::unique_ptr<CryptoCodec> AutoReloadingTlsCryptoEngine::create_tls_client_crypto_codec(const SocketHandle& socket,
                                                                                          const SocketSpec&   spec) {
