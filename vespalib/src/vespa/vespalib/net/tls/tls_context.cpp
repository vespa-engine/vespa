...
std::shared_ptr<TlsContext> TlsContext::create_default_context(
    const TransportSecurityOptions& opts, AuthorizationMode authz_mode) {
...
std::shared_ptr<TlsContext> TlsContext::create_default_context(
    const TransportSecurityOptions& opts, std::shared_ptr<CertificateVerificationCallback> cert_verify_callback,
