...
Lazy<AsyncCryptoSocket::UP> connect_tls(AsyncIo& async, AbstractTlsCryptoEngine& crypto, SocketHandle handle,
                                        SocketSpec spec) {
...
Lazy<AsyncCryptoSocket::UP> AsyncCryptoSocket::connect(AsyncIo& async, CryptoEngine& crypto, SocketHandle handle,
                                                       SocketSpec spec) {
    if (dynamic_cast<NullCryptoEngine*>(&crypto)) {
