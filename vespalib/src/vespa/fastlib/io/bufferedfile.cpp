...
bool Fast_BufferedFile::Eof() const {
    return _fileleft == 0 && _bufi == _bufe;
}

int64_t Fast_BufferedFile::getSize() const {
...
bool Fast_BufferedFile::IsOpened() const {
...
const char* Fast_BufferedFile::GetFileName() const {
