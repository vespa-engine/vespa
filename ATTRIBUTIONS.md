...
## golang.org/x/sys v0.46.0 — Golang BSD + Patents

- Homepage: <https://pkg.go.dev/golang.org/x/sys@v0.46.0>
- Copyright 2009 The Go Authors

---

## golang.org/x/term v0.44.0 — Golang BSD + Patents

- Homepage: <https://pkg.go.dev/golang.org/x/term@v0.44.0>
- Copyright 2009 The Go Authors
