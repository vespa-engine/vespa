...
ResourceUsage& ResourceUsage::operator=(const ResourceUsage& rhs) = default;

ResourceUsage& ResourceUsage::operator=(ResourceUsage&& rhs) = default;

std::ostream& operator<<(std::ostream& out, const ResourceUsage& resource_usage) {
    out << "{disk_usage=" << resource_usage.get_disk_usage() << ", memory_usage=" << resource_usage.get_memory_usage()
