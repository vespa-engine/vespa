...
void AbstractPersistenceProvider::removeIfFoundAsync(const Bucket& b, Timestamp timestamp, const DocumentId& id,
...
BucketIdListResult AbstractPersistenceProvider::getModifiedBuckets(BucketSpace) const {
