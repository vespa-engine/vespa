...
/**
 * <p>Abstraction around buffered/streaming writing to a {@link ResponseHandler}.</p>
 */
class BufferedContentChannelResponseWriter implements ResponseWriter {
    ...
    private final static CompletionHandler NO_OP_COMPLETION_HANDLER = new CompletionHandler() {
        @Override public void completed() {} // TODO
        @Override public void failed(Throwable t) {} // TODO
    };
    ...
    public void write(ByteBuffer buf, CompletionHandler completionHandlerOrNull) {
        ...
        if (handler == null) {
            handler = NO_OP_COMPLETION_HANDLER;
        }
