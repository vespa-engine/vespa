...
public class ConfigServerContainerModelBuilder extends ContainerModelBuilder {
    ...
    protected void addModelEvaluationBundles(ApplicationContainerCluster cluster) {
        // The fat config models include the model-evaluation bundle, but not model-integration, because of its size.
        // The fat models import packages from model-integration, so it must be deployed in the configservers.
