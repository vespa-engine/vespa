...
public class SearchDataTypeValidator extends Validator {
    ...
    private void validateDocument(AbstractSearchCluster cluster, Schemas def, SDDocumentType doc) {
    ...
    private void disallowIndexingOfMaps(AbstractSearchCluster cluster, Schemas def, Field field) {
        DataType fieldType = field.getDataType();
