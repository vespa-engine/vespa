...
public class DeriveConfigFromSchema {
    ...
    /**
     * Simple deploy logger that writes to System.err
     */
    ...
    /**
     * Derive configuration from a single schema file.
     */
    ...
    /**
     * Export all configuration files to the output directory.
     */
     ...
     * Main entry point.
     *
     * Usage: DeriveConfigFromSchema <schema-file.sd | schema-dir> [output-dir]
     */
