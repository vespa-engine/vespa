...
public class TelemetryExportTest {
    ...
    void testMultipleExporters() throws Exception {
        ...
        assertEquals("otlphttp", exporters.get(0).type());
        assertEquals("second", exporters.get(1).id());
        assertEquals("otlp", exporters.get(1).type());
    }
    ...
    void testGooglecloudExporterType() throws Exception {
        ...
        VespaModel model = createModel(hosts, services);
        var exporter = model.getAdmin().getTelemetryExport().get().exporters().get(0);
        assertEquals("googlecloud", exporter.type());
    ...
    void testModelClassValidation() {
        assertThrows(IllegalArgumentException.class, () ->
                new TelemetryExporterConfiguration.Exporter(null, "otlphttp", "https://ep", null, null, null, null));
        assertThrows(IllegalArgumentException.class, () ->
                new TelemetryExporterConfiguration.Exporter("id", null, "https://ep", null, null, null, null));
        assertThrows(IllegalArgumentException.class, () ->
                new TelemetryExporterConfiguration.Auth(null, "vault", null, null, null, null));
        assertThrows(IllegalArgumentException.class, () ->
                new TelemetryExporterConfiguration.Auth("bearer", "", null, null, null, null));
    }
