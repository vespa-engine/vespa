...
public class ContentClusterTest extends ContentBaseTest {
    ...
    public void testMetrics() {
        ...
        assertEquals("vds.datastored.bucket_space{name:default}.buckets_total", config.consumer(4).addedmetrics(3));
    }
    ...
    public void testConfiguredMetrics() {
...

        {
            ...
            expected =
                    ...
                    "vds.datastored.bucket_space{name:default}.buckets_total]";
