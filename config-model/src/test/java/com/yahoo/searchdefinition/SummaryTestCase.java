...
public class SummaryTestCase {
    ...
    public void testMemorySummary() throws ParseException {
        ...
        ApoplicationBuilder.createFromString(sd, logger);
    ...
    public void testInheritance() throws Exception {
        ...
        var search = ApoplicationBuilder.createFromString(sd, logger).getSchema();
    ...
    public void testInheritingParentSummary() throws ParseException {
        ...
        String child = joinLines(
                ...
                "}");
        DeployLoggerStub logger = new DeployLoggerStub();
        ApoplicationBuilder.createFromStrings(logger, parent, child);
