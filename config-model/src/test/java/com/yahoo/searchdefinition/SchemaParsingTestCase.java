...
public class SchemaParsingTestCase extends AbstractSchemaTestCase {
    ...
    public void requireThatIndexingExpressionsCanBeParsed() throws Exception {
        assertNotNull(ApoplicationBuilder.buildFromFile("src/test/examples/simple.sd"));
    }

    @Test
    public void requireThatParseExceptionPositionIsCorrect() throws Exception {
        try {
            ApoplicationBuilder.buildFromFile("src/test/examples/invalid_sd_construct.sd");
    ...
    public void requireThatParserHandlesLexicalError() throws Exception {
        try {
            ApoplicationBuilder.buildFromFile("src/test/examples/invalid_sd_lexical_error.sd");
        } catch (ParseException e) {
    ...
    public void requireErrorWhenJunkAfterSearchBlock() throws IOException, ParseException {
        try {
            ApoplicationBuilder.buildFromFile("src/test/examples/invalid_sd_junk_at_end.sd");
    ...
    public void requireErrorWhenMissingClosingSearchBracket() throws IOException, ParseException {
        try {
            ApoplicationBuilder.buildFromFile("src/test/examples/invalid_sd_no_closing_bracket.sd");
    ...
    public void illegalSearchDefinitionName() throws IOException, ParseException {
        try {
            ApoplicationBuilder.buildFromFile("src/test/examples/invalid-name.sd");
    ...
    public void requireThatParserHandlesHeadAndBody() throws IOException, ParseException {
        assertNotNull(ApoplicationBuilder.buildFromFile("src/test/examples/header_body.sd"));
    }
